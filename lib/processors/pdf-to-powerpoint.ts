...
/**
 * PDF to PowerPoint processor — extracted from app/api/pdf-to-powerpoint/route.ts
 * Uses CloudConvert REST API (pdf → pptx).
...
export async function pdfToPowerpointProcessor(
  ...
  logger.info("pdf_to_powerpoint_complete", { originalName, outputUrl: blob.url })
