...
export const DASHBOARD_TOOLS: DashboardTool[] = [
  ...
  { id: "pdf-to-powerpoint", icon: Presentation,
    ...
    keywords: ["pptx", "slides", "presentacion", "apresentacao"],
  },
  { id: "extract-images", icon: FileDown,
    en: { label: "Extract Images", href: "/extract-images-from-pdf" },
    es: { label: "Extraer Imagenes", href: "/es/extraer-imagenes-de-pdf" },
  ...
  { id: "url-to-pdf", icon: Globe,
    ...
    keywords: ["website", "web", "sitio", "site", "page", "pagina"],
  },
  ...
  { id: "protect-pdf", icon: Lock,
    ...
    keywords: ["password", "contrasena", "senha", "encrypt"],
  },
  { id: "unlock-pdf", icon: Unlock,
    ...
    keywords: ["password", "remove password", "decrypt", "contrasena", "senha"],
  },
  ...
  { id: "ocr-scanner", icon: Scan,
    ...
    es: { label: "Escaner OCR", href: "/es/escaner-ocr" },
  ...
  { id: "qr-code", icon: QrCode,
    ...
    es: { label: "Generador de Codigo QR", href: "/es/codigo-qr" },
    br: { label: "Gerador de Codigo QR", href: "/br/codigo-qr" },
    keywords: ["qr", "barcode", "codigo"],
  },
  { id: "ats-optimizer", icon: Target,
    en: { label: "Optimize Your Resume", href: "/ats-optimizer" },
    es: { label: "Optimiza Tu Curriculum", href: "/es/optimizador-ats" },
    br: { label: "Otimize Seu Curriculo", href: "/br/otimizador-ats" },
    keywords: ["resume", "cv", "curriculum", "curriculo", "ats", "job"],
  },
  { id: "create-resume", icon: FilePlus,
    en: { label: "Create a Resume", href: "/create-resume" },
    es: { label: "Crear Curriculum", href: "/es/crear-curriculum" },
  ...
  { id: "smart-extraction", icon: FileSearch,
    ...
    es: { label: "Extraccion Inteligente", href: "/es/extraccion-inteligente" },
  ...
  { id: "translate-pdf", icon: Languages,
    ...
    keywords: ["translation", "traduccion", "traducao", "language", "idioma", "ai"],
  },

  // Business & Enterprise
  { id: "workflow", icon: Repeat,
    en: { label: "Workflow Automation", href: "/workflow-automation" },
    es: { label: "Automatizacion de Flujos", href: "/es/automatizacion" },
  ...
  { id: "table-extraction", icon: FileSpreadsheet,
    ...
    es: { label: "Extraccion de Tablas", href: "/es/extraccion-de-tablas" },
  ...
  { id: "esign", icon: PenTool,
    ...
    es: { label: "Firma Electronica", href: "/es/firma-electronica" },
  ...
  { id: "pdf-redaction", icon: Shield,
    ...
    es: { label: "Redaccion de PDF", href: "/es/redaccion-pdf" },
