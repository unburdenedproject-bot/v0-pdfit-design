...
export function HeaderBr() {
  ...
  const handleSearchSubmit = (e: React.FormEvent) => {
    ...
    router.push(`/br/ferramentas${q ? `?q=${encodeURIComponent(q)}` : ""}`)
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative" ref={forDropdownRef}>
              <button
                ...
                className={`${pathname.startsWith("/br/para/") ? "text-[#14D8C4]" : "text-white/80"} flex items-center gap-1 hover:text-white font-medium transition-colors`}
        ...
        <nav className="fixed top-16 left-0 right-0 z-40 bg-[#0E0F1E]/95 backdrop-blur-xl border-b border-white/10 shadow-lg md:hidden">
          <div className="container mx-auto px-4 py-4 flex flex-col space-y-3">
            ...
            <div className="pt-2 border-t border-white/10">
              ...
              <Link href="/br/para/advogados" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 text-white/80 hover:text-white font-medium py-2 px-3 rounded-lg hover:bg-white/10 transition-colors">
                <Scale className="h-4 w-4 text-[#14D8C4] flex-shrink-0" />
                Advogados
              </Link>
              <Link href="/br/para/contadores" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 text-white/80 hover:text-white font-medium py-2 px-3 rounded-lg hover:bg-white/10 transition-colors">
                <Calculator className="h-4 w-4 text-[#14D8C4] flex-shrink-0" />
                Contadores
              </Link>
              <Link href="/br/para/equipes-rh" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 text-white/80 hover:text-white font-medium py-2 px-3 rounded-lg hover:bg-white/10 transition-colors">
                <Users className="h-4 w-4 text-[#14D8C4] flex-shrink-0" />
                Equipes de RH
              </Link>
            </div>
