  ...
  const labels =
    localePrefix === "/es"
      ? {
          ...
          uploadDesc: "Arrastra y suelta tu currículum en PDF, o haz clic para seleccionar",
          browse: "Seleccionar archivo",
          jobLabel: "Descripción del puesto (opcional)",
          jobPlaceholder: "Pega la descripción del puesto para un análisis personalizado de palabras clave...",
          analyze: "Analizar Currículum",
          analyzing: "Analizando con IA...",
          analyzeAnother: "Analizar otro",
          fixResume: "Arreglar Mi Currículum con IA",
          buildResume: "Crear Currículum Nuevo",
          generating: "Generando...",
          buildFormTitle: "Crear Currículum Nuevo desde Cero",
          upgradeTitle: "Función Pro",
          upgradeDesc: "El Optimizador ATS está disponible en los planes Pro, Business y Enterprise.",
          ...
          sectionImprovements: "Mejoras por Sección",
          sections: { contact_info: "Información de Contacto", formatting: "Formato", keywords: "Palabras Clave", experience: "Experiencia", education: "Educación", skills: "Habilidades" },
        }
      : localePrefix === "/br"
        ? {
            ...
            upgradeDesc: "O Otimizador ATS está disponível nos planos Pro, Business e Enterprise.",
