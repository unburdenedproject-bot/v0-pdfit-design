...
const categories = [
  {
    ...
    tools: [
      { name: "PDF para JPG", description: "Converta páginas PDF em imagens JPG de alta qualidade.", icon: Image, href: "/br/pdf-para-jpg", tier: "FREE" as const },
      ...
      { name: "PDF para PNG", description: "Converta páginas PDF em imagens PNG.", icon: Image, href: "/br/pdf-para-png", tier: "FREE" as const },
      ...
      { name: "PDF para PowerPoint", description: "Converta páginas PDF em slides de PowerPoint.", icon: Presentation, href: "/br/pdf-para-powerpoint", tier: "PRO" as const },
      { name: "Extrair Imagens", description: "Extraia fotos, logos e gráficos de arquivos PDF.", icon: ImageDown, href: "/br/extrair-imagens-de-pdf", tier: "FREE" as const },
    ],
  },
  {
    ...
    tools: [
      ...
      { name: "URL para PDF", description: "Converta qualquer página web em um documento PDF.", icon: Globe, href: "/br/url-para-pdf", tier: "PRO" as const },
    ],
  },
  {
    ...
    tools: [
      { name: "Unir PDF", description: "Combine varios PDFs em um único arquivo.", icon: Merge, href: "/br/unir-pdf", tier: "FREE" as const },
      { name: "Dividir PDF", description: "Divida um PDF em arquivos separados.", icon: Split, href: "/br/dividir-pdf", tier: "FREE" as const },
      { name: "Girar PDF", description: "Corrija a orientacao das páginas instantaneamente.", icon: RotateCw, href: "/br/girar-pdf", tier: "FREE" as const },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "Comprimir para Email", description: "Reduza PDFs para cumprir os límites de anexo do Gmail, Outlook e Yahoo.", icon: Mail, href: "/br/comprimir-pdf-para-email", tier: "FREE" as const },
  ...
  },
  {
    ...
    tools: [
      { name: "Gerador de Código QR", description: "Gere códigos QR a partir de qualquer URL ou texto instantaneamente.", icon: QrCode, href: "/br/codigo-qr", tier: "PRO" as const },
      ...
      { name: "Extracao Inteligente", description: "Extraia automáticamente nomes, datas, valores e dados chave de qualquer PDF.", icon: FileSearch, href: "/br/extracao-inteligente", tier: "BUSINESS" as const, hasAI: true },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "Modelos de Fluxo", description: "Fluxos predefinidos para documentos jurídicos, contabeis e de laboratorio.", icon: Layers, href: "/br/automacao", tier: "ENTERPRISE" as const },
      { name: "Extracao de Alto Volume", description: "Extraia ate 2.000 páginas de tabelas por mes para Excel.", icon: FileSpreadsheet, href: "/br/extracao-tabelas-alto-volume", tier: "ENTERPRISE" as const },
    ],
  },
]
