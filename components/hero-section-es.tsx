  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-bold text-white">Herramientas con IA:</span>
            <div className="flex items-center gap-3">
              <Link href="/es/optimizador-ats" className="text-sm font-semibold text-[#14D8C4] hover:text-[#2EE6D6] transition-colors">
                Optimizador ATS
              </Link>
              ...
              <span className="text-slate-500">|</span>
              <Link href="/es/generador-preguntas" className="text-sm font-semibold text-[#14D8C4] hover:text-[#2EE6D6] transition-colors">
                Preguntas
              </Link>
              <span className="text-slate-500">|</span>
              <Link href="/es/traducir-pdf" className="text-sm font-semibold text-[#14D8C4] hover:text-[#2EE6D6] transition-colors">
                Traducir
              </Link>
            </div>
          </div>
          ...
          >
            <span className="text-white block">Creado para Profesionales.</span>
            <span
              className="block"
              style={{
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-12 text-sm font-semibold text-slate-300">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>7 Herramientas con IA</span>
            </div>
            <div className="flex items-center gap-2">
              <Shield className="h-4 w-4" style={{ color: "#14D8C4" }} />
              <span>Archivos eliminados tras su uso</span>
            </div>
            <div className="flex items-center gap-2">
      ...
      <div className="relative w-full" style={{ height: "160px", marginTop: "8px" }}>
        ...
        >
          <defs>
            <linearGradient id="waveGrad1Es" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <linearGradient id="waveGrad2Es" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <path
            ...
            fill="url(#waveGrad1Es)"
            style={{
              animation: "waveMoveEs1 6s ease-in-out infinite",
              opacity: 0.85,
            }}
          />
          <path
            d="M0,100 C240,50 480,150 720,100 C960,50 1200,150 1440,100 L1440,160 L0,160 Z"
            fill="url(#waveGrad2Es)"
            style={{
              animation: "waveMoveEs2 6s ease-in-out infinite",
              opacity: 0.5,
            }}
          />
        </svg>
