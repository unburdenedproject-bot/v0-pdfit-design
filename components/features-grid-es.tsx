...
const categories = [
  ...
  },
  {
    ...
    tools: [
      ...
      {
        name: "URL a PDF",
        description: "Convierte cualquier página web en un documento PDF.",
        icon: Globe,
        href: "/es/url-a-pdf",
        tier: "PRO" as const,
      },
  ...
  },
  {
    ...
    tools: [
      ...
      {
        name: "Optimiza Tu Currículum",
        description: "Sube tu currículum, recibe una puntuacion y la IA lo arregla.",
        icon: Target,
      ...
      },
      {
        ...
        description: "Construye un currículum profesional desde cero con IA. Descarga en Word.",
        icon: FilePlus,
      ...
      {
        name: "Traducir PDF",
        description: "Traduce documentos PDF completos a 13 idiomas con IA.",
        icon: Languages,
        href: "/es/traducir-pdf",
        tier: "BUSINESS" as const,
        hasAI: true,
      },
    ],
