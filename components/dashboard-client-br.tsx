...
export function DashboardClientBr({
  ...
  const planLabel = currentPlan === "enterprise" ? "Enterprise" : currentPlan === "business" ? "Business" : currentPlan === "pro" ? "Pro" : "Gratis"
  const dailyLimit = 10
  ...
  useEffect(() => {
    if (searchParams.get("success") === "true") {
      setStatusMessage({
        type: "success",
        text: "Pagamento realizado! Ativando seu plano...",
      })
    ...
    <div className="container mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="mb-8 rounded-2xl p-[1px] bg-gradient-to-br from-[#14D8C4]/40 via-[#6B7CFF]/30 to-[#14D8C4]/20">
          <div className="rounded-2xl bg-white/[0.05] backdrop-blur-sm p-8">
            <div className="max-w-2xl">
              <h2 className="text-2xl font-black text-white mb-2">Comece com sua primeira ferramenta</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl bg-white/[0.05] backdrop-blur-sm border border-white/10">
          <div className="p-6 pb-4">
            <h3 className="text-lg font-bold text-white">Plano e Cobranca</h3>
          </div>
          <div className="px-6 pb-6">
