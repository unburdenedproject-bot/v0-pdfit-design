...
interface DashboardClientBrProps {
  user: User
  plan?: string
  usageCount?: number
...
const quickTools = [
  { label: "Unir PDF", href: "/br/unir-pdf", icon: Merge },
  { label: "Dividir PDF", href: "/br/dividir-pdf", icon: Split },
  { label: "Comprimir PDF", href: "/br/comprimir-pdf", icon: Compress },
  { label: "Girar PDF", href: "/br/girar-pdf", icon: RotateCw },
  { label: "PDF para JPG", href: "/br/pdf-para-jpg", icon: Image },
  { label: "PDF para Word", href: "/br/pdf-para-word", icon: FileText },
  { label: "Proteger PDF", href: "/br/proteger-pdf", icon: Lock },
  { label: "Desbloquear PDF", href: "/br/desbloquear-pdf", icon: Unlock },
  { label: "Scanner OCR", href: "/br/scanner-ocr", icon: Scan },
  { label: "Achatar PDF", href: "/br/achatar-pdf", icon: Layers },
  { label: "Pronto para Upload", href: "/br/pdf-pronto-para-upload", icon: Upload },
  { label: "Limpeza de Digitalizacao", href: "/br/limpeza-digitalizacao", icon: Camera },
]

const tips = [
  { text: "Combine varios PDFs em um so usando Unir PDF", href: "/br/unir-pdf" },
  { text: "Reduza o tamanho de arquivos para email com Comprimir PDF", href: "/br/comprimir-pdf" },
  { text: "Torne documentos digitalizados pesquisaveis com o Scanner OCR", href: "/br/scanner-ocr" },
  { text: "Corrija e otimize arquivos para portais de upload com PDF Pronto para Upload", href: "/br/pdf-pronto-para-upload" },
]
...
export function DashboardClientBr({
  user,
  plan = "free",
  usageCount = 0,
          ...
          <Card className="border-slate-200 shadow-sm h-full">
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between">
                ...
                <Link href="/br/ferramentas" className="text-sm text-orange-500 hover:text-orange-600 font-medium flex items-center gap-1">
