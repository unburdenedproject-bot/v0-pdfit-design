  ...
  const labels =
    localePrefix === "/es"
      ? {
          ...
          upgradeDesc: "El Resumidor de PDF con IA esta disponible en el plan Business ($13.99/mes). Resume documentos largos en segundos, en cualquier idioma.",
      ...
      : localePrefix === "/br"
        ? {
            ...
            upgradeDesc: "O Resumidor de PDF com IA esta disponivel no plano Business ($13.99/mes). Resuma documentos longos em segundos, em qualquer idioma.",
