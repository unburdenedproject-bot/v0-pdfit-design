  ...
  const labels =
    localePrefix === "/es"
      ? {
          ...
          upgradeDesc: "El Generador de Preguntas con IA está disponible en el plan Pro ($3.99/mes). Genera preguntas de estudio y examen de cualquier documento.",
          ...
          invalidDesc: "El PDF parece estar en blanco, escaneado o contener solo imágenes. Para generar preguntas, necesitamos un PDF con texto seleccionable.",
      ...
      : localePrefix === "/br"
        ? {
            ...
            upgradeDesc: "O Gerador de Perguntas com IA está disponível no plano Pro ($3.99/mes). Gere perguntas de estudo e prova de qualquer documento.",
