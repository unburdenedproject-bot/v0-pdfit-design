  ...
  const labels =
    localePrefix === "/es"
      ? {
          ...
          upgradeDesc: "El Generador de Preguntas con IA esta disponible en el plan Pro ($7.99/mes). Genera preguntas de estudio y examen de cualquier documento.",
      ...
      : localePrefix === "/br"
        ? {
            ...
            upgradeDesc: "O Gerador de Perguntas com IA esta disponivel no plano Pro ($7.99/mes). Gere perguntas de estudo e prova de qualquer documento.",
        ...
        : {
            ...
            upgradeDesc: "AI Question Generator is available on the Pro plan ($7.99/month). Generate study and exam questions from any document.",
