      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Add strong password encryption to any PDF</li>
              <li className="flex items-center gap-2">✓ Industry-standard AES encryption</li>
              <li className="flex items-center gap-2">✓ Content, formatting, and quality preserved</li>
              <li className="flex items-center gap-2">✓ No installation — encrypt in your browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Encrypt PDFs Before Sending by Email", desc: "Email is not secure by default. Encrypt sensitive contracts, tax documents, or personal records with a password before attaching. Share the password separately for maximum security." },
                { title: "Secure Financial Documents", desc: "Financial statements, audit reports, and internal memos contain sensitive information. Encrypt these PDFs before uploading to cloud storage or sharing with stakeholders." },
                { title: "Protect Legal Documents", desc: "Contracts, NDAs, and legal agreements require confidentiality. Password encryption ensures only intended parties can access the document, even if the file is intercepted." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Encrypt a PDF with a Password</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Set a password", desc: "Enter a strong password to protect your document" },
                { num: "3", title: "Download encrypted PDF", desc: "Get your password-protected file instantly" },
              ].map((step) => (
