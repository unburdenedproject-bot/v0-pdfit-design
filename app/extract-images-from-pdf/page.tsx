      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>All Images Extracted</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Extract all embedded images from any PDF</li>
              <li className="flex items-center gap-2">✓ Images saved in their original format (JPG, PNG)</li>
              <li className="flex items-center gap-2">✓ Perfect for reusing photos, logos, and graphics</li>
              <li className="flex items-center gap-2">✓ Works on Mac, Windows, iOS, Android, and Linux</li>
              <li className="flex items-center gap-2">✓ No installation — extract images in your browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Reuse Photos and Graphics from PDFs", desc: "Received a brochure, presentation, or report as a PDF? Extract the images to reuse in your own documents, slides, or social media posts without screenshots." },
                { title: "Extract Logos and Brand Assets", desc: "Pull logos, icons, and brand graphics from PDF brand guides, marketing materials, and corporate documents — get the original image files instantly." },
                { title: "Different from PDF to JPG", desc: "PDF to JPG converts entire pages into images. Image extraction pulls out only the embedded graphics — photos, charts, logos — separate from the page layout." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Extract Images from a PDF</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Upload or drag and drop your PDF into PDF.it." },
                { num: "2", title: "Click Extract Images", desc: "All embedded images are detected automatically." },
                { num: "3", title: "Download the ZIP", desc: "Download the ZIP file containing all extracted images." },
              ].map((step) => (
        ...
        <Script id="faq-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "FAQPage",
          "mainEntity": [
            { "@type": "Question", "name": "How do I extract images from a PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Upload your PDF to PDF.it, click Extract, and download a ZIP file containing all the images found in your PDF." } },
            { "@type": "Question", "name": "What image formats are extracted?", "acceptedAnswer": { "@type": "Answer", "text": "PDF.it extracts images in their original format — typically JPG or PNG. The images are downloaded as a ZIP file." } },
            { "@type": "Question", "name": "What is the difference between extracting images and converting PDF to JPG?", "acceptedAnswer": { "@type": "Answer", "text": "PDF to JPG converts each page into an image. Extract Images pulls out only the embedded photos, logos, and graphics — not the full page layout." } },
            { "@type": "Question", "name": "Can I extract images from a scanned PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Scanned PDFs treat the entire page as one image. You can extract it, but it will be the full page scan rather than individual graphics." } },
            { "@type": "Question", "name": "Can I extract images from a PDF on my phone?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. PDF.it works in mobile browsers — upload, extract, and download on iPhone or Android." } },
            { "@type": "Question", "name": "Is it free to extract images from a PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Free accounts get 10 extractions per day. Pro accounts get unlimited extractions." } }
          ]
        })}} />
      </main>
      <Footer />
