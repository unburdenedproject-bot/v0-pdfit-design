...
export const metadata = {
  title: "Extract Images from PDF Online — Free Image Extractor | OmnisPDF",
  description:
    "Extract all images from PDF files with OmnisPDF. Pull out photos, logos, and graphics from any PDF — fast, browser-based, no login required.",
}
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Upload your PDF to OmnisPDF, click Extract, and download a ZIP file containing all the images found in your PDF." }
    },
    {
      "@type": "Question",
      "name": "What image formats are extracted?",
      "acceptedAnswer": { "@type": "Answer", "text": "OmnisPDF extracts images in their original format — typically JPG or PNG. The images are downloaded as a ZIP file." }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. OmnisPDF works in mobile browsers — upload, extract, and download on iPhone or Android." }
    },
    {
      "@type": "Question",
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <p className="text-lg text-slate-600 mb-8">
              Need the photos or graphics from a PDF without the text and layout? OmnisPDF's image extractor pulls out every embedded image — photos, logos, charts, diagrams — and delivers them as a ZIP file you can use anywhere.
            </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                { q: "How do I extract images from a PDF?", a: "Upload your PDF to OmnisPDF, click Extract, and download a ZIP file containing all the images found in your PDF." },
                { q: "What image formats are extracted?", a: "OmnisPDF extracts images in their original format — typically JPG or PNG. The images are downloaded as a ZIP file." },
                ...
                { q: "Can I extract images from a PDF on my phone?", a: "Yes. OmnisPDF works in mobile browsers — upload, extract, and download on iPhone or Android." },
