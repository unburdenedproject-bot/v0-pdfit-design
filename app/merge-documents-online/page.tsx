      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Instant Merging</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Merge any PDF documents into one file</li>
              <li className="flex items-center gap-2">✓ No quality loss — formatting preserved</li>
              <li className="flex items-center gap-2">✓ Works on any device with a modern browser</li>
              <li className="flex items-center gap-2">✓ No software installation or account required</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Combine Reports Into One Document", desc: "Assembling a quarterly report or research paper from multiple files? Upload each section, arrange them in order, and merge into one clean document ready for distribution." },
                { title: "Merge Contracts and Legal Documents", desc: "Combine signed agreements, addendums, exhibits, and supporting documents into a single PDF for legal records. One file means less confusion and easier archiving." },
                { title: "Create Document Bundles for Sharing", desc: "Sending multiple files to a client? Merge everything into one PDF bundle — easier to share via email, upload to portals, or print as a single packet." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Merge Documents Online</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your documents", desc: "Drag and drop or click to choose PDF files" },
                { num: "2", title: "Arrange and merge", desc: "Set the order, then click Merge" },
                { num: "3", title: "Download your PDF", desc: "Get your combined document instantly" },
              ].map((step) => (
