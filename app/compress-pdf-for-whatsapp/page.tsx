      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Extreme compression for fast mobile sharing</li>
              <li className="flex items-center gap-2">✓ Text stays sharp and readable on any screen</li>
              <li className="flex items-center gap-2">✓ Works on iPhone, Android, Mac, and Windows</li>
              <li className="flex items-center gap-2">✓ No app installation — compress in your browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Documents & Contracts", desc: "Share proposals, invoices, and contracts with clients over WhatsApp without making them wait for a large download. Compressed PDFs arrive instantly and open smoothly on any phone." },
                { title: "Receipts & Invoices", desc: "Quickly send purchase receipts, payment confirmations, and invoices via WhatsApp. Compression keeps the files small so they send in seconds, even on slow connections." },
                { title: "School & Study Materials", desc: "Students and teachers often share assignments, notes, and study materials over WhatsApp groups. Compressed PDFs download quickly without eating up mobile data." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF for WhatsApp</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                ...
                { num: "3", title: "Download & share", desc: "Send the smaller PDF on WhatsApp instantly" },
              ].map((step) => (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { name: "Compress for Email", href: "/compress-pdf-for-email", desc: "Fit email limits" },
                { name: "Compress to 1MB", href: "/compress-pdf-to-1mb", desc: "For 1MB size limits" },
