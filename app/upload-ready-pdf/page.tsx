      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>One-Click Optimization</span></div>
                <div className="flex items-center gap-2"><Shield className="h-4 w-4 text-[#14D8C4]" /><span>Files Deleted After Session</span></div>
                <div className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-[#14D8C4]" /><span>Works With Any Portal</span></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Flattens form fields so data displays correctly</li>
              <li className="flex items-center gap-2">✓ Compresses file size for portal upload limits</li>
              <li className="flex items-center gap-2">✓ Works with government, university, and job portals</li>
              <li className="flex items-center gap-2">✓ No installation — optimize PDFs in your browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Flatten, Compress & Optimize", desc: "Form fields and annotations are merged into the page, file size is reduced, and PDF structure is cleaned — all in one click." },
                { title: "Government & Visa Portals", desc: "Government portals are strict about PDF format and size. Upload-Ready ensures your forms are flattened, compressed, and compatible." },
                { title: "Job, University & Legal Submissions", desc: "HR portals, university systems, and court filings often reject PDFs with interactive fields or large file sizes. One click fixes it." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Make a PDF Upload-Ready</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Click Upload-Ready", desc: "Flattening and compression happen automatically" },
                { num: "3", title: "Download your PDF", desc: "Get your optimized file instantly" },
              ].map((step) => (
