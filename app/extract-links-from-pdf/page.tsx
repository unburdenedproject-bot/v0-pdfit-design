...
export const metadata = {
  title: "Extract Links from PDF — Find All URLs in a PDF | OmnisPDF",
  description:
    "Find and extract all hyperlinks and URLs from PDF documents. OmnisPDF helps you pull text content including embedded links from any PDF.",
}
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Convert your PDF to text using OmnisPDF's PDF to TXT tool. The extracted text will contain all visible URLs from the document. You can then search through the text for http://, https://, or www. patterns to find every link." }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Scanned PDFs are images, so links aren't clickable or embedded as text. Use OmnisPDF's OCR Scanner first to convert the scanned pages to selectable text, then extract the text to find any URLs printed in the document." }
    },
    {
      "@type": "Question",
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-4">
              {[
                "Upload your PDF to OmnisPDF's PDF to TXT converter.",
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                { q: "How do I extract links from a PDF?", a: "Convert your PDF to text using OmnisPDF's PDF to TXT tool. The extracted text will contain all visible URLs from the document. You can then search through the text for http://, https://, or www. patterns to find every link." },
                ...
                { q: "How do I extract links from a scanned PDF?", a: "Scanned PDFs are images, so links aren't clickable or embedded as text. Use OmnisPDF's OCR Scanner first to convert the scanned pages to selectable text, then extract the text to find any URLs printed in the document." },
