      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              ...
              <li className="flex items-center gap-2">✓ Perfect for email signatures and badges</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Email Signatures & Micro-Attachments", desc: "Corporate email systems and ticketing platforms often limit attachments to 100KB. Compress your logo, vCard, or brochure PDF to fit within strict size restrictions." },
                { title: "Badge & ID Photo Uploads", desc: "Employee badge systems, event registrations, and membership portals require photo uploads under 100KB. Compress your badge photo PDF to meet these limits." },
                { title: "Mobile-Optimized Documents", desc: "Sending PDFs over slow connections or to devices with limited storage benefits from extreme compression. Reduce your file for instant loading and minimal data usage." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF for 100KB Limits</h2>
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "Compress to 200KB", href: "/compress-pdf-to-200kb", desc: "For 200KB upload limits" },
