              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-600">
                    Need to recombine PDF parts? Use <Link href="/merge-pdf" className="text-orange-600 hover:underline">Merge PDF</Link> to join multiple files into one — works great on mobile for reassembling documents.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Compress for sharing</h3>
                  <p className="text-slate-600">
                    Before sharing via WhatsApp or email, use <Link href="/compress-pdf-for-email" className="text-orange-600 hover:underline">Compress PDF for Email</Link> to make sure your file is small enough to send.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Convert pages to images</h3>
                  <p className="text-slate-600">
                    Need to share a page as a photo? Convert it to <Link href="/pdf-to-jpg" className="text-orange-600 hover:underline">JPG</Link> or <Link href="/pdf-to-png" className="text-orange-600 hover:underline">PNG</Link> directly from your phone — much easier to share in messaging apps than a PDF.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Fix rotated pages</h3>
                  <p className="text-slate-600">
                    Scanned PDFs often have pages rotated sideways. Use <Link href="/rotate-pdf" className="text-orange-600 hover:underline">Rotate PDF</Link> on your phone to fix the orientation before sharing.
                  </p>
                </div>
              </div>
            </section>
