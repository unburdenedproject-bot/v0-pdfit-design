          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Smaller file sizes.</strong> PDFs are often smaller than their Office counterparts, making them easier to email. You can <Link href="/compress-pdf" className="text-orange-600 hover:underline">compress the PDF further</Link> if needed.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-500 font-bold mt-0.5">5.</span>
                  <span><strong>Security.</strong> PDFs can be <Link href="/protect-pdf" className="text-orange-600 hover:underline">password-protected</Link> to prevent unauthorized editing or viewing.</span>
                </li>
              </ul>
            </section>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-600">
                    Word documents usually convert cleanly. Watch out for custom fonts that may not be embedded — stick to standard fonts like Arial, Times New Roman, or Calibri for best results. If your document has tracked changes, accept or reject them before converting. Use the dedicated <Link href="/word-to-pdf" className="text-orange-600 hover:underline">Word to PDF</Link> tool for advanced options.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Excel (.xlsx) to PDF</h3>
                  <p className="text-slate-600">
                    Spreadsheets can be tricky because wide tables may get cut off. Before converting, set your print area in Excel and choose landscape orientation for wide sheets. The <Link href="/excel-to-pdf" className="text-orange-600 hover:underline">Excel to PDF</Link> tool handles this automatically when possible.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">PowerPoint (.pptx) to PDF</h3>
                  <p className="text-slate-600">
                    Presentations convert with one slide per page by default. Animations and transitions will not appear in the PDF, but all text, images, and charts are preserved. Use the <Link href="/powerpoint-to-pdf" className="text-orange-600 hover:underline">PowerPoint to PDF</Link> tool for the best results.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                <li>&#10003; <strong>Merge multiple PDFs</strong> into one document using <Link href="/merge-pdf" className="text-orange-600 hover:underline">Merge PDF</Link> — great for combining a cover letter, resume, and portfolio.</li>
                <li>&#10003; <strong>Compress the PDF</strong> if it is too large for email. Use <Link href="/compress-pdf-for-email" className="text-orange-600 hover:underline">Compress PDF for Email</Link> to get it under the typical 25MB limit.</li>
                <li>&#10003; <strong>Add password protection</strong> with <Link href="/protect-pdf" className="text-orange-600 hover:underline">Protect PDF</Link> if the document contains sensitive data.</li>
                <li>&#10003; <strong>Add a watermark</strong> using <Link href="/watermark-pdf" className="text-orange-600 hover:underline">Watermark PDF</Link> to mark drafts or confidential documents.</li>
              </ul>
            </section>
