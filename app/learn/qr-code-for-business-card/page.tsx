...
export const metadata = {
  title: "QR Code for Business Cards (Link to Your Website or vCard) | OmnisPDF",
  description:
    "Learn how to add a QR code to your business card that links to your website, LinkedIn, or vCard contact info. Generate business card QR codes with OmnisPDF.",
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. OmnisPDF's QR Code tool is a Pro feature available at $7.99/month. Pro users get unlimited QR code generation plus all premium PDF tools." }
    }
  ]
}
...
const howToSchema = {
  ...
  "description": "Generate a professional QR code for your business card in 3 simple steps using OmnisPDF.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Choose vCard or URL type",
      "text": "Open OmnisPDF's QR Code tool and select either vCard (to encode your full contact info) or URL (to link to your website or LinkedIn profile)."
    },
    {
      "@type": "HowToStep",
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Open OmnisPDF's QR Code tool (Pro feature), select your type, and enter your data. For vCard, fill in your name, title, company, phone, email, and address. For URL, paste your link. Keep data minimal for a cleaner, more scannable code.",
                  },
                  {
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                ...
                { q: "Is the QR Code generator a Pro feature?", a: "Yes. OmnisPDF's QR Code tool is a Pro feature available at $7.99/month. Pro users get unlimited QR code generation plus all premium PDF tools." },
              ].map((faq, i) => (
