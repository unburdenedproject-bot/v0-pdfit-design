          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mt-4">
                Learn more about the different types in our <Link href="/learn/qr-code-types-explained" className="text-[#14D8C4] hover:underline">QR Code Types Explained</Link> guide.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>&#10003; <strong>Test before bulk printing.</strong> Print one card and scan the QR code with at least two different phones. Check our <Link href="/learn/qr-code-best-practices" className="text-[#14D8C4] hover:underline">QR code best practices</Link> for more tips.</li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mt-4">
                If you need to embed your QR code into a PDF version of your card, you can use <Link href="/word-to-pdf" className="text-[#14D8C4] hover:underline">Word to PDF</Link> or design your card and convert it. Need to compress the final file? Use <Link href="/compress-pdf" className="text-[#14D8C4] hover:underline">Compress PDF</Link> to keep it email-friendly.
              </p>
            </section>
