...
export const metadata = {
  title: "Convert Word to PDF on iPhone (DOCX to PDF in Minutes) | OmnisPDF",
  description:
    "Learn how to convert Word to PDF on iPhone using Safari and OmnisPDF. No app needed — open your DOCX from email or Files, convert it, and share the PDF in minutes.",
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. OmnisPDF works directly in Safari (or any iPhone browser). Go to omnispdf.com/word-to-pdf, upload your .docx file, and download the converted PDF. No app installation needed." }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. OmnisPDF preserves fonts, images, tables, and layout during conversion. For best results, make sure your Word document uses standard fonts like Arial or Calibri, which convert reliably across all devices." }
    },
    {
      "@type": "Question",
      "name": "Can I convert Word to PDF using the Files app on iPhone?",
      "acceptedAnswer": { "@type": "Answer", "text": "The Files app can open DOCX files for viewing but doesn't have a built-in PDF converter. You can use the Print menu trick (share > Print > pinch to zoom the preview > share as PDF), but this often changes margins and drops hyperlinks. OmnisPDF gives a more accurate conversion." }
    },
    {
      "@type": "Question",
      "name": "How do I share the converted PDF from my iPhone?",
      "acceptedAnswer": { "@type": "Answer", "text": "After downloading the PDF from OmnisPDF, tap the share icon to send it via email, iMessage, AirDrop, WhatsApp, or any other app. You can also save it to the Files app or upload it to cloud storage." }
    },
    {
      "@type": "Question",
...
const howToSchema = {
  ...
  "description": "Convert a DOCX file to PDF on your iPhone using Safari and OmnisPDF — no app needed.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Open OmnisPDF in Safari",
      "text": "Open Safari on your iPhone and go to omnispdf.com/word-to-pdf. Tap the upload area to browse for your .docx file."
    },
    {
      "@type": "HowToStep",
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
                ...
                {[
                  {
                    ...
                    desc: "Open Safari and go to omnispdf.com/word-to-pdf. The page is fully mobile-optimized — it works exactly like the desktop version, just sized for your phone screen.",
                  },
                  {
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Email attachment.</strong> Open the email with the Word file, tap and hold the attachment, then tap "Share" and choose "Save to Files." Now you can find it in the Files app when uploading to OmnisPDF.</span>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Cloud storage apps.</strong> If the file is in Google Drive, Dropbox, or OneDrive, you can access it directly from the iOS file picker when uploading to OmnisPDF — these services integrate with the Files app.</span>
                </li>
                <li className="flex items-start gap-3">
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mt-4">
                For a quick internal note, the print trick is fine. For anything professional — resumes, contracts, client deliverables — use <Link href="/word-to-pdf" className="text-orange-600 hover:underline">OmnisPDF's Word to PDF converter</Link> for accurate results.
              </p>
            </section>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                { q: "Can I convert Word to PDF on iPhone without an app?", a: "Yes. OmnisPDF works directly in Safari (or any iPhone browser). Go to omnispdf.com/word-to-pdf, upload your .docx file, and download the converted PDF. No app installation needed." },
                ...
                { q: "Will the PDF keep the same formatting as my Word document?", a: "Yes. OmnisPDF preserves fonts, images, tables, and layout during conversion. For best results, make sure your Word document uses standard fonts like Arial or Calibri, which convert reliably across all devices." },
                { q: "Can I convert Word to PDF using the Files app on iPhone?", a: "The Files app can open DOCX files for viewing but doesn't have a built-in PDF converter. You can use the Print menu trick (share > Print > pinch to zoom the preview > share as PDF), but this often changes margins and drops hyperlinks. OmnisPDF gives a more accurate conversion." },
                { q: "How do I share the converted PDF from my iPhone?", a: "After downloading the PDF from OmnisPDF, tap the share icon to send it via email, iMessage, AirDrop, WhatsApp, or any other app. You can also save it to the Files app or upload it to cloud storage." },
