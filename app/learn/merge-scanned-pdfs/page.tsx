          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>✓ <strong>Use <Link href="/rotate-pdf" className="text-[#14D8C4] hover:underline">Rotate PDF</Link></strong> to fix any pages that are in the wrong orientation. You can rotate individual pages 90, 180, or 270 degrees.</li>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mt-4">
                Use <Link href="/compress-pdf" className="text-[#14D8C4] hover:underline">Compress PDF</Link> after merging. For strict size limits, try the dedicated tools for <Link href="/compress-pdf" className="text-[#14D8C4] hover:underline">compression</Link>.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                <li>✓ <strong>Upload your merged PDF</strong> to <Link href="/ocr-scanner" className="text-[#14D8C4] hover:underline">OCR Scanner</Link> (Pro feature).</li>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                <li>✓ <strong>Use <Link href="/phone-scan-cleanup" className="text-[#14D8C4] hover:underline">Phone Scan Cleanup</Link></strong> to automatically fix lighting, remove shadows, straighten pages, and improve contrast.</li>
