      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Merge 2, 5, 10, or 50+ PDFs into one document</li>
              <li className="flex items-center gap-2">✓ Drag and drop to control file order</li>
              <li className="flex items-center gap-2">✓ No quality loss — all pages stay as they are</li>
              <li className="flex items-center gap-2">✓ Works on any device with a browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Batch Merge Dozens of Files", desc: "Need to combine a large batch of invoices, reports, or certificates? Pro users can select multiple files at once and merge them in a single operation." },
                { title: "Keep Pages in the Right Order", desc: "After uploading, drag and drop files to set the exact sequence. PDF.it preserves your chosen order so every chapter and appendix appears where it should." },
                { title: "Merge Then Compress for Sharing", desc: "Merging many PDFs can create a large file. After combining, use PDF.it's Compress PDF tool to shrink the result for email and cloud storage." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Merge Multiple PDFs</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDFs", desc: "Drag and drop all your PDF files" },
                { num: "2", title: "Arrange and merge", desc: "Reorder files, then click Merge" },
                { num: "3", title: "Download your PDF", desc: "Get your single combined file instantly" },
              ].map((step) => (
