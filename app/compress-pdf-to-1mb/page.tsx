...
export const metadata = {
  title: "Compress PDF for 1MB Upload Limits — Free Extreme Compression | PDF.it",
  description:
...
export default function CompressPDFTo1MBPage() {
  const faqs = [
    { q: "How do I compress a PDF for a 1MB upload limit?", a: "Upload your PDF to PDF.it and click Compress. The tool applies extreme compression to reduce image resolution and optimize internal structures, drastically reducing file size. Results depend on the content of your PDF." },
    ...
    { q: "Can I compress a PDF to 1MB on my phone?", a: "Yes. PDF.it works in any mobile browser. Upload your PDF, compress it, and download the smaller file directly on iPhone or Android." },
    { q: "What is the difference between compressing to 1MB vs 2MB or 5MB?", a: "All three use the same extreme compression engine. The difference is the target size. Compressing to 1MB applies more aggressive optimization, which may reduce image quality slightly more than 2MB or 5MB targets." },
  ]
      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">
              Many platforms enforce a strict 1MB file size limit. Visa applications, government ID submissions, scholarship forms, and some job portals all require small documents. PDF.it applies extreme compression to drastically reduce your PDF size, helping you meet tight upload requirements.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Extreme compression for maximum size reduction</li>
              <li className="flex items-center gap-2">✓ Perfect for visa and government form uploads</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Visa & Immigration Applications", desc: "Many visa portals (Schengen, US, UK, Canada) require supporting documents under 1MB each. Compress your passport scans, bank statements, and cover letters to meet these strict limits." },
                { title: "Government Forms & ID Uploads", desc: "Government portals for tax filings, permit applications, and ID submissions often cap uploads at 1MB. Compress your documents to upload without errors." },
                { title: "Mobile Sharing & Scholarships", desc: "Sending large PDFs over WhatsApp or Telegram is slow and sometimes blocked. Scholarship and admissions portals also require documents under 1MB. Compress for fast delivery." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF for 1MB Limits</h2>
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "Compress to 500KB", href: "/compress-pdf-to-500kb", desc: "For 500KB upload limits" },
