...
export const metadata = {
  ...
  alternates: {
    canonical: "https://omnispdf.com/pt/proteger-pdf",
    languages: {
      "en": "https://omnispdf.com/protect-pdf",
      "es": "https://omnispdf.com/es/proteger-pdf",
      "pt": "https://omnispdf.com/pt/proteger-pdf",
    },
  },
}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "Desbloquear PDF", href: "/pt/desbloquear-pdf", desc: "Remover proteção com senha" },
                { name: "Unir PDF", href: "/pt/unir-pdf", desc: "Combinar e depois proteger" },
                { name: "Dividir PDF", href: "/pt/dividir-pdf", desc: "Extrair páginas antes de proteger" },
                { name: "Comprimir PDF", href: "/pt/comprimir-pdf", desc: "Reduzir tamanho após proteger" },
              ].map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
