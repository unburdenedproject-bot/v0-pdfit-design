        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "Dividir PDF", href: "/pt/dividir-pdf", desc: "Extraia paginas antes de girar" },
                { name: "Unir PDF", href: "/pt/unir-pdf", desc: "Combine PDFs apos girar" },
                { name: "Comprimir PDF", href: "/pt/comprimir-pdf", desc: "Reduza o tamanho apos salvar" },
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                ...
                { q: "Qual e o tamanho maximo de arquivo que posso girar?", a: "Contas gratuitas podem enviar arquivos de ate 25MB. Contas Pro e Business podem enviar ate 200MB." },
              ].map((faq, i) => (
