...
export const metadata = {
  ...
  alternates: {
    canonical: "https://omnispdf.com/pt/desbloquear-pdf",
    languages: {
      "en": "https://omnispdf.com/unlock-pdf",
      "es": "https://omnispdf.com/es/desbloquear-pdf",
      "pt": "https://omnispdf.com/pt/desbloquear-pdf",
    },
  },
}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "Proteger PDF", href: "/pt/proteger-pdf", desc: "Adicionar proteção com senha" },
                { name: "Unir PDF", href: "/pt/unir-pdf", desc: "Combinar após desbloquear" },
                { name: "Dividir PDF", href: "/pt/dividir-pdf", desc: "Extrair páginas após desbloquear" },
                { name: "Comprimir PDF", href: "/pt/comprimir-pdf", desc: "Reduzir tamanho após desbloquear" },
              ].map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                ...
                { q: "Qual é o tamanho máximo de arquivo que posso desbloquear?", a: "Contas gratuitas podem enviar arquivos de até 25MB. Contas Pro e Business podem enviar até 200MB." },
              ].map((faq, i) => (
