          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                ...
                { name: "Assinatura Eletrônica", desc: "Adicione assinaturas a PDFs.", href: "/pt/assinatura-eletronica", icon: PenTool },
                { name: "Redação PDF", desc: "Remova informações sensíveis.", href: "/pt/redacao-pdf", icon: Shield },
                ...
                { name: "Achatar PDF", desc: "Bloqueie campos e anotações.", href: "/pt/achatar-pdf", icon: Layers },
