...
export const metadata = {
  ...
  alternates: {
    canonical: "https://omnispdf.com/pt/marca-dagua-pdf",
    languages: {
      "en": "https://omnispdf.com/watermark-pdf",
      "es": "https://omnispdf.com/es/marca-de-agua-pdf",
      "pt": "https://omnispdf.com/pt/marca-dagua-pdf",
    },
  },
}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { name: "Comprimir PDF", href: "/pt/comprimir-pdf", desc: "Reduzir tamanho após marca d'água" },
                { name: "Unir PDF", href: "/pt/unir-pdf", desc: "Combinar documentos com marca d'água" },
                { name: "Dividir PDF", href: "/pt/dividir-pdf", desc: "Adicionar marca d'água só em seções" },
              ].map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
