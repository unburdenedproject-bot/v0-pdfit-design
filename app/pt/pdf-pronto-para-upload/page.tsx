          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { name: "Achatar PDF", href: "/pt/achatar-pdf", desc: "Apenas achatar formulários" },
                { name: "Comprimir PDF", href: "/pt/comprimir-pdf", desc: "Apenas reduzir tamanho" },
              ].map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
