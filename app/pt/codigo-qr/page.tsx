        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "PDF para PNG", href: "/pt/pdf-para-png", desc: "Exporte páginas PDF como imagens" },
                { name: "PDF para JPG", href: "/pt/pdf-para-jpg", desc: "Converta páginas PDF em JPG" },
                { name: "Marca d'Água PDF", href: "/pt/marca-dagua-pdf", desc: "Adicione marca aos seus PDFs" },
