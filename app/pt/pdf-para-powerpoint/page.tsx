...
export const metadata = {
  ...
  alternates: {
    canonical: "https://omnispdf.com/pt/pdf-para-powerpoint",
    languages: {
      en: "https://omnispdf.com/pdf-to-powerpoint",
      es: "https://omnispdf.com/es/pdf-a-powerpoint",
      pt: "https://omnispdf.com/pt/pdf-para-powerpoint",
    },
  },
}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "PDF para Word", href: "/pt/pdf-para-word", desc: "Edite texto no Word" },
                { name: "PDF para Excel", href: "/pt/pdf-para-excel", desc: "Extraia tabelas" },
                { name: "PowerPoint para PDF", href: "/pt/powerpoint-para-pdf", desc: "Converta de volta para PDF" },
                { name: "Comprimir PDF", href: "/pt/comprimir-pdf", desc: "Reduza o tamanho primeiro" },
              ].map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
