...
export const metadata = {
  ...
  alternates: {
    canonical: "https://omnispdf.com/pt/redigir-pdf",
    languages: {
      en: "https://omnispdf.com/redact-pdf",
      es: "https://omnispdf.com/es/redactar-pdf",
      pt: "https://omnispdf.com/pt/redigir-pdf",
    },
  },
}
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                { name: "Redação PDF", desc: "Ferramenta principal de redação.", href: "/pt/redacao-pdf", icon: Shield },
                { name: "Proteger PDF", desc: "Adicione proteção com senha.", href: "/pt/proteger-pdf", icon: Lock },
                { name: "Criptografar PDF", desc: "Cifre seu PDF com senha.", href: "/pt/criptografar-pdf", icon: Lock },
                { name: "Achatar PDF", desc: "Bloqueie campos de formulário.", href: "/pt/achatar-pdf", icon: Layers },
                { name: "Marca d'Água", desc: "Adicione marcas d'água ao PDF.", href: "/pt/marca-dagua-pdf", icon: FileText },
