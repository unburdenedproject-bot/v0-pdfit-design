...
export const metadata = {
  ...
  alternates: {
    languages: {
      ...
      pt: "/pt/comprimir-pdf-digitalizado",
    },
  },
}
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                ...
                { name: "Reduzir Tamanho", desc: "Reduz tamanho geral.", href: "/pt/reduzir-tamanho-pdf", icon: Compress },
        ...
        <section className="py-16 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <Link href="/pt/comprimir-pdf-digitalizado" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-xl text-lg transition-colors shadow-lg">Comprimir PDF Digitalizado</Link>
          </div>
        </section>
      </main>
      <FooterPt />
