...
export const metadata = {
  ...
  alternates: { languages: { en: "/compress-pdf-to-2mb", es: "/es/comprimir-pdf-a-2mb", pt: "/pt/comprimir-pdf-para-2mb" } },
}
...
export default function ComprimirPDFPara2MBPagePt() {
  return (
      ...
      <main>
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Comprima seu PDF para cumprir limites de upload de 2MB. Ideal para portais governamentais, candidaturas de emprego, plataformas educacionais e formularios que exigem arquivos pequenos.</p>
        ...
        <ProcessingInterface acceptedFiles=".pdf" toolName="Compress PDF" outputFormat="PDF" processingMessage="Comprimindo seu PDF para limites de 2MB..." successMessage="Seu PDF comprimido esta pronto!" compressionLevel="recommended" />
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="space-y-10">
              <div className="bg-gray-50 rounded-xl p-8 border border-gray-200"><h3 className="text-xl font-black text-slate-900 mb-3">Candidaturas de Emprego</h3><p className="text-slate-600">Sistemas de rastreamento de candidatos frequentemente limitam uploads a 2MB. Comprima seu curriculo com carta de apresentacao para que suba sem erros.</p></div>
              <div className="bg-gray-50 rounded-xl p-8 border border-gray-200"><h3 className="text-xl font-black text-slate-900 mb-3">Processos Governamentais</h3><p className="text-slate-600">Portais de impostos, licencas e documentos regulatorios frequentemente exigem PDFs abaixo de 2MB.</p></div>
              <div className="bg-gray-50 rounded-xl p-8 border border-gray-200"><h3 className="text-xl font-black text-slate-900 mb-3">Admissao Universitaria</h3><p className="text-slate-600">Historicos, redacoes e cartas de recomendacao para universidades precisam caber nos limites de upload dos portais de admissao.</p></div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                ...
                { name: "Comprimir para Email", desc: "Para anexos de email.", href: "/pt/comprimir-pdf-para-email", icon: Compress },
                ...
                { name: "Achatar PDF", desc: "Remove campos.", href: "/pt/achatar-pdf", icon: FileText },
        ...
        <section className="py-16 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <h2 className="text-2xl font-black mb-4">Precisa Comprimir PDF para 2MB?</h2>
            ...
            <Link href="/pt/comprimir-pdf-para-2mb" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-xl text-lg transition-colors shadow-lg">Comprimir para 2MB Agora</Link>
          </div>
        </section>
      </main>
      <FooterPt />
