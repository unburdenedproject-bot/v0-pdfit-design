...
export const metadata = {
  title: "Converter Excel para PDF Online — XLSX para PDF Gratis | OmnisPDF",
  description:
    "Converta Excel para PDF em segundos com o OmnisPDF. Transforme planilhas XLS ou XLSX em um PDF limpo e pronto para compartilhar — rapido, facil e direto do navegador.",
  alternates: {
    canonical: "https://omnispdf.com/pt/excel-para-pdf",
    languages: {
      en: "https://omnispdf.com/excel-to-pdf",
      es: "https://omnispdf.com/es/excel-a-pdf",
      pt: "https://omnispdf.com/pt/excel-para-pdf",
    },
  },
}
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "O OmnisPDF pode converter tanto XLS quanto XLSX para PDF?",
      acceptedAnswer: { "@type": "Answer", text: "Sim. O OmnisPDF suporta ambos os formatos de arquivo .xls e .xlsx." },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Sim. O OmnisPDF funciona em navegadores moveis — envie o arquivo XLSX e baixe o PDF." },
    },
    {
      "@type": "Question",
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-300 mb-8">
                Converta XLS/XLSX para PDF com o OmnisPDF — ideal para compartilhar relatorios, faturas e planilhas em formato consistente e pronto para imprimir.
              </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <p className="text-lg text-slate-600 mb-8">
              Use o conversor de Excel para PDF do OmnisPDF para transformar uma planilha XLS ou XLSX em um PDF que voce pode compartilhar com qualquer pessoa. Ideal para relatorios, impressao, envio por e-mail e entrega de arquivos — converta em segundos e baixe seu PDF na hora.
            </p>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl space-y-12">
            ...
            <div>
              ...
              <p className="text-slate-600">
                O OmnisPDF converte suas planilhas em um PDF otimizado para visualizacao e impressao padrao, mantendo seus dados claros e organizados.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-4">
              {[
                "Envie ou arraste seu arquivo XLS/XLSX para o OmnisPDF.",
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "Word para PDF", href: "/pt/word-para-pdf", desc: "Converta documentos Word para PDF" },
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                { q: "O OmnisPDF pode converter tanto XLS quanto XLSX para PDF?", a: "Sim. O OmnisPDF suporta ambos os formatos de arquivo .xls e .xlsx." },
