        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "Dividir PDF", href: "/pt/dividir-pdf", desc: "Divida se continuar muito grande" },
                { name: "Unir PDF", href: "/pt/unir-pdf", desc: "Combine após comprimir" },
                { name: "Proteger PDF", href: "/pt/proteger-pdf", desc: "Proteja após comprimir" },
                { name: "Marca d'Água PDF", href: "/pt/marca-dagua-pdf", desc: "Marque após comprimir" },
              ].map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
