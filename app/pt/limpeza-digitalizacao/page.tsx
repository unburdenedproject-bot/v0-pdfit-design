        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                { name: "Scanner OCR", desc: "Torne PDFs escaneados pesquisáveis.", href: "/pt/scanner-ocr", icon: ScanLine },
                { name: "Comprimir PDF", desc: "Reduza o tamanho sem perder qualidade.", href: "/pt/comprimir-pdf", icon: FileText },
                { name: "Unir PDF", desc: "Combine vários PDFs em um.", href: "/pt/unir-pdf", icon: Merge },
                { name: "Girar PDF", desc: "Corrija páginas de lado ou invertidas.", href: "/pt/girar-pdf", icon: RotateCw },
                { name: "Dividir PDF", desc: "Divida um PDF em arquivos separados.", href: "/pt/dividir-pdf", icon: Scissors },
                { name: "Proteger PDF", desc: "Adicione proteção com senha.", href: "/pt/proteger-pdf", icon: Lock },
                { name: "Achatar PDF", desc: "Achate campos e anotações.", href: "/pt/achatar-pdf", icon: FileText },
                { name: "PDF para JPG", desc: "Converta páginas PDF em imagens.", href: "/pt/pdf-para-jpg", icon: FileText },
              ].map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
