...
export const metadata = {
  ...
  alternates: {
    languages: {
      ...
      pt: "/pt/comprimir-pdf-para-100kb",
    },
  },
}
      ...
      <main>
        ...
        <section className="py-16 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <Link href="/pt/comprimir-pdf-para-100kb" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-xl text-lg transition-colors shadow-lg">Comprimir para 100KB Agora</Link>
          </div>
        </section>
      </main>
      <FooterPt />
