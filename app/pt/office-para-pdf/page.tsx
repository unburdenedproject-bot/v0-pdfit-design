...
export const metadata = {
  ...
  alternates: {
    canonical: "https://omnispdf.com/pt/office-para-pdf",
    languages: {
      en: "https://omnispdf.com/office-to-pdf",
      es: "https://omnispdf.com/es/office-a-pdf",
      pt: "https://omnispdf.com/pt/office-para-pdf",
    },
  },
}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-orange-500" /><span>Formatacao Preservada</span></div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "PowerPoint para PDF", href: "/pt/powerpoint-para-pdf", desc: "Converta slides para PDF" },
                { name: "Comprimir PDF", href: "/pt/comprimir-pdf", desc: "Reduza o tamanho apos converter" },
