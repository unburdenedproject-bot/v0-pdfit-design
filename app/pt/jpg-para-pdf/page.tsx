        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                { name: "PNG para PDF", desc: "Converta imagens PNG para PDF.", href: "/pt/png-para-pdf", icon: ImageIcon },
                { name: "PDF para JPG", desc: "Converta paginas PDF em imagens JPG.", href: "/pt/pdf-para-jpg", icon: FileText },
