...
const categories = [
  {
    ...
    tools: [
      ...
      { name: "PDF para Texto", description: "Extraia o texto de um PDF.", icon: Type, href: "/pt/pdf-para-texto", tier: "FREE" as const },
      ...
      { name: "PDF para Excel", description: "Extraia tabelas de PDF para planilha.", icon: FileSpreadsheet, href: "/pt/pdf-para-excel", tier: "PRO" as const },
      { name: "PDF para PowerPoint", description: "Converta paginas PDF em slides.", icon: Presentation, href: "/pt/pdf-para-powerpoint", tier: "PRO" as const },
      { name: "Extrair Imagens", description: "Extraia fotos, logos e graficos de um PDF.", icon: ImageDown, href: "/pt/extrair-imagens-de-pdf", tier: "FREE" as const },
    ],
  },
  {
    ...
    tools: [
      ...
      { name: "Excel para PDF", description: "Converta planilhas para PDF.", icon: FileSpreadsheet, href: "/pt/excel-para-pdf", tier: "PRO" as const },
      { name: "PowerPoint para PDF", description: "Converta apresentacoes para PDF.", icon: Presentation, href: "/pt/powerpoint-para-pdf", tier: "PRO" as const },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "Girar PDF", description: "Corrija a orientacao das paginas.", icon: RotateCw, href: "/pt/girar-pdf", tier: "FREE" as const },
      { name: "Achatar PDF", description: "Trave campos e anotacoes em um PDF plano.", icon: Layers, href: "/pt/achatar-pdf", tier: "FREE" as const },
    ],
  },
  {
    name: "Seguranca",
    ...
    tools: [
      { name: "Proteger PDF", description: "Adicione senha ao seu PDF.", icon: Lock, href: "/pt/proteger-pdf", tier: "FREE" as const },
      ...
      { name: "Marca d'Agua", description: "Adicione marcas d'agua de texto ou imagem.", icon: Droplets, href: "/pt/marca-dagua-pdf", tier: "PRO" as const },
    ],
  },
  {
    name: "Comprimir",
    ...
    tools: [
      { name: "Comprimir PDF", description: "Reduza o tamanho com compressao Leve, Media ou Extrema.", icon: Compress, href: "/pt/comprimir-pdf", tier: "FREE" as const },
      { name: "Comprimir para Email", description: "Reduza PDFs para anexar no Gmail, Outlook e Yahoo.", icon: Mail, href: "/pt/comprimir-pdf-para-email", tier: "FREE" as const },
      { name: "PDF Pronto para Upload", description: "Otimize PDFs para qualquer portal de upload.", icon: Upload, href: "/pt/pdf-pronto-para-upload", tier: "FREE" as const },
    ],
  },
  {
    name: "Digitalizar",
    ...
    tools: [
      { name: "Scanner OCR", description: "Extraia texto de PDFs digitalizados.", icon: Scan, href: "/pt/scanner-ocr", tier: "PRO" as const },
      { name: "Limpeza de Digitalizacao", description: "Converta fotos de documentos em PDFs profissionais.", icon: Camera, href: "/pt/limpeza-digitalizacao", tier: "FREE" as const },
      { name: "Codigo QR", description: "Gere codigos QR a partir de qualquer URL ou texto.", icon: QrCode, href: "/pt/codigo-qr", tier: "PRO" as const },
    ],
  },
  {
    name: "Business",
    ...
    tools: [
      { name: "Automacao", description: "Encadeie varias ferramentas PDF em um fluxo automatico.", icon: Repeat, href: "/pt/automacao", tier: "BUSINESS" as const },
      { name: "Extracao de Tabelas", description: "Extraia tabelas de PDFs diretamente para Excel.", icon: FileSpreadsheet, href: "/pt/extracao-de-tabelas", tier: "BUSINESS" as const },
      { name: "Comparar PDF", description: "Compare dois PDFs lado a lado e destaque diferencas.", icon: ArrowLeftRight, href: "/pt/comparar-pdf", tier: "BUSINESS" as const },
      { name: "Assinatura Eletronica", description: "Adicione assinaturas eletronicas legais a PDFs.", icon: PenTool, href: "/pt/assinatura-eletronica", tier: "BUSINESS" as const },
      { name: "Redacao de PDF", description: "Remova permanentemente texto sensivel de PDFs.", icon: Shield, href: "/pt/redacao-pdf", tier: "BUSINESS" as const },
    ],
  },
]
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-slate-600 max-w-2xl mx-auto leading-relaxed">
                  ...
                  <a href="/pt/contato" className="text-orange-500 hover:text-orange-600 font-medium underline">
                    Fale conosco
                  </a>.
                </p>
              </div>
