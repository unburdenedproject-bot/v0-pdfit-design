...
export const metadata = {
  ...
  alternates: {
    canonical: "https://omnispdf.com/pt/ocr-pdf",
    languages: {
      en: "https://omnispdf.com/ocr-pdf",
      es: "https://omnispdf.com/es/ocr-pdf",
      pt: "https://omnispdf.com/pt/ocr-pdf",
    },
  },
}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                ...
                <div className="flex items-center gap-2"><Download className="h-4 w-4 text-orange-500" /><span>PDF Pesquisavel</span></div>
              </div>
            </div>
          </div>
        </section>
