...
export const metadata = {
  ...
  alternates: { languages: { en: "/compress-pdf-to-500kb", es: "/es/comprimir-pdf-a-500kb", pt: "/pt/comprimir-pdf-para-500kb" } },
}
      ...
      <main>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                { name: "Comprimir para 200KB", desc: "Para limites de 200KB.", href: "/pt/comprimir-pdf-para-200kb", icon: Compress },
        ...
        <section className="py-16 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <Link href="/pt/comprimir-pdf-para-500kb" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-xl text-lg transition-colors shadow-lg">Comprimir para 500KB Agora</Link>
          </div>
        </section>
      </main>
      <FooterPt />
