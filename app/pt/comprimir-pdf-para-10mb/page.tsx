...
export const metadata = {
  ...
  alternates: { languages: { en: "/compress-pdf-to-10mb", es: "/es/comprimir-pdf-a-10mb", pt: "/pt/comprimir-pdf-para-10mb" } },
}
      ...
      <main>
        ...
        <section className="py-16 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <Link href="/pt/comprimir-pdf-para-10mb" className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-xl text-lg transition-colors shadow-lg">Comprimir para 10MB Agora</Link>
          </div>
        </section>
      </main>
      <FooterPt />
