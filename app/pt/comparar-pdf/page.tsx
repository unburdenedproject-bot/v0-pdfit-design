        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                { name: "Redação PDF", desc: "Remova permanentemente texto sensível de PDFs.", href: "/pt/redacao-pdf", icon: Shield },
                { name: "Assinatura Eletrônica", desc: "Adicione assinaturas eletrônicas a PDFs.", href: "/pt/assinatura-eletronica", icon: PenTool },
