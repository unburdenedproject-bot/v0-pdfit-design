...
export const metadata = {
  ...
  alternates: {
    canonical: "https://omnispdf.com/pt/scanner-ocr",
    languages: {
      en: "https://omnispdf.com/ocr-scanner",
      es: "https://omnispdf.com/es/escaner-ocr",
      pt: "https://omnispdf.com/pt/scanner-ocr",
    },
  },
}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "PDF para Texto", href: "/pt/pdf-para-texto", desc: "Extraia texto de PDFs com texto" },
                { name: "Girar PDF", href: "/pt/girar-pdf", desc: "Corrija escaneamentos tortos antes do OCR" },
                { name: "Comprimir PDF", href: "/pt/comprimir-pdf", desc: "Reduza o tamanho antes do OCR" },
                { name: "Dividir PDF", href: "/pt/dividir-pdf", desc: "OCR apenas nas páginas necessárias" },
              ].map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
