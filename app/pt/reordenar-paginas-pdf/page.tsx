...
export const metadata = {
  ...
  alternates: {
    canonical: "https://omnispdf.com/pt/reordenar-paginas-pdf",
    languages: {
      en: "https://omnispdf.com/reorder-pdf-pages",
      es: "https://omnispdf.com/es/reordenar-paginas-pdf",
      pt: "https://omnispdf.com/pt/reordenar-paginas-pdf",
    },
  },
}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-orange-500" /><span>Reorganizacao Visual</span></div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "Girar PDF", href: "/pt/girar-pdf", desc: "Gire paginas do PDF" },
                { name: "Dividir PDF", href: "/pt/dividir-pdf", desc: "Separe paginas do PDF" },
                { name: "Unir PDF", href: "/pt/unir-pdf", desc: "Combine varios PDFs" },
                { name: "Achatar PDF", href: "/pt/achatar-pdf", desc: "Bloqueie formularios e camadas" },
                { name: "Comprimir PDF", href: "/pt/comprimir-pdf", desc: "Reduza o tamanho do arquivo" },
                { name: "Proteger PDF", href: "/pt/proteger-pdf", desc: "Adicione senha ao PDF" },
              ].map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
