...
export const metadata = {
  title: "Converter PDF para Excel Online — Extrair Tabelas de PDF | OmnisPDF",
  description:
    "Converta PDF para Excel com o OmnisPDF. Extraia tabelas e dados dos seus arquivos PDF em planilhas .xlsx editaveis — rapido, seguro e direto do navegador.",
  alternates: {
    canonical: "https://omnispdf.com/pt/pdf-para-excel",
    languages: {
      en: "https://omnispdf.com/pdf-to-excel",
      es: "https://omnispdf.com/es/pdf-a-excel",
      pt: "https://omnispdf.com/pt/pdf-para-excel",
    },
  },
}
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Envie seu PDF para o OmnisPDF, clique em Converter e baixe sua planilha Excel.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "O OmnisPDF extrai tabelas e dados estruturados com a maior precisao possivel. Os resultados podem variar dependendo de como o PDF original foi criado.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "PDFs escaneados requerem OCR para extrair texto e tabelas. Use primeiro a ferramenta Scanner OCR do OmnisPDF e depois converta para Excel.",
      },
    },
    {
      "@type": "Question",
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <p className="text-lg text-slate-600 mb-8">
              Use a ferramenta PDF para Excel do OmnisPDF para extrair tabelas e dados de arquivos PDF em planilhas editaveis. Envie seu PDF, converta e baixe um arquivo .xlsx pronto para analisar — sem precisar instalar nenhum software.
            </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl space-y-12">
            <div>
              ...
              <p className="text-slate-600">
                O OmnisPDF detecta e extrai tabelas dos seus arquivos PDF, convertendo linhas e colunas em celulas do Excel que voce pode editar, filtrar e analisar.
              </p>
            </div>
            <div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "PDF para Word", href: "/pt/pdf-para-word", desc: "Converta PDF para documento editavel" },
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                { q: "Como converto um PDF para Excel?", a: "Envie seu PDF para o OmnisPDF, clique em Converter e baixe sua planilha Excel." },
                { q: "Os dados das tabelas sao extraidos com precisao?", a: "O OmnisPDF extrai tabelas e dados estruturados com a maior precisao possivel. Os resultados podem variar dependendo de como o PDF original foi criado." },
                { q: "Posso converter um PDF escaneado para Excel?", a: "PDFs escaneados requerem OCR para extrair texto e tabelas. Use primeiro a ferramenta Scanner OCR do OmnisPDF e depois converta para Excel." },
                { q: "Posso converter PDF para Excel no celular?", a: "Sim. O OmnisPDF funciona em navegadores moveis — envie, converta e baixe do iPhone ou Android." },
