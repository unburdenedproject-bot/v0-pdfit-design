          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                ...
                { name: "PDF Digitalizado", desc: "Comprime digitalizacoes.", href: "/pt/comprimir-pdf-digitalizado", icon: Compress },
                { name: "PDF para JPG", desc: "Converte em imagens.", href: "/pt/pdf-para-jpg", icon: Image },
