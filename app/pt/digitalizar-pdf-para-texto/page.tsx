...
export const metadata = {
  ...
  alternates: {
    canonical: "https://omnispdf.com/pt/digitalizar-pdf-para-texto",
    languages: {
      en: "https://omnispdf.com/scan-pdf-to-text",
      es: "https://omnispdf.com/es/escanear-pdf-a-texto",
      pt: "https://omnispdf.com/pt/digitalizar-pdf-para-texto",
    },
  },
}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-orange-500" /><span>OCR Avançado</span></div>
