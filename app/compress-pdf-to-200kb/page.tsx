      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              ...
              <li className="flex items-center gap-2">✓ Perfect for passport, ID, and signature uploads</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Passport & ID Photo Submissions", desc: "Passport renewal portals and national ID upload systems often require files under 200KB. Compress your scanned passport photo or ID PDF to meet these strict size requirements." },
                { title: "Digital Signature Files", desc: "Many platforms require signature files under 200KB for electronic document signing. Compress your scanned signature PDF to meet file size limits while keeping it legible." },
                { title: "Strict Government Portals", desc: "Some government systems enforce very low upload caps of 200KB per document. Compress your forms, certificates, and supporting documents to submit without errors." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF for 200KB Limits</h2>
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "Compress to 100KB", href: "/compress-pdf-to-100kb", desc: "For 100KB upload limits" },
