...
export default function ReordenarPaginasPDFPage() {
  const faqs = [
    {
        "q": "Como reordeno paginas em um PDF?",
        "a": "Use Dividir PDF para extrair paginas, depois Unir PDF para recombina-las na ordem desejada."
    },
    {
        "q": "Posso mover uma pagina especifica?",
        "a": "Sim. Divida para extrair a pagina, depois una todas na nova ordem."
    },
    {
        "q": "Posso reorganizar no celular?",
        "a": "Sim. O PDF.it funciona em navegadores moveis."
    },
    {
        "q": "Preciso instalar software?",
        "a": "Nao. Roda inteiramente no navegador."
    },
    {
        "q": "E seguro enviar meu PDF?",
        "a": "Sim. Criptografia SSL e exclusao apos a sessao."
    },
    {
        "q": "Posso inverter a ordem?",
        "a": "Sim. Divida e una na ordem reversa."
    }
]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Reorganize paginas em qualquer PDF dividindo e unindo. Extraia as paginas necessarias, coloque na ordem certa e baixe um documento reorganizado.</p>
            <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Qualquer Ordem de Paginas</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">Reordenar paginas PDF e facil com o PDF.it. Use a ferramenta Dividir PDF para extrair paginas individuais, depois envie para Unir PDF na ordem desejada. O PDF.it combina em um unico PDF reorganizado — pronto para baixar, imprimir ou compartilhar.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Reorganize paginas em qualquer ordem</li>
              <li className="flex items-center gap-2">✓ Mova, troque ou inverta sequencias</li>
              <li className="flex items-center gap-2">✓ Sem instalacao de software</li>
              <li className="flex items-center gap-2">✓ Funciona no Mac, Windows, iOS, Android e Linux</li>
          </ul>
        </div></section>

        <section className="py-12 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-md text-center"><div className="flex flex-col sm:flex-row gap-4 justify-center"><Link href="/br/dividir-pdf" className="inline-flex items-center justify-center bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-3 px-8 rounded-xl transition-colors">Passo 1: Dividir PDF</Link><Link href="/br/unir-pdf" className="inline-flex items-center justify-center bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-3 px-8 rounded-xl transition-colors">Passo 2: Unir PDF</Link></div></div></section>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Corrija a Ordem Incorreta", desc: "Documentos escaneados as vezes ficam fora de ordem. Use Dividir e Unir para corrigir a sequencia rapidamente." },
                { title: "Reorganize Apresentacoes", desc: "Precisa mover uma secao para o inicio? Divida e una na nova ordem para um documento final polido." },
                { title: "Organize Documentos Escaneados", desc: "Paginas escaneadas na ordem errada? Extraia cada pagina e recombine na sequencia correta." },
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
            {[{ num: "1", title: "Divida seu PDF", desc: "Extraia paginas individuais ou grupos" }, { num: "2", title: "Una na nova ordem", desc: "Envie paginas na sequencia desejada" }, { num: "3", title: "Baixe seu PDF", desc: "Receba o documento reordenado" }].map((step) => (<div key={step.num} className="flex-1"><div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3" style={{ background: "linear-gradient(135deg, #1a1f5e, #252A6A)", boxShadow: "0 0 20px rgba(20, 216, 196, 0.3), 0 4px 8px rgba(232,129,58,0.1)", border: "1px solid rgba(20,216,196,0.25)" }}><span className="text-[#14D8C4] font-black text-lg">{step.num}</span></div><p className="font-semibold text-slate-900">{step.title}</p><p className="text-sm text-slate-500 mt-1">{step.desc}</p></div>))}
          </div>
        </div></section>
