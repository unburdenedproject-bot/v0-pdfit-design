    ...
    <div className="min-h-screen bg-[#F3F4FF]">
      ...
      <main>
        ...
        <section className="py-8 bg-[#F0FDFA] border-b border-[#14D8C4]/10"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 bg-[#14D8C4] rounded-lg flex items-center justify-center flex-shrink-0"><Unlock className="h-5 w-5 text-white" /></div><p className="text-slate-700 font-semibold">PDF com restricoes de permissao? Tente a ferramenta.</p></div>
        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <section className="mb-12">
            ...
            <ul className="space-y-3 text-slate-700">
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">A.</span><span><strong>Senha de abertura (nao consigo abrir o PDF).</strong> Esse e o caso mais dificil. O PDF e criptografado e sem a senha correta, o conteudo e inacessivel.</span></li>
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">B.</span><span><strong>Senha de permissoes (consigo abrir mas nao imprimir/copiar).</strong> Esse caso tem solucao! A ferramenta Desbloquear PDF do PDF.it pode remover essas restricoes.</span></li>
            </ul>
          </section>
