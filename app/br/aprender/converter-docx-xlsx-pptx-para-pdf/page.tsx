        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 text-slate-700">
              <li>&#10003; <Link href="/br/word-para-pdf" className="text-[#14D8C4] hover:underline">Word para PDF</Link> — otimizada para documentos de texto com cabecalhos, rodapes e indice.</li>
              <li>&#10003; <Link href="/br/excel-para-pdf" className="text-[#14D8C4] hover:underline">Excel para PDF</Link> — preserva tabelas, graficos e areas de impressao.</li>
              <li>&#10003; <Link href="/br/powerpoint-para-pdf" className="text-[#14D8C4] hover:underline">PowerPoint para PDF</Link> — converte slides com imagens, formas e graficos.</li>
              <li>&#10003; <Link href="/br/office-para-pdf" className="text-[#14D8C4] hover:underline">Office para PDF</Link> — aceita qualquer formato em uma unica interface.</li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 text-slate-700">
              <li>&#10003; <strong>Incorpore fontes</strong> em todos os documentos antes de converter. Veja nosso guia de <Link href="/br/aprender/pptx-para-pdf-fontes-faltando" className="text-[#14D8C4] hover:underline">fontes faltando</Link>.</li>
              ...
              <li>&#10003; Para manter o formato perfeito, leia nosso guia de <Link href="/br/aprender/office-para-pdf-manter-formato" className="text-[#14D8C4] hover:underline">como manter a formatacao</Link>.</li>
            </ul>
          </section>
        </div></article>
