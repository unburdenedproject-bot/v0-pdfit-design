          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">1.</span><span><strong>Comprovante ou recibo.</strong> Precisa salvar apenas a página do comprovante para enviar por mensagem.</span></li>
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">2.</span><span><strong>Capa de documento.</strong> Quer a primeira página como miniatura ou imagem de capa.</span></li>
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">3.</span><span><strong>Gráfico ou tabela.</strong> Precisa de uma página com gráfico para inserir em apresentação ou relatório.</span></li>
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">4.</span><span><strong>Formulário preenchido.</strong> Quer salvar como imagem para referência rápida.</span></li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mb-4">Se seu PDF é grande e você só precisa de uma página, considere usar <Link href="/br/dividir-pdf" className="text-orange-600 hover:underline">Dividir PDF</Link> primeiro:</p>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600">Se a página tem gráficos, tabelas ou texto fino que precisa ficar nítido, considere converter para <Link href="/br/pdf-para-png" className="text-orange-600 hover:underline">PNG</Link> em vez de JPG. O PNG mantém a qualidade sem artefatos de compressão.</p>
            </section>
