          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">1.</span><span><strong>Sem artefatos.</strong> PNG usa compressão sem perda — texto, linhas e bordas ficam perfeitamente nítidos, sem os artefatos que JPG cria.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">2.</span><span><strong>Suporte a transparência.</strong> PNG suporta canal alfa (transparência), útil para sobrepor elementos em fundos coloridos.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">3.</span><span><strong>Compatibilidade universal.</strong> Todas as ferramentas de design (Canva, Figma, Photoshop, Illustrator, InDesign) trabalham perfeitamente com PNG.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">4.</span><span><strong>Cores precisas.</strong> PNG preserva as cores originais do PDF sem alteração pela compressão.</span></li>
              </ul>
            </section>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-t border-gray-200"><td className="py-3 px-4 font-semibold">Canva</td><td className="py-3 px-4 text-[#14D8C4] font-semibold">300 DPI</td><td className="py-3 px-4">Use Upload &gt; Faça upload de mídia</td></tr>
                    <tr className="border-t border-gray-200 bg-gray-50"><td className="py-3 px-4 font-semibold">Figma</td><td className="py-3 px-4 text-[#14D8C4] font-semibold">300 DPI</td><td className="py-3 px-4">Arraste direto para o canvas</td></tr>
                    <tr className="border-t border-gray-200"><td className="py-3 px-4 font-semibold">Photoshop</td><td className="py-3 px-4 text-[#14D8C4] font-semibold">300 DPI</td><td className="py-3 px-4">Abra como nova camada</td></tr>
                    <tr className="border-t border-gray-200 bg-gray-50"><td className="py-3 px-4 font-semibold">Google Slides</td><td className="py-3 px-4 text-[#14D8C4] font-semibold">200 DPI</td><td className="py-3 px-4">Inserir &gt; Imagem</td></tr>
                  </tbody>
                </table>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-600">Se precisa de apenas uma parte do PDF, use <Link href="/br/dividir-pdf" className="text-[#14D8C4] hover:underline">Dividir PDF</Link> primeiro para extrair as páginas relevantes. Depois converta para PNG.</p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Extraia Imagens Diretamente</h3>
                  <p className="text-slate-600">Se precisa de imagens individuais do PDF (fotos, logos), use <Link href="/br/extrair-imagens-de-pdf" className="text-[#14D8C4] hover:underline">Extrair Imagens de PDF</Link> para obter as imagens originais em resolução total.</p>
                </div>
                <div>
