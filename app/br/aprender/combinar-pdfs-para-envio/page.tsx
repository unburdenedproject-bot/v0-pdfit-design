          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>&#10003; <strong>Comprima depois de unir</strong> usando <Link href="/br/comprimir-pdf" className="text-[#14D8C4] hover:underline">Comprimir PDF</Link> — especialmente para documentos digitalizados.</li>
                <li>&#10003; <strong>Proteja documentos sensiveis</strong> com senha usando <Link href="/br/proteger-pdf" className="text-[#14D8C4] hover:underline">Proteger PDF</Link> antes de enviar.</li>
