          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">1.</span><span><strong>Busca instantanea.</strong> Encontre qualquer palavra em documentos de centenas de paginas usando Ctrl+F.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">2.</span><span><strong>Copiar e colar.</strong> Selecione trechos de texto e cole em e-mails, planilhas ou outros documentos sem redigitar.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">3.</span><span><strong>Indexacao.</strong> Sistemas de gerenciamento de documentos podem indexar o conteudo para busca futura.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">4.</span><span><strong>Acessibilidade.</strong> Leitores de tela podem ler o conteudo para usuarios com deficiencia visual.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">5.</span><span><strong>Conversao posterior.</strong> Converta para <Link href="/br/pdf-para-texto" className="text-[#14D8C4] hover:underline">texto simples</Link> ou <Link href="/br/pdf-para-word" className="text-[#14D8C4] hover:underline">Word</Link> com resultados muito superiores.</span></li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>&#10003; Apos o OCR, use <Link href="/br/comprimir-pdf" className="text-[#14D8C4] hover:underline">Comprimir PDF</Link> para reduzir o tamanho do arquivo.</li>
              </ul>
            </section>
          </div>
        </article>
