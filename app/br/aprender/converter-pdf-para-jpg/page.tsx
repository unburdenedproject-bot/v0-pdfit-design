          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">1.</span><span><strong>Apresentações.</strong> Você não pode arrastar um PDF para o PowerPoint ou Google Slides — mas pode inserir um JPG. Converter páginas em imagens permite usar conteúdo PDF em qualquer apresentação.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">2.</span><span><strong>Redes sociais e sites.</strong> Plataformas como Instagram, Facebook e a maioria dos construtores de sites não aceitam upload de PDF. JPG é universalmente aceito.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">3.</span><span><strong>Pré-visualizações rápidas.</strong> Às vezes você precisa de uma miniatura ou imagem de pré-visualização de um documento — um JPG da primeira página funciona perfeitamente.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">4.</span><span><strong>Apps de mensagem.</strong> Compartilhar um JPG no WhatsApp, Slack ou Teams mostra uma pré-visualização inline. PDFs geralmente exigem que o destinatário baixe e abra um arquivo separado.</span></li>
              </ul>
            </section>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-t border-gray-200"><td className="py-3 px-4 font-semibold text-[#14D8C4]">72 DPI</td><td className="py-3 px-4">Miniaturas rápidas, pré-visualizações web</td><td className="py-3 px-4">Pequeno (~100-300KB)</td></tr>
                    <tr className="border-t border-gray-200 bg-gray-50"><td className="py-3 px-4 font-semibold text-[#14D8C4]">150 DPI</td><td className="py-3 px-4">Email, uso web, redes sociais</td><td className="py-3 px-4">Médio (~300-800KB)</td></tr>
                    <tr className="border-t border-gray-200"><td className="py-3 px-4 font-semibold text-[#14D8C4]">200 DPI</td><td className="py-3 px-4">Apresentações, documentos, visualização clara</td><td className="py-3 px-4">Grande (~500KB-1.5MB)</td></tr>
                    <tr className="border-t border-gray-200 bg-gray-50"><td className="py-3 px-4 font-semibold text-[#14D8C4]">300 DPI</td><td className="py-3 px-4">Impressão, arquivamento, máxima qualidade</td><td className="py-3 px-4">Muito grande (~1-3MB por página)</td></tr>
                  </tbody>
                </table>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 mt-2">Precisa de PNG? Use nossa ferramenta <Link href="/br/pdf-para-png" className="text-[#14D8C4] hover:underline">PDF para PNG</Link> para conversão sem perda.</p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mt-4">Usuários gratuitos podem converter um arquivo por vez. Se você converte PDFs regularmente, <Link href="/br/precos" className="text-[#14D8C4] hover:underline">atualizar para Pro</Link> economiza tempo significativo.</p>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-600">Se seu PDF é muito grande, <Link href="/br/comprimir-pdf" className="text-[#14D8C4] hover:underline">comprima primeiro</Link> para eliminar dados desnecessários. Isso pode acelerar o processo de conversão sem afetar a qualidade final do JPG.</p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Divida Primeiro, Converta Depois</h3>
                  <p className="text-slate-600">Se você só precisa de algumas páginas como JPG, não converta o PDF inteiro. Use <Link href="/br/dividir-pdf" className="text-[#14D8C4] hover:underline">Dividir PDF</Link> para extrair apenas as páginas que precisa, depois converta para JPG. Mais rápido e menos bagunça.</p>
                </div>
                <div>
