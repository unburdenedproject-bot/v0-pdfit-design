              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-600">
                    Extraia paginas do primeiro PDF, depois do segundo, e use <Link href="/br/unir-pdf" className="text-[#14D8C4] hover:underline">Unir PDF</Link> para combinar os resultados em um unico documento.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Extrair e comprimir</h3>
                  <p className="text-slate-600">
                    Extraia as paginas desejadas e depois use <Link href="/br/comprimir-pdf" className="text-[#14D8C4] hover:underline">Comprimir PDF</Link> para reduzir o tamanho do resultado — especialmente util para documentos digitalizados.
                  </p>
                </div>
                <div>
