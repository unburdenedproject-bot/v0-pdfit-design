          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody className="text-slate-700">
                    ...
                    <tr className="border-t border-gray-200">
                      <td className="py-3 px-4 font-semibold text-[#14D8C4]">180°</td>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>&#10003; <strong>Gire antes de unir:</strong> se vai combinar documentos digitalizados com <Link href="/br/unir-pdf" className="text-[#14D8C4] hover:underline">Unir PDF</Link>, corrija a orientacao de cada um primeiro.</li>
                <li>&#10003; <strong>Funciona no celular:</strong> corrija paginas diretamente no iPhone ou Android pelo navegador.</li>
                <li>&#10003; <strong>Apos girar</strong>, voce pode <Link href="/br/comprimir-pdf" className="text-[#14D8C4] hover:underline">comprimir</Link> para reduzir o tamanho do arquivo.</li>
              </ul>
            </section>
