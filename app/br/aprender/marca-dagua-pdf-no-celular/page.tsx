        ...
        <article className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mt-4">Depois de adicionar a marca d&apos;agua, voce pode usar <Link href="/br/comprimir-pdf" className="text-orange-600 hover:underline">Comprimir PDF</Link> para reduzir o tamanho antes de enviar por e-mail.</p>
            </section>
          </div>
        </article>
