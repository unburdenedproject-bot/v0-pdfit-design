    ...
    <div className="min-h-screen bg-[#F3F4FF]">
      ...
      <main>
        ...
        <section className="py-8 bg-[#F0FDFA] border-b border-[#14D8C4]/10"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 bg-[#14D8C4] rounded-lg flex items-center justify-center flex-shrink-0"><Send className="h-5 w-5 text-white" /></div><p className="text-slate-700 font-semibold">Quer converter agora? Va direto para a ferramenta.</p></div>
          <Link href="/br/office-para-pdf" className="inline-flex items-center gap-2 bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-2.5 px-6 rounded-xl text-sm transition-colors whitespace-nowrap">Converter para PDF <ArrowRight className="h-4 w-4" /></Link>
        </div></section>
        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <section className="mb-12">
            ...
            <ul className="space-y-3 text-slate-700">
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">1.</span><span><strong>Aparencia.</strong> Documentos do Office podem parecer diferentes em cada computador. PDF garante aparencia identica.</span></li>
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">2.</span><span><strong>Editabilidade.</strong> DOCX e XLSX podem ser editados pelo destinatario. PDF protege o conteudo.</span></li>
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">3.</span><span><strong>Compatibilidade.</strong> Nem todos tem Microsoft Office. PDFs abrem em qualquer dispositivo.</span></li>
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">4.</span><span><strong>Profissionalismo.</strong> Enviar PDF passa uma imagem mais profissional do que enviar um DOCX.</span></li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 text-slate-700">
              ...
              <li>&#10003; <strong>Contrato para assinatura:</strong> PDF (ou use <Link href="/br/assinatura-eletronica" className="text-[#14D8C4] hover:underline">assinatura eletronica</Link>).</li>
              ...
              <li>&#10003; <strong>Proposta comercial:</strong> PDF, idealmente com <Link href="/br/aprender/como-proteger-pdf-com-senha" className="text-[#14D8C4] hover:underline">senha de protecao</Link>.</li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 text-slate-700">
              <li>&#10003; <Link href="/br/word-para-pdf" className="text-[#14D8C4] hover:underline">Word para PDF</Link> — para documentos DOCX e DOC.</li>
              <li>&#10003; <Link href="/br/excel-para-pdf" className="text-[#14D8C4] hover:underline">Excel para PDF</Link> — para planilhas XLSX e XLS.</li>
              <li>&#10003; <Link href="/br/powerpoint-para-pdf" className="text-[#14D8C4] hover:underline">PowerPoint para PDF</Link> — para apresentacoes PPTX e PPT.</li>
              <li>&#10003; <Link href="/br/office-para-pdf" className="text-[#14D8C4] hover:underline">Office para PDF</Link> — para qualquer formato em uma ferramenta.</li>
            </ul>
            <p className="text-slate-600 mt-4">Se o PDF ficar grande demais para email, use o <Link href="/br/comprimir-pdf" className="text-[#14D8C4] hover:underline">compressor de PDF</Link> para reduzir o tamanho.</p>
          </section>
        </div></article>
        ...
        <section className="py-12" style={{ background: "#0E0F1E" }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl text-center">
          ...
          <Link href="/br/office-para-pdf" className="inline-flex items-center gap-2 bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-3 px-8 rounded-xl transition-colors"><Send className="h-5 w-5" /> Converter para PDF Agora</Link>
        </div></section>
