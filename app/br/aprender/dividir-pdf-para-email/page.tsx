          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                  ...
                  <p className="text-slate-600 text-sm">Se o PDF esta entre 25-50MB, a <Link href="/br/comprimir-pdf" className="text-[#14D8C4] hover:underline">compressao</Link> pode ser suficiente para caber no limite. Especialmente eficaz para documentos digitalizados.</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>&#10003; <strong>O destinatario pode recombinar</strong> usando <Link href="/br/unir-pdf" className="text-[#14D8C4] hover:underline">Unir PDF</Link> do PDF.it.</li>
                <li>&#10003; <strong>Alternativa:</strong> use <Link href="/br/comprimir-pdf" className="text-[#14D8C4] hover:underline">Comprimir PDF</Link> primeiro — pode ser suficiente para caber no limite sem precisar dividir.</li>
              </ul>
            </section>
