          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">1.</span><span><strong>Documentos para enviar.</strong> Se precisa enviar uma página de documento por mensagem com texto legível, PNG mantém a nitidez.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">2.</span><span><strong>Uso em apps de design.</strong> Apps como Canva no celular funcionam melhor com PNG para manter a qualidade.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">3.</span><span><strong>Capturas para apresentações.</strong> PNGs de PDFs ficam perfeitos quando inseridos em apresentações no celular.</span></li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mt-4">Prefere JPG? Use nossa ferramenta <Link href="/br/pdf-para-jpg" className="text-[#14D8C4] hover:underline">PDF para JPG</Link>.</p>
            </section>
