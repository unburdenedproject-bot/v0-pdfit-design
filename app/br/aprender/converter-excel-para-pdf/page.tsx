          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">1.</span><span><strong>Compartilhamento profissional.</strong> PDFs são universais — qualquer pessoa pode abrir sem ter Excel instalado.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">2.</span><span><strong>Proteção de dados.</strong> O destinatário não pode alterar os dados ou ver fórmulas — vê apenas o resultado visual.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">3.</span><span><strong>Impressão consistente.</strong> O PDF garante que a planilha será impressa exatamente como você vê na tela.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">4.</span><span><strong>Relatórios e apresentações.</strong> PDFs de planilhas são ideais para anexar a emails, relatórios e apresentações.</span></li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mb-4">O maior problema ao converter Excel para PDF é planilhas largas que não cabem em uma página. Leia nosso guia detalhado: <Link href="/br/aprender/excel-para-pdf-colunas-cortadas" className="text-[#14D8C4] hover:underline">Excel para PDF — Colunas Cortadas</Link>.</p>
              ...
              <ul className="space-y-2 text-slate-700 mt-2">
                ...
                <li>- Use "Ajustar à página" (veja: <Link href="/br/aprender/excel-para-pdf-ajustar-a-pagina" className="text-[#14D8C4] hover:underline">Excel para PDF — Ajustar à Página</Link>)</li>
              </ul>
            </section>
