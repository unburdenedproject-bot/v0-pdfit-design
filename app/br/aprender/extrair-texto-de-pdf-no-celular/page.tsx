          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">1.</span><span><strong>Copiar dados de um recibo.</strong> Precisa do número do pedido ou valor de uma fatura em PDF.</span></li>
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">2.</span><span><strong>Salvar informações.</strong> Quer copiar trechos de um documento para suas notas ou mensagem.</span></li>
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">3.</span><span><strong>Traduzir conteúdo.</strong> Extrair o texto para colar no Google Tradutor ou outro serviço de tradução.</span></li>
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">4.</span><span><strong>Responder emails.</strong> Copiar informações de um PDF anexo para responder um email rapidamente.</span></li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mb-4">Se o PDF foi escaneado (você não consegue selecionar texto), a ferramenta PDF para Texto não vai funcionar. Neste caso, use o <Link href="/br/scanner-ocr" className="text-orange-600 hover:underline">Scanner OCR</Link> que reconhece texto em imagens usando inteligência artificial.</p>
