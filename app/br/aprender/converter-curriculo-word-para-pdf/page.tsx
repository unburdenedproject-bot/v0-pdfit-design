        ...
        <article className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mb-4">Com o curriculo preparado no Word, use o <Link href="/br/word-para-pdf" className="text-[#14D8C4] hover:underline">conversor Word para PDF</Link> do PDF.it:</p>
