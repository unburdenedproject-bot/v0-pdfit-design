          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
                ...
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-t border-gray-200">
                      <td className="py-3 px-4 font-semibold text-[#14D8C4]">Extrair Paginas</td>
                    ...
                    <tr className="border-t border-gray-200 bg-gray-50">
                      <td className="py-3 px-4 font-semibold text-[#14D8C4]">Dividir PDF</td>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>&#10003; <strong>Comprima o resultado</strong> com <Link href="/br/comprimir-pdf" className="text-[#14D8C4] hover:underline">Comprimir PDF</Link> se o arquivo extraido ainda for grande.</li>
                <li>&#10003; <strong>Combine com Unir:</strong> extraia paginas de diferentes PDFs e depois use <Link href="/br/unir-pdf" className="text-[#14D8C4] hover:underline">Unir PDF</Link> para combina-las.</li>
              </ul>
            </section>
