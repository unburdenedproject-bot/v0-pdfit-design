        ...
        <article className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Se o PDF foi criado a partir de um escaneamento em baixa qualidade, nenhuma configuração de conversão vai melhorar a imagem. A qualidade do JPG nunca supera a do PDF original. Tente usar <Link href="/br/scanner-ocr" className="text-orange-600 hover:underline">Scanner OCR</Link> para melhorar documentos digitalizados.</p>
                </div>
                <div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-t border-gray-200"><td className="py-3 px-4">WhatsApp, miniaturas</td><td className="py-3 px-4 font-semibold text-orange-600">150 DPI</td><td className="py-3 px-4">Bom, arquivo pequeno</td></tr>
                    <tr className="border-t border-gray-200 bg-gray-50"><td className="py-3 px-4">Apresentações, documentos</td><td className="py-3 px-4 font-semibold text-orange-600">200 DPI</td><td className="py-3 px-4">Muito bom, arquivo moderado</td></tr>
                    <tr className="border-t border-gray-200"><td className="py-3 px-4">Impressão, design</td><td className="py-3 px-4 font-semibold text-orange-600">300 DPI</td><td className="py-3 px-4">Excelente, arquivo grande</td></tr>
                  </tbody>
                </table>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mb-4">Se mesmo com 300 DPI seu JPG tem artefatos visíveis ao redor do texto, considere usar <Link href="/br/pdf-para-png" className="text-orange-600 hover:underline">PDF para PNG</Link>. O formato PNG:</p>
