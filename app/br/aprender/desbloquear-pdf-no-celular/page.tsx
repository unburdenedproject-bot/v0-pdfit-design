    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="py-8 bg-orange-50 border-b border-orange-100"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center flex-shrink-0"><Smartphone className="h-5 w-5 text-white" /></div><p className="text-slate-700 font-semibold">Pronto para desbloquear? Pule o guia e va direto para a ferramenta.</p></div>
        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <section className="mb-12">
            ...
            <ul className="space-y-3 text-slate-700">
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">1.</span><span><strong>Recebeu PDF protegido pelo WhatsApp.</strong> Um colega enviou um documento com senha e voce precisa salvar sem protecao.</span></li>
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">2.</span><span><strong>Precisa imprimir do celular.</strong> O PDF tem restricao de impressao e voce quer imprimir via AirPrint ou Google Cloud Print.</span></li>
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">3.</span><span><strong>Nao tem computador disponivel.</strong> Voce esta fora do escritorio e precisa resolver rapidamente.</span></li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 text-slate-700">
              <li>&#10003; <strong>Esqueceu a senha?</strong> Veja nosso guia de <Link href="/br/aprender/desbloquear-pdf-senha-esquecida" className="text-orange-600 hover:underline">PDF com senha esquecida</Link>.</li>
              <li>&#10003; <strong>Precisa imprimir?</strong> Apos desbloquear, veja <Link href="/br/aprender/desbloquear-pdf-para-imprimir" className="text-orange-600 hover:underline">como desbloquear para imprimir</Link>.</li>
              <li>&#10003; <strong>Quer proteger depois?</strong> Use a ferramenta <Link href="/br/aprender/proteger-pdf-no-celular" className="text-orange-600 hover:underline">Proteger PDF no celular</Link> para adicionar uma nova senha.</li>
            </ul>
          </section>
        </div></article>
        ...
        <section className="py-12 bg-gradient-to-br from-slate-900 to-slate-800"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl text-center">
          ...
          <Link href="/br/desbloquear-pdf" className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-xl transition-colors"><Smartphone className="h-5 w-5" /> Desbloquear PDF Agora</Link>
        </div></section>
