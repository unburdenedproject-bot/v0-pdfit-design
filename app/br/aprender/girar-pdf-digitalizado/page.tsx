          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                <li>&#10003; <strong>Passo 1: Gire</strong> — corrija a orientacao de todas as paginas usando <Link href="/br/girar-pdf" className="text-[#14D8C4] hover:underline">Girar PDF</Link>.</li>
                <li>&#10003; <strong>Passo 2: Una</strong> — se tem varios PDFs digitalizados, combine com <Link href="/br/unir-pdf" className="text-[#14D8C4] hover:underline">Unir PDF</Link>.</li>
                <li>&#10003; <strong>Passo 3: Comprima</strong> — reduza o tamanho com <Link href="/br/comprimir-pdf" className="text-[#14D8C4] hover:underline">Comprimir PDF</Link> (documentos digitalizados comprimem muito bem).</li>
                <li>&#10003; <strong>Passo 4: OCR (opcional)</strong> — se precisa que o texto seja pesquisavel, use <Link href="/br/ocr-pdf" className="text-[#14D8C4] hover:underline">OCR PDF</Link>.</li>
              </ul>
            </section>
