      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: "A Automação de Fluxos é grátis?", a: "A Automação de Fluxos é uma função do plano Enterprise ($49,99/mês). Inclui fluxos ilimitados junto com todas as outras ferramentas Enterprise." },
        ...
        <Script id="faq-schema-pt" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "A Automação de Fluxos é grátis?", "acceptedAnswer": { "@type": "Answer", "text": "A Automação de Fluxos é uma função do plano Enterprise ($49,99/mês). Inclui fluxos ilimitados junto com todas as outras ferramentas Enterprise." } },
