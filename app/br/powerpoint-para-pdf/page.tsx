...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "O PDF.it pode converter tanto PPT quanto PPTX para PDF?",
      "acceptedAnswer": { "@type": "Answer", "text": "Sim. O PDF.it suporta ambos os formatos de arquivo .ppt e .pptx." }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Sim. O PDF.it funciona em navegadores moveis — envie sua apresentacao e baixe o PDF." }
    },
    {
      "@type": "Question",
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl space-y-12">
            ...
            <div>
              ...
              <p className="text-slate-600">
                O PDF.it converte os slides em paginas PDF para que seu texto, imagens e graficos sejam faceis de ler e compartilhar. Nota: animacoes e transicoes se tornam estaticas no formato PDF.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-4">
              {[
                "Envie ou arraste seu arquivo PPT/PPTX para o PDF.it.",
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { name: "Office para PDF", href: "/br/office-para-pdf", desc: "Converta arquivos Office para PDF" },
                { name: "Comprimir PDF", href: "/br/comprimir-pdf", desc: "Reduza o tamanho do seu PDF" },
