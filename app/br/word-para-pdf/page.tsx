      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-[#14D8C4]" /><span>Formatacao Preservada</span></div>
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Arquivos Eliminados Apos a Sessao</span></div>
                <div className="flex items-center gap-2"><Download className="h-4 w-4 text-[#14D8C4]" /><span>DOC e DOCX Suportados</span></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Converte Word para PDF online em segundos</li>
              <li className="flex items-center gap-2">✓ Suporta arquivos DOC e DOCX</li>
              <li className="flex items-center gap-2">✓ Cria PDFs prontos para compartilhar por e-mail, imprimir e enviar</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Converta DOCX para PDF Mantendo o Layout", desc: "O PDF.it converte documentos Word em PDFs projetados para ficarem consistentes em todos os dispositivos. Ideal para enviar arquivos onde a formatacao precisa se manter estavel." },
                { title: "Torne seus Documentos Word Faceis de Compartilhar e Imprimir", desc: "PDFs sao o padrao para entregas, impressao e documentos oficiais. Converta seu arquivo Word para PDF para que os destinatarios vejam o mesmo layout — independente do software que usem." },
                { title: "Conversao Rapida Online — Sem Apps", desc: "Envie um arquivo Word, converta para PDF e baixe imediatamente — sem downloads, sem instalacoes e sem etapas complicadas." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Converter Word para PDF</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Envie seu arquivo", desc: "Envie ou arraste seu arquivo DOC/DOCX para o PDF.it." },
                { num: "2", title: "Clique em Converter", desc: "Clique em Converter Word para PDF." },
                { num: "3", title: "Baixe seu PDF", desc: "Baixe seu novo PDF." },
              ].map((step) => (
        ...
        <Script id="faq-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "FAQPage",
          "mainEntity": [
            { "@type": "Question", "name": "Posso converter tanto DOC quanto DOCX para PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Sim. O PDF.it suporta ambos os formatos de arquivo .doc e .docx." } },
            { "@type": "Question", "name": "O PDF mantera a formatacao do meu arquivo Word?", "acceptedAnswer": { "@type": "Answer", "text": "Na maioria dos casos, sim — o PDF.it preserva o layout, fontes e espacamento. Documentos complexos com fontes personalizadas ou tabelas incomuns podem variar ligeiramente." } },
            { "@type": "Question", "name": "Posso converter Word para PDF no celular?", "acceptedAnswer": { "@type": "Answer", "text": "Sim. O PDF.it funciona em navegadores moveis — envie seu arquivo Word e baixe o PDF." } },
            { "@type": "Question", "name": "E seguro enviar meu documento Word?", "acceptedAnswer": { "@type": "Answer", "text": "Sim. Todas as transferencias sao criptografadas com SSL e seus arquivos sao eliminados imediatamente apos sua sessao. Nunca armazenamos nem compartilhamos seus documentos." } },
            ...
            { "@type": "Question", "name": "Meu PDF parece diferente do meu arquivo Word — por que?", "acceptedAnswer": { "@type": "Answer", "text": "As diferencas podem ocorrer por fontes incorporadas ou formatacao complexa. Tente simplificar o espacamento, usar fontes padrao ou exportar novamente." } }
          ]
        })}} />
      </main>
      <FooterBr />
