...
const posts = [
  {
    ...
    excerpt:
      "Criamos o PDF.it porque profissionais merecem ferramentas PDF melhores. Nossa historia e o que nos torna diferentes.",
    date: "2026-04-01",
    category: "Anuncio",
  },
  {
    ...
    excerpt:
      "Nossa nova ferramenta de Extracao de Tabelas usa Google Document AI para detectar e exportar tabelas de qualquer PDF para planilhas Excel.",
    date: "2026-04-01",
    category: "Produto",
  },
  {
    ...
    excerpt:
      "A maioria das ferramentas PDF so funciona em ingles. Construimos o PDF.it para profissionais em todo o mundo.",
    date: "2026-04-01",
    category: "Empresa",
  },
]
            ...
            <div className="max-w-2xl mx-auto">
              <div className="rounded-2xl p-[1px]" style={{ background: "linear-gradient(135deg, rgba(20,216,196,0.3), rgba(30,111,217,0.2))" }}>
                <div className="rounded-2xl p-8 text-center" style={{ background: "rgba(255,255,255,0.05)", backdropFilter: "blur(12px)" }}>
                  <h2 className="text-2xl font-black text-white mb-3">Fique Atualizado</h2>
                  <p className="text-slate-400 mb-6">
                    Receba dicas PDF, atualizacoes de produto e melhores praticas da equipe PDF.it.
                  </p>
                  <Link
                    href="/br/blog"
                  ...
                  <p className="text-slate-500 text-sm mt-4">Respeitamos sua caixa de entrada. Sem spam, nunca.</p>
                </div>
              </div>
            </div>
          </div>
