...
export const metadata = {
  title: "PDF para Google Sheets — Converta Tabelas de PDF para Google Sheets | PDF.it",
  description:
    "Converta PDF para Google Sheets com o PDF.it. Extraia tabelas de PDFs para planilhas editaveis no Google Sheets — rapido, preciso e no navegador.",
  alternates: {
    canonical: "https://pdf.it.com/br/pdf-para-google-sheets",
    languages: {
      en: "https://pdf.it.com/pdf-to-google-sheets",
      es: "https://pdf.it.com/es/pdf-a-google-sheets",
      pt: "https://pdf.it.com/br/pdf-para-google-sheets",
    },
  },
}
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Suba seu PDF no PDF.it para converte-lo em formato XLSX. Depois, suba o arquivo .xlsx para o Google Drive e abra com o Google Sheets para editar e analisar os dados.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Sim. O PDF.it detecta e extrai tabelas do PDF, preservando linhas e colunas. O Google Sheets mantem essa estrutura ao abrir o arquivo XLSX.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "A conversao de PDF para XLSX (compativel com Google Sheets) e um recurso Pro do PDF.it. Voce pode testar com arquivos de ate 25MB na versao gratuita.",
      },
    },
  ],
}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Conversao Rapida</span></div>
                <div className="flex items-center gap-2"><Shield className="h-4 w-4 text-[#14D8C4]" /><span>100% Seguro</span></div>
                <div className="flex items-center gap-2"><Download className="h-4 w-4 text-[#14D8C4]" /><span>Compativel com Google Sheets</span></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <p className="text-lg text-slate-600 mb-8">
              O PDF.it converte seu PDF em formato XLSX, totalmente compativel com o Google Sheets. Extraia tabelas, dados numericos e informacoes estruturadas do PDF. Suba o arquivo convertido para o Google Drive e abra com o Google Sheets para analisar, editar e compartilhar.
            </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-4">
              {[
                ...
                "Clique em Converter — o PDF.it gera um arquivo .xlsx compativel.",
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                { q: "Como converter PDF para Google Sheets?", a: "Suba seu PDF no PDF.it para converte-lo em formato XLSX. Depois, suba o arquivo .xlsx para o Google Drive e abra com o Google Sheets para editar e analisar os dados." },
                { q: "As tabelas do PDF sao preservadas no Google Sheets?", a: "Sim. O PDF.it detecta e extrai tabelas do PDF, preservando linhas e colunas. O Google Sheets mantem essa estrutura ao abrir o arquivo XLSX." },
                ...
                { q: "E gratuito converter PDF para Google Sheets?", a: "A conversao de PDF para XLSX (compativel com Google Sheets) e um recurso Pro do PDF.it. Voce pode testar com arquivos de ate 25MB na versao gratuita." },
              ].map((faq, i) => (
