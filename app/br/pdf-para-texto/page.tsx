          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl space-y-12">
            <div>
              ...
              <p className="text-slate-600">
                Converta paginas de PDF em um arquivo de texto limpo que voce pode editar em qualquer lugar. O PDF.it exporta seu conteudo como texto puro, facilitando colar no Word, Google Docs, Notion, e-mails ou editores de codigo.
              </p>
            </div>
            <div>
