    ...
    <div className="min-h-screen bg-[#F3F4FF]">
      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Converte PDF para PNG com resultados nitidos e legiveis</li>
              <li className="flex items-center gap-2">✓ Ideal para paginas com muito texto, graficos e diagramas</li>
              ...
              <li className="flex items-center gap-2">✓ Downloads faceis para paginas individuais ou documentos completos</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Converta Paginas de PDF em Imagens PNG", desc: "Transforme cada pagina de um PDF em um arquivo PNG separado. Cada pagina se torna uma imagem que voce pode usar em apresentacoes, e-mails, documentos, ferramentas de design ou sites." },
                { title: "Por Que Escolher PNG em Vez de JPG?", desc: "PNG produz texto e graficos mais limpos que JPG porque evita artefatos de compressao agressiva. Se precisar de arquivos menores, experimente nossa ferramenta PDF para JPG." },
                { title: "Saida de Alta Qualidade para Design e Compartilhamento", desc: "As exportacoes PNG sao ideais para diagramas, mockups de interface, recibos, formularios e qualquer PDF onde a clareza e importante." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <Script id="faq-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "FAQPage",
          "mainEntity": [
            { "@type": "Question", "name": "Posso converter um PDF de varias paginas para PNG?", "acceptedAnswer": { "@type": "Answer", "text": "Sim. O PDF.it converte cada pagina do PDF em uma imagem PNG individual que voce pode baixar separadamente." } },
            { "@type": "Question", "name": "Por que escolher PNG em vez de JPG?", "acceptedAnswer": { "@type": "Answer", "text": "PNG e melhor para texto nitido, graficos e diagramas porque nao usa compressao agressiva. JPG costuma ser menor e melhor para paginas com muitas fotos." } },
            { "@type": "Question", "name": "Posso converter PDF para PNG no celular?", "acceptedAnswer": { "@type": "Answer", "text": "Sim. O PDF.it funciona em navegadores moveis — envie seu PDF, converta e baixe suas imagens PNG." } },
            { "@type": "Question", "name": "Por que meus arquivos PNG ficam borrados?", "acceptedAnswer": { "@type": "Answer", "text": "PNGs borrados geralmente vem de um PDF de baixa qualidade, especialmente documentos escaneados. Experimente nosso Scanner OCR para PDFs escaneados." } },
            { "@type": "Question", "name": "E seguro enviar meu PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Sim. Todas as transferencias sao criptografadas com SSL e seus arquivos sao eliminados imediatamente apos sua sessao." } },
            { "@type": "Question", "name": "Qual e o tamanho maximo de arquivo que posso converter?", "acceptedAnswer": { "@type": "Answer", "text": "Contas gratuitas podem enviar arquivos de ate 25MB. Contas Pro podem enviar ate 200MB. Contas Business podem enviar ate 1GB." } },
          ]
        })}} />
      </main>
      <FooterBr />
