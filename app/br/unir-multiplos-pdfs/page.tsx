...
export default function UnirMultiplosPDFsPage() {
  const faqs = [
    {
        "q": "Como uno multiplos PDFs?",
        "a": "Envie todos os PDFs, organize na ordem e clique em Unir."
    },
    {
        "q": "Posso unir mais de 10?",
        "a": "Sim. Usuarios Pro tem processamento em lote."
    },
    {
        "q": "A ordem e preservada?",
        "a": "Sim. O PDF.it preserva a ordem exata que voce definir."
    },
    {
    ...
    {
        "q": "O PDF unido ficara muito grande?",
        "a": "Se sim, use Comprimir PDF para reduzir o tamanho."
    },
    {
        "q": "Funciona no celular?",
        "a": "Sim. Totalmente baseado no navegador."
    }
]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-black mb-4">Unir Multiplos PDFs em Um Arquivo</h1>
            <p className="text-xl text-slate-300 mb-8">Combine 2, 5 ou 10+ arquivos PDF em um unico documento. Envie seus arquivos, defina a ordem e baixe um PDF unido — rapido, gratis e pelo navegador.</p>
            <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Uniao em Lote (Pro)</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">Se voce precisa unir dois contratos ou combinar dezenas de capitulos, o PDF.it lida com tudo. Envie seus PDFs, organize e obtenha um documento unido limpo. Usuarios Pro desbloqueiam processamento em lote.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Una 2, 5, 10 ou 50+ PDFs em um documento</li>
              <li className="flex items-center gap-2">✓ Arraste e solte para controlar a ordem</li>
              <li className="flex items-center gap-2">✓ Sem perda de qualidade — paginas ficam como estao</li>
              <li className="flex items-center gap-2">✓ Funciona em qualquer dispositivo com navegador</li>
          </ul>
        </div></section>

        <ProcessingInterface acceptedFiles=".pdf" toolName="Merge PDF" outputFormat="PDF" processingMessage="Unindo seus PDFs..." successMessage="Seu PDF unido esta pronto!" />
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Una Dezenas de Arquivos em Lote", desc: "Precisa combinar um grande lote? Usuarios Pro podem selecionar multiplos arquivos e uni-los em uma operacao." },
                { title: "Mantenha na Ordem Certa", desc: "Arraste e solte para definir a sequencia exata. O PDF.it preserva a ordem escolhida." },
                { title: "Una e Comprima", desc: "Unir muitos PDFs pode criar arquivo grande. Depois use Comprimir PDF para reduzir o resultado." },
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Unir Multiplos PDFs</h2>
          <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
            {[{ num: "1", title: "Envie seus PDFs", desc: "Arraste e solte todos os arquivos" }, { num: "2", title: "Organize e una", desc: "Reordene, depois clique em Unir" }, { num: "3", title: "Baixe seu PDF", desc: "Receba o arquivo combinado" }].map((step) => (<div key={step.num} className="flex-1"><div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3" style={{ background: "linear-gradient(135deg, #1a1f5e, #252A6A)", boxShadow: "0 0 20px rgba(20, 216, 196, 0.3), 0 4px 8px rgba(232,129,58,0.1)", border: "1px solid rgba(20,216,196,0.25)" }}><span className="text-[#14D8C4] font-black text-lg">{step.num}</span></div><p className="font-semibold text-slate-900">{step.title}</p><p className="text-sm text-slate-500 mt-1">{step.desc}</p></div>))}
          </div>
        </div></section>
