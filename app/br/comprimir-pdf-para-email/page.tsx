      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Compressão Inteligente</span></div>
                ...
                <div className="flex items-center gap-2"><Mail className="h-4 w-4 text-[#14D8C4]" /><span>Tamanho Pronto para E-mail</span></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Comprima PDFs para cumprir os limites do Gmail, Outlook e Yahoo</li>
              <li className="flex items-center gap-2">✓ Compressão inteligente que mantém documentos profissionais</li>
              <li className="flex items-center gap-2">✓ Funciona em Mac, Windows, iOS, Android e Linux</li>
              <li className="flex items-center gap-2">✓ Sem instalação — comprima PDFs no seu navegador</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Envie Contratos e Faturas", desc: "Contratos e faturas grandes com assinaturas frequentemente ultrapassam os limites de e-mail. O PDF.it os comprime para um tamanho enviável mantendo cada página nítida." },
                { title: "Comprima Relatórios e Apresentações", desc: "Relatórios com gráficos, imagens e tabelas podem ser enormes. Reduza o tamanho do arquivo para enviá-los por e-mail diretamente em vez de usar links compartilhados." },
                { title: "Funciona de Qualquer Dispositivo", desc: "Precisa enviar um PDF comprimido pelo celular? O PDF.it funciona em navegadores móveis — comprima e envie por e-mail em qualquer lugar." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Comprimir um PDF para E-mail</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Envie seu PDF", desc: "Arraste e solte ou clique para escolher um arquivo" },
                { num: "2", title: "Clique em Comprimir", desc: "A compressão inteligente é aplicada automaticamente" },
                { num: "3", title: "Baixe e anexe", desc: "Obtenha seu PDF pronto para e-mail instantaneamente" },
              ].map((step) => (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { name: "Comprimir para 2MB", href: "/br/comprimir-pdf-para-2mb", desc: "Tamanhos restritos" },
