                ...
                {[
                  {
                    ...
                    price: "$0/mes",
                    items: [
                      "10 conversoes/dia, arquivos ate 25MB",
                      "Ferramentas PDF essenciais (unir, dividir, comprimir, girar, achatar, proteger, desbloquear)",
                  ...
                  },
                  {
                    ...
                    price: "$7.99/mes",
                    items: [
                      "Conversoes ilimitadas, arquivos ate 200MB",
                      "Todas as ferramentas PDF incluindo OCR, marca d'agua, conversoes Office",
                      "Otimizador ATS, criador de curriculo, codigo QR, URL para PDF",
                    ],
                  },
                  {
                    name: "Business",
                    price: "$13.99/mes",
                    items: [
                      "Tudo no Pro, arquivos ate 1GB",
                      "Extracao de tabelas (200 paginas/mes), comparacao PDF, assinatura eletronica, redacao PDF",
                      "Automacao de fluxos",
                    ],
                  },
                  {
                    ...
                    items: [
                      "Tudo no Business",
                      "Extracao de tabelas de alto volume (2.000 paginas/mes), automacao de fluxos",
                      "Modelos de fluxo, processamento prioritario, suporte dedicado",
                    ],
                  },
                ].map((tier) => (
                  <div
