        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Converte tabelas e dados de PDF para planilhas Excel</li>
              <li className="flex items-center gap-2">✓ Ideal para relatorios financeiros, faturas e exportacoes de dados</li>
              <li className="flex items-center gap-2">✓ Baixe um arquivo .xlsx pronto para abrir no Excel ou Google Sheets</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Extraia Tabelas de PDF para Planilhas", desc: "O PDF.it detecta e extrai tabelas dos seus arquivos PDF, convertendo linhas e colunas em celulas do Excel que voce pode editar, filtrar e analisar." },
                { title: "Ideal para Relatorios Financeiros e Faturas", desc: "Converta extratos bancarios, faturas e relatorios em planilhas editaveis. Economize horas de trabalho manual copiando dados." },
                { title: "Baixe .xlsx — Compativel com Excel e Google Sheets", desc: "Seu arquivo convertido abre diretamente no Microsoft Excel, Google Sheets ou qualquer app de planilhas. Sem necessidade de limpar a formatacao." },
              ].map((feature) => (
                <div
                  key={feature.title}
