...
export const metadata = {
  title: "Comprimir PDF para Limites de 500KB — Compressao Extrema Gratis | PDF.it",
  description: "Aplique compressao extrema no PDF para reduzir o tamanho para portais com limite de 500KB. Compressao maxima para portais governamentais, upload de fotos de visto, formularios moveis e inscricoes online — rapido, pelo navegador, gratis.",
  alternates: { canonical: "/br/comprimir-pdf-para-500kb", languages: { en: "/compress-pdf-to-500kb", es: "/es/comprimir-pdf-a-500kb", pt: "/br/comprimir-pdf-para-500kb" } },
}

export default function ComprimirPDFPara500KBPageBr() {
  const faqs = [
    { q: "Como comprimo um PDF para limite de 500KB?", a: "Envie seu PDF ao PDF.it e clique em Comprimir. A ferramenta aplica compressao extrema para reduzir a resolucao de imagens e otimizar a estrutura interna, reduzindo drasticamente o tamanho do arquivo. Os resultados dependem do conteudo do seu PDF." },
    { q: "Meu PDF ficara definitivamente abaixo de 500KB apos comprimir?", a: "A compressao extrema reduz drasticamente o tamanho do arquivo, mas os resultados dependem do conteudo do PDF. PDFs pequenos com muito texto comprimem muito bem. Arquivos maiores ou pesados em imagens podem precisar ser divididos primeiro e cada parte comprimida separadamente." },
    { q: "Quais portais exigem PDFs abaixo de 500KB?", a: "Muitos portais governamentais, formularios de upload de foto de visto, formularios de inscricao movel e sistemas de envio online impoem limite de 500KB. Isso e comum para documentos de identidade, uploads de fotos e documentacao de apoio." },
    { q: "Meu PDF continuara legivel apos comprimir para 500KB?", a: "Sim. O texto permanece nitido e totalmente legivel. As imagens podem perder algum detalhe em niveis de compressao extrema, mas o documento continua utilizavel para a maioria dos propositos." },
    { q: "Posso comprimir um PDF para 500KB pelo celular?", a: "Sim. O PDF.it funciona em qualquer navegador movel. Envie seu PDF, comprima-o e baixe o arquivo menor direto no seu iPhone ou Android." },
    { q: "O que faco se meu PDF continuar acima de 500KB apos comprimir?", a: "Tente dividir o PDF em partes menores com nossa ferramenta Dividir PDF e comprima cada parte individualmente. Voce tambem pode achatar o PDF, remover paginas desnecessarias ou converter imagens para escala de cinza para reduzir ainda mais." },
  ]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Aplique compressao extrema para reduzir drasticamente o tamanho do seu PDF em portais com limites de 500KB. Perfeito para portais governamentais, upload de fotos de visto, formularios moveis e inscricoes online rigorosas.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">Algumas plataformas impoem um limite muito rigoroso de 500KB. Portais governamentais, uploads de foto de visto, formularios de inscricao movel e sistemas de envio online frequentemente exigem documentos abaixo de 500KB. O PDF.it aplica compressao extrema para reduzir drasticamente o tamanho do seu PDF, ajudando voce a cumprir esses requisitos rigorosos de upload.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">✓ Compressao extrema para maxima reducao de tamanho</li>
            <li className="flex items-center gap-2">✓ Perfeito para portais governamentais e upload de foto de visto</li>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "Portais Governamentais com Limites Rigorosos", desc: "Muitos sites governamentais para declaracao de impostos, alvaras e registros oficiais limitam uploads a 500KB por arquivo. Comprima seus documentos para enviar sem erros ou rejeicoes." },
            { title: "Upload de Fotos e Documentos de Visto", desc: "Portais de solicitacao de visto frequentemente exigem fotos de identidade, copias de passaporte e documentos de apoio abaixo de 500KB. Comprima seus documentos digitalizados para cumprir esses requisitos rigorosos." },
            { title: "Formularios Moveis e Candidaturas de Emprego", desc: "Formularios otimizados para celular impoem limites menores para uploads rapidos em conexoes moveis. Portais de emprego e envios de certificacao as vezes limitam anexos a 500KB." },
          ].map((feature) => (
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Comprimir um PDF para Limites de 500KB</h2>
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[{ name: "Comprimir para 200KB", href: "/br/comprimir-pdf-para-200kb", desc: "Para limites de 200KB" }, { name: "Comprimir para 1MB", href: "/br/comprimir-pdf-para-1mb", desc: "Para limites de 1MB" }, { name: "Comprimir para 2MB", href: "/br/comprimir-pdf-para-2mb", desc: "Para limites de 2MB" }, { name: "Dividir PDF", href: "/br/dividir-pdf", desc: "Divida se ainda for grande" }].map((tool) => (
