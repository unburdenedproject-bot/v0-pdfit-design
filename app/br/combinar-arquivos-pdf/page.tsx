...
export const metadata = {
  ...
  alternates: {
    canonical: "/br/combinar-arquivos-pdf",
    languages: {
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Combinacao Rapida</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Combine qualquer numero de arquivos PDF</li>
              <li className="flex items-center gap-2">✓ Formato e qualidade 100% preservados</li>
              <li className="flex items-center gap-2">✓ Funciona em desktop, tablet e celular</li>
              <li className="flex items-center gap-2">✓ Sem registro obrigatorio</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Combine Documentos para Email", desc: "Em vez de enviar 5 anexos separados, combine tudo em um unico PDF. Seu destinatario recebe um arquivo limpo e organizado — muito mais profissional." },
                { title: "Prepare Documentacao Completa", desc: "Junte formularios preenchidos, comprovantes, declaracoes e documentos de apoio em um unico pacote PDF para envio a orgaos publicos ou empresas." },
                { title: "Organize Materiais de Estudo", desc: "Combine apostilas, artigos, anotacoes e slides em um unico PDF para ter todo o material de estudo em um so lugar." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Combinar Arquivos PDF</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Envie seus PDFs", desc: "Arraste ou selecione seus arquivos" },
                { num: "2", title: "Organize a ordem", desc: "Reorganize antes de combinar" },
                { num: "3", title: "Baixe seu PDF", desc: "Receba seu arquivo combinado na hora" },
              ].map((step) => (
