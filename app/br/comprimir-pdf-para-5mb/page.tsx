...
export const metadata = {
  title: "Comprimir PDF para Limites de 5MB — Compressao Extrema Gratis | PDF.it",
  description: "Aplique compressao extrema no PDF para reduzir o tamanho para portais com limite de 5MB. Compressao maxima para envios, inscricoes e uploads — rapido, pelo navegador, gratis.",
  alternates: { canonical: "/br/comprimir-pdf-para-5mb", languages: { en: "/compress-pdf-to-5mb", es: "/es/comprimir-pdf-a-5mb", pt: "/br/comprimir-pdf-para-5mb" } },
}

export default function ComprimirPDFPara5MBPageBr() {
  const faqs = [
    { q: "Como comprimo um PDF para limite de 5MB?", a: "Envie seu PDF ao PDF.it, clique em Comprimir e baixe o arquivo reduzido. O PDF.it usa compressao extrema para reduzir drasticamente o tamanho do arquivo. Os resultados dependem do conteudo do seu PDF." },
    { q: "Meu PDF ficara definitivamente abaixo de 5MB apos comprimir?", a: "A compressao extrema reduz drasticamente o tamanho do arquivo. A maioria dos PDFs abaixo de 20MB comprime significativamente. Arquivos muito pesados em imagens podem precisar ser divididos primeiro e cada parte comprimida separadamente." },
    { q: "O texto continuara legivel apos comprimir?", a: "Sim. O texto permanece nitido e legivel. A qualidade da imagem pode ser levemente reduzida, mas as paginas continuam utilizaveis." },
    { q: "Por que portais de upload tem limite de 5MB?", a: "Muitos portais governamentais, universidades e plataformas de candidatura de emprego definem limite de 5MB para gerenciar armazenamento e largura de banda. Comprimir seu PDF garante que cumpra esses requisitos." },
    { q: "Posso comprimir um PDF para 5MB pelo celular?", a: "Sim. O PDF.it funciona em navegadores moveis — envie, comprima e baixe no iPhone ou Android." },
    { q: "O que faco se meu PDF continuar acima de 5MB apos comprimir?", a: "Se o arquivo ainda for grande demais, tente dividi-lo em partes menores usando a ferramenta Dividir PDF do PDF.it e comprima cada parte individualmente." },
  ]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Aplique compressao extrema para reduzir drasticamente o tamanho do seu PDF em portais com limites de 5MB. Pelo navegador, resultados instantaneos.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">Precisa fazer upload de um PDF mas o portal diz "arquivo muito grande"? O PDF.it aplica compressao extrema para reduzir drasticamente o tamanho do seu PDF — perfeito para formularios governamentais, envios universitarios, candidaturas de emprego e qualquer site com limite de 5MB.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">✓ Compressao extrema para maxima reducao de tamanho</li>
            <li className="flex items-center gap-2">✓ Perfeito para portais de upload com limites de tamanho</li>
        ...
        <ProcessingInterface acceptedFiles=".pdf" toolName="Compress PDF" outputFormat="PDF" processingMessage="Comprimindo seu PDF para menos de 5MB..." successMessage="Seu PDF comprimido esta pronto!" compressionLevel="extreme" />
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "Cumpra Limites de Portais de Upload", desc: "Portais governamentais, inscricoes universitarias e sites de emprego frequentemente limitam uploads a 5MB. O PDF.it aplica compressao extrema para reduzir drasticamente o tamanho do arquivo, ajudando voce a cumprir esses requisitos." },
            { title: "Comprima Documentos e Formularios Digitalizados", desc: "PDFs digitalizados frequentemente tem 10-30MB. O modo de compressao extrema do PDF.it reduz dados de imagem agressivamente para levar o arquivo abaixo de 5MB mantendo o texto legivel." },
            { title: "Ainda Grande Demais? Divida e Comprima", desc: "Se seu PDF ainda estiver acima de 5MB apos comprimir, use a ferramenta Dividir PDF do PDF.it para separar em partes menores e comprima cada uma individualmente." },
          ].map((feature) => (
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Comprimir um PDF para Limites de 5MB</h2>
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[{ name: "Comprimir para 2MB", href: "/br/comprimir-pdf-para-2mb", desc: "Para limites de 2MB" }, { name: "Comprimir para 10MB", href: "/br/comprimir-pdf-para-10mb", desc: "Para limites de 10MB" }, { name: "Comprimir PDF", href: "/br/comprimir-pdf", desc: "Compressao padrao" }, { name: "Dividir PDF", href: "/br/dividir-pdf", desc: "Divida se ainda for grande" }].map((tool) => (
