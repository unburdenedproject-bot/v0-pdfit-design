    ...
    return (
      <>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {resetError && (
                    <div className="rounded-xl p-4 flex items-start gap-3" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(107,124,255,0.25)" }}>
                      ...
                      <p className="text-sm text-white/90 leading-relaxed flex-1">{resetError}</p>
                    </div>
                  )}
                  <Button
                    type="submit"
        ...
        <div className="flex items-center justify-center gap-1.5 mt-6">
          ...
          <p className="text-slate-500 text-xs">Seus arquivos nunca são armazenados. Criptografia SSL.</p>
        </div>
      </>
    )
  }
        ...
        <div className="rounded-[15px] p-8 bg-white/[0.07] backdrop-blur-xl">
          ...
          {messageParam === "already-verified" && (
            <div className="mb-4 rounded-lg border border-green-500/30 bg-green-500/10 px-4 py-3 text-center">
              <p className="text-sm text-green-300 font-medium">Seu e-mail já foi verificado. Faça login.</p>
            </div>
          )}
