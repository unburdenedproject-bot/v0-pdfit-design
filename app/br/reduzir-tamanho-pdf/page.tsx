  ...
  const faqs = [
    {
        ...
        "a": "Envie ao PDF.it, escolha o nivel de compressao e clique em Comprimir."
    },
    {
        "q": "Qual a diferenca entre leve, medio e extremo?",
        "a": "Leve preserva qualidade. Media equilibra tamanho e qualidade. Extrema maximiza a reducao."
    },
    {
        "q": "Quanto meu PDF sera reduzido?",
        "a": "Depende do conteudo. PDFs com imagens podem ver 50-80% de reducao com compressao extrema."
    },
    {
        "q": "E gratis?",
        "a": "Sim. Usuarios gratuitos podem reduzir ate 10 PDFs por dia de ate 25MB."
    },
    {
        "q": "A qualidade sera afetada?",
        "a": "Depende do nivel. O texto sempre permanece nitido."
    },
    {
        "q": "E se ainda estiver muito grande?",
        "a": "Tente nivel mais alto, ou divida o PDF em secoes menores."
    }
]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-black mb-4">Reduzir Tamanho PDF Online</h1>
            <p className="text-xl text-slate-300 mb-8">Escolha seu nivel de compressao — leve para preservar qualidade, medio para equilíbrio, ou extremo para maxima reducao. Envie, reduza, baixe — tudo no navegador.</p>
            <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Escolha Seu Nivel de Compressao</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">PDFs podem ser grandes por muitas razoes — imagens de alta resolucao, fontes incorporadas, estruturas nao otimizadas ou metadados ocultos. O PDF.it analisa seu documento e aplica compressao focando nas maiores fontes de inchaço.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Tres niveis de compressao: leve, medio e extremo</li>
              <li className="flex items-center gap-2">✓ O texto sempre permanece nitido e legivel</li>
              <li className="flex items-center gap-2">✓ Funciona no Mac, Windows, iOS, Android e Linux</li>
              <li className="flex items-center gap-2">✓ Sem instalacao — reduza o tamanho no seu navegador</li>
          </ul>
        </div></section>

        <ProcessingInterface acceptedFiles=".pdf" toolName="Compress PDF" outputFormat="PDF" processingMessage="Reduzindo o tamanho do seu PDF..." successMessage="Seu PDF menor esta pronto!" showCompressionSelector />
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Caiba nos Limites de E-mail", desc: "A maioria dos provedores limita anexos a 10-25MB. Reduza seu PDF para caber nos limites e ser baixado rapidamente." },
                { title: "Atenda Requisitos de Upload", desc: "Candidaturas, formularios governamentais e envios para universidades tem limites rigorosos de tamanho. Reduza seu PDF para atender." },
                { title: "Economize Espaco na Nuvem", desc: "Economize espaco no Google Drive, Dropbox ou OneDrive reduzindo PDFs arquivados. Arquivos menores sincronizam mais rapido." },
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Reduzir o Tamanho do PDF</h2>
          <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
            {[{ num: "1", title: "Envie seu PDF", desc: "Arraste e solte ou clique para escolher" }, { num: "2", title: "Escolha o nivel", desc: "Leve, Medio ou Extremo" }, { num: "3", title: "Baixe seu PDF", desc: "Receba seu arquivo reduzido instantaneamente" }].map((step) => (<div key={step.num} className="flex-1"><div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3" style={{ background: "linear-gradient(135deg, #1a1f5e, #252A6A)", boxShadow: "0 0 20px rgba(20, 216, 196, 0.3), 0 4px 8px rgba(232,129,58,0.1)", border: "1px solid rgba(20,216,196,0.25)" }}><span className="text-[#14D8C4] font-black text-lg">{step.num}</span></div><p className="font-semibold text-slate-900">{step.title}</p><p className="text-sm text-slate-500 mt-1">{step.desc}</p></div>))}
          </div>
        </div></section>
