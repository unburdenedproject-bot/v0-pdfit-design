      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Reducao Rapida</span></div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-center gap-3 mb-3"><HardDrive className="h-5 w-5 text-[#14D8C4]" /><h3 className="font-bold text-slate-900">Imagens de Alta Resolucao</h3></div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-center gap-3 mb-3"><HardDrive className="h-5 w-5 text-[#14D8C4]" /><h3 className="font-bold text-slate-900">Fontes Incorporadas</h3></div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-center gap-3 mb-3"><HardDrive className="h-5 w-5 text-[#14D8C4]" /><h3 className="font-bold text-slate-900">Metadados e Dados Ocultos</h3></div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-center gap-3 mb-3"><HardDrive className="h-5 w-5 text-[#14D8C4]" /><h3 className="font-bold text-slate-900">Camadas e Formularios</h3></div>
        ...
        <section className="py-16 bg-[#191B4D] text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <Link href="/br/reduzir-tamanho-pdf" className="inline-block bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-3 px-8 rounded-xl text-lg transition-colors shadow-lg">Reduzir Tamanho de PDF</Link>
          </div>
        </section>
      </main>
      <FooterBr />
