...
export default function PDFParaXlsxPage() {
  const faqs = [
    {
        "q": "Qual a diferenca entre XLSX e XLS?",
        "a": "XLSX e o formato Excel moderno com melhor compressao e compatibilidade. O PDF.it converte PDFs diretamente para XLSX."
    },
    {
        "q": "Como converto um PDF para XLSX?",
        "a": "Envie seu PDF ao PDF.it, clique em Converter e baixe seu arquivo XLSX."
    },
    {
        "q": "Minhas tabelas serao convertidas com precisao?",
        "a": "Tabelas bem estruturadas convertem com alta precisao. Layouts complexos podem exigir pequenos ajustes."
    },
    {
        "q": "Posso converter PDF escaneado para XLSX?",
        "a": "Use o Scanner OCR do PDF.it primeiro para extrair texto, depois converta o resultado."
    },
    {
        "q": "O conversor e gratuito?",
        "a": "Disponivel para assinantes Pro e Business."
    },
    {
        "q": "Posso converter multiplos PDFs de uma vez?",
        "a": "Sim. Contas Pro e Business suportam processamento em lote."
    }
]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-black mb-4">Converter PDF para XLSX</h1>
            <p className="text-xl text-slate-300 mb-8">Extraia tabelas e dados de qualquer PDF para uma planilha Excel XLSX editavel. Deteccao precisa de colunas, download instantaneo.</p>
            <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                ...
                <div className="flex items-center gap-2"><Download className="h-4 w-4 text-[#14D8C4]" /><span>Extracao Precisa</span></div>
            </div>
          </div></div>
        </section>

        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">XLSX e o formato moderno de planilha Excel usado pelo Microsoft Excel, Google Sheets e LibreOffice Calc. Quando voce recebe relatorios financeiros, notas fiscais ou tabelas de dados como PDFs, converte-los para XLSX permite classificar, filtrar, calcular e analisar os dados.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Extraia tabelas de PDF para formato XLSX editavel</li>
              <li className="flex items-center gap-2">✓ Deteccao inteligente de colunas, linhas e cabecalhos</li>
              <li className="flex items-center gap-2">✓ Abre no Excel, Google Sheets e LibreOffice</li>
              <li className="flex items-center gap-2">✓ Sem instalacao — converta PDFs no seu navegador</li>
          </ul>
        </div></section>

        <ProcessingInterface acceptedFiles=".pdf" toolName="PDF to Excel" outputFormat="XLSX" processingMessage="Convertendo seu PDF para XLSX..." successMessage="Seu arquivo XLSX esta pronto!" />
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Extraia Dados Financeiros", desc: "Extratos bancarios e relatorios trimestrais vem como PDFs. Converta para XLSX para rodar formulas, criar graficos e analisar tendencias no Excel ou Google Sheets." },
                { title: "Converta Notas Fiscais em Planilhas", desc: "Notas fiscais em PDF? Converta para XLSX para extrair itens, calcular totais e importar dados para seu software de contabilidade." },
                { title: "Analise Relatorios e Tabelas de Dados", desc: "Dados de pesquisa e tabelas de precos presos em PDFs se tornam uteis no Excel. Classifique, filtre, analise e crie graficos sem digitacao manual." },
