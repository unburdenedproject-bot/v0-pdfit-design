      ...
      <main>
        ...
        <section className="py-16 bg-[#191B4D] text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <Link href="/br/comprimir-pdf-para-10mb" className="inline-block bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-3 px-8 rounded-xl text-lg transition-colors shadow-lg">Comprimir para 10MB Agora</Link>
          </div>
        </section>
      </main>
      <FooterBr />
