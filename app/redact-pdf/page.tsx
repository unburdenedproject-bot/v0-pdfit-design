        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">
              PDF redaction is the process of permanently removing sensitive, confidential, or private information from a document. Unlike covering text with a black box, true redaction deletes the underlying data so it can never be recovered, copied, or searched. Required for HIPAA, GDPR, and legal compliance.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Permanently removes text, images, and metadata</li>
              <li className="flex items-center gap-2">✓ Required for HIPAA and GDPR compliance</li>
              <li className="flex items-center gap-2">✓ Prevents accidental data leaks when sharing</li>
              <li className="flex items-center gap-2">✓ No software to install — redact in your browser</li>
            </ul>
          </div>
        </section>

        {/* CTA — Redact PDFs with PDF.it */}
        <section className="py-12 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/pdf-redaction" className="inline-flex items-center justify-center gap-2 bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-3 px-8 rounded-xl transition-colors">Try PDF Redaction</Link>
              <Link href="/pricing" className="inline-flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-900 text-white font-bold py-3 px-8 rounded-xl transition-colors">See Business Plan</Link>
            </div>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Legal and Regulatory Compliance", desc: "Courts, government agencies, and healthcare organizations require permanent data removal before sharing documents. PDF redaction meets HIPAA, GDPR, FOIA, and court rules." },
                { title: "HIPAA and GDPR Requirements", desc: "HIPAA mandates permanent removal of protected health information. GDPR requires proper anonymization. Simply covering text with a black box does not meet these standards." },
                { title: "Permanent vs. Visual Redaction", desc: "Visual redaction (black rectangles) leaves text in the file. True redaction permanently deletes the data. PDF.it uses true redaction to ensure sensitive information is completely gone." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Use PDF.it's PDF Redaction tool" },
                { num: "2", title: "Select content to redact", desc: "Choose text, images, or areas to remove" },
                { num: "3", title: "Download redacted PDF", desc: "Get your secure, redacted file instantly" },
              ].map((step) => (
