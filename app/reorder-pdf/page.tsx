          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>No Software Needed</span></div>
                <div className="flex items-center gap-2"><Shield className="h-4 w-4 text-[#14D8C4]" /><span>Files Deleted After Session</span></div>
                <div className="flex items-center gap-2"><Download className="h-4 w-4 text-[#14D8C4]" /><span>Free to Use</span></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">
              Need to rearrange pages in a PDF? PDF.it makes it simple with a two-step workflow: split your document into individual pages, then merge them back together in any order. No software to install, no account required — preserves original quality including text, images, and formatting.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Rearrange pages in any order you need</li>
              <li className="flex items-center gap-2">✓ Preserves original quality and formatting</li>
              <li className="flex items-center gap-2">✓ Works with scanned PDFs and digital documents</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Fix Page Order Mistakes", desc: "Scanned a stack of papers in the wrong order? Received a PDF with pages out of sequence? Split the document into individual pages, then merge them back in the correct order." },
                { title: "Reorganize Presentations & Reports", desc: "Restructure a slide deck or rearrange sections of a report by splitting and merging pages in your new preferred order. Perfect for customizing presentations for different audiences." },
                { title: "Sort Scanned Documents", desc: "When scanning multiple documents at once, pages often end up out of order. Split, review, and merge them back in the correct sequence — works with receipts, contracts, forms, or certificates." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Split your PDF", desc: "Separate into individual pages" },
