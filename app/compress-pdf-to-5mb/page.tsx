      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Maximum Compression</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              ...
              <li className="flex items-center gap-2">✓ Perfect for upload portals with size limits</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Meet Upload Portal Size Limits", desc: "Government portals, university applications, and job sites often cap uploads at 5MB. PDF.it applies extreme compression to drastically reduce your file size, helping you meet these requirements." },
                { title: "Compress Scanned Documents & Forms", desc: "Scanned PDFs are often 10-30MB. PDF.it's extreme compression mode reduces image data aggressively to bring the file under 5MB while keeping text readable." },
                { title: "Still Too Large? Split Then Compress", desc: "If your PDF is still over 5MB after compression, use PDF.it's Split PDF tool to break it into smaller parts, then compress each one individually." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF for 5MB Limits</h2>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { name: "Compress to 10MB", href: "/compress-pdf-to-10mb", desc: "For 10MB upload limits" },
