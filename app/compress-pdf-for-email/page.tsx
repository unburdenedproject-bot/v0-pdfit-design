      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                ...
                <div className="flex items-center gap-2"><Mail className="h-4 w-4 text-[#14D8C4]" /><span>Email-Ready Size</span></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Compress PDFs to fit Gmail, Outlook, and Yahoo limits</li>
              <li className="flex items-center gap-2">✓ Smart compression keeps documents professional</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Send Contracts & Invoices", desc: "Large contracts and invoices with signatures often exceed email limits. PDF.it compresses them to a sendable size while keeping every page crisp." },
                { title: "Compress Reports & Presentations", desc: "Reports with charts, images, and graphs can be huge. Reduce file size so you can email them directly instead of using file-sharing links." },
                { title: "Works From Any Device", desc: "Need to send a compressed PDF from your phone? PDF.it works in mobile browsers — compress and email on the go." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF for Email</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Click Compress", desc: "Smart compression is applied automatically" },
                { num: "3", title: "Download and attach", desc: "Get your email-ready PDF instantly" },
              ].map((step) => (
