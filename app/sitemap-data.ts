...
const allUrls: MetadataRoute.Sitemap = [
  ...
  { url: `${baseUrl}/high-volume-table-extraction`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/chat-with-pdf`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/smart-extraction`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/pdf-summarizer`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/question-generator`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/translate-pdf`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  ...
  { url: `${baseUrl}/blog/compress-pdf-email`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.6 },
  { url: `${baseUrl}/blog/scanned-pdf-searchable-ocr`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.6 },
  { url: `${baseUrl}/blog/protect-sensitive-documents`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.6 },
  ...
  { url: `${baseUrl}/es/chat-con-pdf`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/es/extraccion-inteligente`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/es/resumidor-pdf`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/es/generador-preguntas`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/es/traducir-pdf`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/es/extraccion-tablas-alto-volumen`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  ...
  { url: `${baseUrl}/br/chat-com-pdf`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/br/extracao-inteligente`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/br/resumidor-pdf`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/br/gerador-perguntas`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/br/traduzir-pdf`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
  { url: `${baseUrl}/br/extracao-tabelas-alto-volume`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
