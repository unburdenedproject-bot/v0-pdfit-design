...
export const metadata: Metadata = {
  title: "Organizar PDFs por Lotes — Procesa Multiples Archivos a la Vez | PDF.it",
  description: "Organiza multiples archivos PDF por lotes con PDF.it Pro. Une, divide, rota y comprime PDFs en masa — ahorra tiempo con procesamiento por lotes.",
  alternates: {
...
export default function OrganizarPDFPorLotesPage() {
  const faqs = [
    { q: "Que significa organizar PDFs por lotes?", a: "Organizar por lotes significa procesar multiples archivos PDF a la vez — unir, dividir, rotar o comprimir en masa en lugar de uno por uno. PDF.it Pro te permite subir multiples archivos y aplicar operaciones a todos simultaneamente." },
    ...
    { q: "El procesamiento por lotes esta disponible en el plan gratuito?", a: "Los usuarios gratuitos pueden procesar un archivo a la vez con archivos de hasta 25MB. El procesamiento por lotes es una funcion Pro disponible por $3.99/mes, que incluye archivos de hasta 200MB y conversiones ilimitadas." },
    { q: "Cuantos archivos puedo procesar a la vez?", a: "Los usuarios Pro pueden subir y procesar docenas de archivos en un solo lote. No hay limite fijo — la restriccion principal es el limite de tamano por archivo (200MB para Pro, 1GB para Business)." },
    { q: "Puedo automatizar flujos de trabajo PDF con PDF.it?", a: "Si. Los usuarios del plan Business ($13.99/mes) tienen acceso a Automatizacion de Flujos de Trabajo, que permite encadenar multiples operaciones — por ejemplo, dividir PDFs, comprimir cada parte y luego unir paginas seleccionadas." },
    { q: "Mis archivos estan seguros durante el procesamiento por lotes?", a: "Si. Todos los archivos se procesan de forma segura y se eliminan automaticamente al terminar tu sesion. PDF.it no almacena ni comparte tus documentos." },
  ]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-300 mb-8">Procesa multiples archivos PDF a la vez con PDF.it Pro. Une, divide, rota y comprime PDFs en masa — ahorra horas de trabajo repetitivo con procesamiento por lotes.</p>
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Multiples Operaciones</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">Administrar una gran biblioteca de archivos PDF consume mucho tiempo cuando solo puedes procesar uno a la vez. PDF.it Pro te da procesamiento por lotes en todas las herramientas principales — sube multiples archivos, aplica operaciones en masa y descarga todo como ZIP.</p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Une, divide, rota y comprime PDFs por lotes</li>
              <li className="flex items-center gap-2">✓ Sube multiples archivos simultaneamente</li>
        ...
        <ProcessingInterface acceptedFiles=".pdf" toolName="Organize PDF" outputFormat="PDF" processingMessage="Organizando tus PDFs..." successMessage="Tus PDFs organizados estan listos!" requiresPlan="pro" />
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Organiza Bibliotecas de Documentos", desc: "Sube todo tu lote de PDFs que necesitan union, division o compresion. PDF.it procesa todo en paralelo — sin mas clics archivo por archivo." },
                ...
                { title: "Automatiza Flujos de Trabajo PDF", desc: "Los usuarios del plan Business pueden encadenar multiples operaciones — dividir, comprimir y luego unir — todo en un flujo automatizado para tareas recurrentes." },
              ].map((feature) => (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                ...
                { num: "2", title: "Sube multiples archivos", desc: "Selecciona todos los archivos a procesar" },
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { name: "Comprimir PDF", href: "/es/comprimir-pdf", desc: "Reduce el tamano" },
                { name: "Automatizacion", href: "/es/automatizacion-flujos", desc: "Encadena operaciones" },
              ].map((tool) => (
