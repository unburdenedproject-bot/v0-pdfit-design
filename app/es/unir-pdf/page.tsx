...
export const metadata = {
  title: "Unir PDF Online — Combinar Archivos PDF en Uno | OmnisPDF",
  description:
    "Une archivos PDF en un solo documento con OmnisPDF. Combina PDFs online, reordena páginas y descarga un único PDF — rápido y sencillo.",
  alternates: {
    languages: {
      en: "/merge-pdf",
      es: "/es/unir-pdf",
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Sube tus PDFs a OmnisPDF, reordénalos como necesites y haz clic en Unir PDFs para descargar un solo archivo combinado." }
    },
    {
      "@type": "Question",
      "name": "¿Puedo reordenar los PDFs antes de unirlos?",
      "acceptedAnswer": { "@type": "Answer", "text": "Sí. Sube tus archivos y ordénalos en la secuencia correcta — OmnisPDF los une en ese orden." }
    },
    {
      "@type": "Question",
      "name": "¿Puedo unir PDFs desde mi celular?",
      "acceptedAnswer": { "@type": "Answer", "text": "Sí. OmnisPDF funciona en navegadores móviles — sube, une y descarga desde tu iPhone o Android." }
    },
    {
      "@type": "Question",
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-300 mb-8">
                Combina varios PDFs en un solo archivo con OmnisPDF. Sube, reordena, une y descarga — rápido, limpio y desde tu navegador.
              </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <p className="text-lg text-slate-600 mb-8">
              Usa la herramienta Unir PDF de OmnisPDF para combinar PDFs en un solo archivo en segundos. Sube varios documentos PDF, ordénalos correctamente y descarga un único PDF unido — perfecto para entregas, contratos, facturas e informes.
            </p>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl space-y-12">
            ...
            <div>
              ...
              <p className="text-slate-600">
                Sube tus archivos y ordénalos en el orden exacto que quieras. OmnisPDF los une en la secuencia que tú elijas.
              </p>
            </div>
            <div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-4">
              {[
                "Sube dos o más archivos PDF a OmnisPDF.",
              ...
              {[
                {
                  ...
                  a: "Sube tus PDFs a OmnisPDF, reordénalos como necesites y haz clic en Unir PDFs para descargar un solo archivo combinado.",
                },
                {
                  q: "¿Puedo reordenar los PDFs antes de unirlos?",
                  a: "Sí. Sube tus archivos y ordénalos en la secuencia correcta — OmnisPDF los une en ese orden.",
                },
                {
                  q: "¿Puedo unir PDFs desde mi celular?",
                  a: "Sí. OmnisPDF funciona en navegadores móviles — sube, une y descarga desde tu iPhone o Android.",
                },
                {
