...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "¿Puedo hacer un PDF escaneado buscable después de unir?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. Pasa el archivo unido por la herramienta Escáner OCR de PDF.it. El OCR (Reconocimiento Óptico de Caracteres) lee el texto en las imágenes escaneadas y agrega una capa de texto buscable, para que puedas buscar, copiar y selecciónar texto en el documento." } },
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                ...
                { q: "¿Puedo hacer un PDF escaneado buscable después de unir?", a: "Sí. Pasa el archivo unido por la herramienta Escáner OCR de PDF.it. El OCR lee el texto en las imágenes escaneadas y agrega una capa de texto buscable, para que puedas buscar, copiar y selecciónar texto en el documento." },
