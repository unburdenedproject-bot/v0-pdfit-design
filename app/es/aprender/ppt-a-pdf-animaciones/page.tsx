...
const faqSchema = { "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [
  { "@type": "Question", "name": "Las animaciones de PowerPoint se transfieren a PDF?", "acceptedAnswer": { "@type": "Answer", "text": "No. PDF es un formato de documento estatico y no soporta animaciones. Cuando conviertes PowerPoint a PDF, cada diapositiva se captura en su estado final — todos los elementos animados aparecen en sus posiciones finales, pero los efectos de movimiento se eliminan." } },
  { "@type": "Question", "name": "Que sucede con las transiciones de diapositivas en PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Las transiciones de diapositivas (desvanecimiento, barrido, empuje, etc.) se pierden completamente al convertir a PDF. Cada diapositiva se convierte en una pagina estatica en el PDF. No hay forma de preservar transiciones en un archivo PDF." } },
  { "@type": "Question", "name": "Los videos incrustados funcionan en PDF?", "acceptedAnswer": { "@type": "Answer", "text": "No. Los videos incrustados no se incluyen en el PDF. Solo se muestra el poster o miniatura del video como imagen estatica. Si tu audiencia necesita ver el video, comparte el PPTX original o enlaza al video por separado." } },
  { "@type": "Question", "name": "Que elementos de PowerPoint SI se convierten a PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Texto, imagenes, formas, SmartArt, graficos, tablas y formato de fondo se convierten a PDF. Estos elementos aparecen exactamente como en el estado final de cada diapositiva. Los hiperenlaces tambien se preservan en la mayoria de los casos." } },
  { "@type": "Question", "name": "Como puedo compartir una presentacion animada sin usar PowerPoint?", "acceptedAnswer": { "@type": "Answer", "text": "Tienes varias opciones: exportar como video (MP4) desde PowerPoint, usar PowerPoint Online para visualizacion gratuita, compartir via Google Slides (importa tu PPTX), o subir a SlideShare. Cada metodo preserva las animaciones mejor que PDF." } },
  { "@type": "Question", "name": "Si convierto un PDF de vuelta a PowerPoint, vuelven las animaciones?", "acceptedAnswer": { "@type": "Answer", "text": "No. Una vez que una presentacion se convierte a PDF, los datos de animacion se pierden permanentemente. Convertir el PDF de vuelta a PowerPoint te da diapositivas editables, pero necesitarias volver a agregar las animaciones manualmente." } }
] }
    ...
    <div className="min-h-screen bg-[#F3F4FF]">
      ...
      <main>
        <section className="bg-[#191B4D] text-white py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-slate-300">Creaste una presentacion con animaciones impresionantes y transiciones. Pero cuando la conviertas a PDF, sobrevivira algo de eso? Aqui esta la respuesta honesta — y que puedes hacer al respecto.</p>
        </div></div></section>
        ...
        <section className="py-8 bg-orange-50 border-b border-orange-100"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center flex-shrink-0"><PlayCircle className="h-5 w-5 text-white" /></div><p className="text-slate-700 font-semibold">Necesitas convertir de todas formas? Ve directo a la herramienta.</p></div>
        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <section className="mb-12">
            ...
            <p className="text-slate-600 mb-4">PDF es un <strong>formato de documento estatico</strong>. Fue disenado para preservar la apariencia de una pagina impresa — no para reproducir efectos de movimiento. Cuando conviertes una presentacion PowerPoint a PDF:</p>
            <ul className="space-y-3 text-slate-700">
              <li className="flex items-start gap-3"><span className="text-red-500 font-bold mt-0.5">&#10007;</span><span><strong>Las animaciones se eliminan.</strong> Animaciones de entrada, enfasis, salida y trayectorias de movimiento se pierden. Cada elemento aparece en su posicion final.</span></li>
              <li className="flex items-start gap-3"><span className="text-red-500 font-bold mt-0.5">&#10007;</span><span><strong>Las transiciones se eliminan.</strong> Desvanecimiento, barrido, empuje, transformacion — ninguna se transfiere. Cada diapositiva simplemente aparece como la siguiente pagina.</span></li>
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-3 text-slate-700">
              <li className="flex items-start gap-3"><span className="text-green-500 font-bold mt-0.5">&#10003;</span><span><strong>Texto y fuentes</strong> — Todo el texto se preserva con formato (negrita, cursiva, colores, tamanos). Fuentes estandar se convierten perfectamente; incrusta fuentes personalizadas para estar seguro.</span></li>
              <li className="flex items-start gap-3"><span className="text-green-500 font-bold mt-0.5">&#10003;</span><span><strong>Imagenes y fotos</strong> — Preservadas en su calidad original en el PDF.</span></li>
              <li className="flex items-start gap-3"><span className="text-green-500 font-bold mt-0.5">&#10003;</span><span><strong>Formas, lineas y SmartArt</strong> — Todos los graficos vectoriales se renderizan correctamente.</span></li>
              <li className="flex items-start gap-3"><span className="text-green-500 font-bold mt-0.5">&#10003;</span><span><strong>Graficos y diagramas</strong> — Renderizados como imagenes estaticas, preservando la apariencia exacta de PowerPoint.</span></li>
              <li className="flex items-start gap-3"><span className="text-green-500 font-bold mt-0.5">&#10003;</span><span><strong>Tablas</strong> — Diseno y formato se mantienen.</span></li>
              <li className="flex items-start gap-3"><span className="text-green-500 font-bold mt-0.5">&#10003;</span><span><strong>Hiperenlaces</strong> — Los enlaces clicables usualmente sobreviven la conversion.</span></li>
              <li className="flex items-start gap-3"><span className="text-green-500 font-bold mt-0.5">&#10003;</span><span><strong>Fondos de diapositivas</strong> — Degradados, patrones e imagenes de fondo se preservan.</span></li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600 mb-4">Si necesitas que tu audiencia vea las animaciones, aqui hay mejores opciones que PDF:</p>
            <div className="space-y-6">
              <div><h3 className="text-lg font-bold text-slate-900 mb-2">Exportar como video MP4</h3><p className="text-slate-600">PowerPoint puede exportar tu presentacion completa como archivo de video (Archivo &gt; Exportar &gt; Crear un video). Todas las animaciones, transiciones y tiempos se preservan. La desventaja: los espectadores no pueden saltar facilmente a diapositivas especificas.</p></div>
              <div><h3 className="text-lg font-bold text-slate-900 mb-2">Compartir via PowerPoint Online</h3><p className="text-slate-600">Sube tu PPTX a OneDrive y comparte un enlace de solo lectura. Los destinatarios pueden ver la presentacion en su navegador con las animaciones intactas — no necesitan instalar PowerPoint.</p></div>
              <div><h3 className="text-lg font-bold text-slate-900 mb-2">Importar a Google Slides</h3><p className="text-slate-600">Sube tu PPTX a Google Slides y comparte un enlace. La mayoria de las animaciones son soportadas, aunque efectos complejos pueden renderizarse diferente. Gratis y accesible para cualquiera con una cuenta de Google.</p></div>
            </div>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-black text-slate-900 mb-4">Se pueden recuperar las animaciones despues de convertir a PDF?</h2>
            <p className="text-slate-600 mb-4">No. Una vez que una presentacion se convierte a PDF, los datos de animacion se pierden permanentemente. Incluso si conviertes el PDF de vuelta a PowerPoint, el PPTX resultante tendra diapositivas estaticas. Necesitarias volver a agregar las animaciones manualmente.</p>
            <p className="text-slate-600">Por eso es importante <strong>conservar tu archivo PPTX original</strong>. El PDF debe tratarse como una copia de distribucion, no un reemplazo del archivo fuente.</p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-black text-slate-900 mb-4">Cuando PDF ES la opcion correcta (incluso con animaciones)</h2>
            ...
            <ul className="space-y-2 text-slate-700">
              ...
              <li>&#10003; <strong>Adjuntar a emails</strong> — PDF es universalmente visible y mas pequeno que PPTX.</li>
              <li>&#10003; <strong>Subir a portales</strong> — solicitudes de empleo, becas y tramites regulatorios usualmente requieren PDF.</li>
              <li>&#10003; <strong>Imprimir folletos</strong> — para copias fisicas, PDF da los <Link href="/es/aprender/ppt-a-pdf-para-imprimir" className="text-orange-600 hover:underline">resultados de impresion mas confiables</Link>.</li>
              <li>&#10003; <strong>Archivar presentaciones</strong> — PDF asegura que el contenido sea legible anos despues, en cualquier dispositivo.</li>
            </ul>
          </section>
        </div></article>
        ...
        <section className="py-12 bg-[#191B4D]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl text-center">
          ...
          <Link href="/es/powerpoint-a-pdf" className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-xl transition-colors"><PlayCircle className="h-5 w-5" /> Convertir PPT a PDF Ahora</Link>
        </div></section>
