...
export const metadata = {
  title: "Cómo Convertir PDF a JPG en Línea (Rápido y Alta Calidad) | PDF.it",
  description:
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "¿Puedo convertir PDF a JPG en mi teléfono?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. PDF.it funciona en cualquier navegador móvil incluyendo Safari en iPhone y Chrome en Android. Sube tu PDF, conviértelo y guarda las imágenes JPG directamente en tu teléfono. No necesitas ninguna app." } }
  ]
}
...
const howToSchema = {
  ...
  "description": "Convierte las páginas de tu PDF a imágenes JPG de alta calidad en 3 simples pasos usando PDF.it.",
  "step": [
    { "@type": "HowToStep", "name": "Sube tu PDF", "text": "Ve a la herramienta PDF a JPG de PDF.it y sube tu archivo haciendo clic o arrastrándolo al área de carga." },
      ...
      <main>
        ...
        <section className="py-8 bg-[#F0FDFA] border-b border-[#14D8C4]/10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <Link href="/es/pdf-a-jpg" className="inline-flex items-center gap-2 bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-2.5 px-6 rounded-xl text-sm transition-colors whitespace-nowrap">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">1.</span><span><strong>Presentaciones.</strong> No puedes arrastrar un PDF a PowerPoint o Google Slides — pero sí puedes insertar un JPG. Convertir páginas a imágenes te permite usar contenido PDF en cualquier presentación.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">2.</span><span><strong>Redes sociales y sitios web.</strong> Plataformas como Instagram, Facebook y la mayoría de constructores de sitios web no admiten cargas de PDF. JPG es universalmente aceptado.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">3.</span><span><strong>Previsualizaciones rápidas.</strong> A veces necesitas una miniatura o imagen de previsualización de un documento — un JPG de la primera página funciona perfectamente.</span></li>
                <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">4.</span><span><strong>Apps de mensajería.</strong> Compartir un JPG en WhatsApp, Slack o Teams muestra una previsualización en línea. Los PDFs generalmente requieren que el destinatario descargue y abra un archivo separado.</span></li>
              </ul>
            </section>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-t border-gray-200"><td className="py-3 px-4 font-semibold text-[#14D8C4]">72 DPI</td><td className="py-3 px-4">Miniaturas rápidas, previsualizaciones web</td><td className="py-3 px-4">Pequeño (~100-300KB)</td></tr>
                    <tr className="border-t border-gray-200 bg-gray-50"><td className="py-3 px-4 font-semibold text-[#14D8C4]">150 DPI</td><td className="py-3 px-4">Email, uso web, redes sociales</td><td className="py-3 px-4">Mediano (~300-800KB)</td></tr>
                    <tr className="border-t border-gray-200"><td className="py-3 px-4 font-semibold text-[#14D8C4]">200 DPI</td><td className="py-3 px-4">Presentaciones, documentos, visualización clara</td><td className="py-3 px-4">Grande (~500KB-1.5MB)</td></tr>
                    <tr className="border-t border-gray-200 bg-gray-50"><td className="py-3 px-4 font-semibold text-[#14D8C4]">300 DPI</td><td className="py-3 px-4">Impresión, archivado, máxima calidad</td><td className="py-3 px-4">Muy grande (~1-3MB por página)</td></tr>
                  </tbody>
                </table>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 mt-2">¿Necesitas PNG? Usa nuestra herramienta <Link href="/es/pdf-a-png" className="text-[#14D8C4] hover:underline">PDF a PNG</Link> para conversión sin pérdida.</p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 mb-4">Si tienes varios PDFs para convertir, hacerlos uno a uno es tedioso. Los usuarios Pro de PDF.it pueden subir múltiples PDFs y convertirlos todos a JPG en un solo lote:</p>
              ...
              <p className="text-slate-600 mt-4">Los usuarios gratuitos pueden convertir un archivo a la vez. Si conviertes PDFs regularmente, <Link href="/es/precios" className="text-[#14D8C4] hover:underline">actualizar a Pro</Link> ahorra tiempo significativo.</p>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-600">Si tu PDF es muy grande, <Link href="/es/comprimir-pdf" className="text-[#14D8C4] hover:underline">comprímelo primero</Link> para eliminar datos innecesarios. Esto puede acelerar el proceso de conversión sin afectar la calidad final del JPG.</p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Divide Primero, Convierte Después</h3>
                  <p className="text-slate-600">Si solo necesitas unas pocas páginas como JPG, no conviertas todo el PDF. Usa <Link href="/es/dividir-pdf" className="text-[#14D8C4] hover:underline">Dividir PDF</Link> para extraer solo las páginas que necesitas, luego conviértelas a JPG. Más rápido y menos desorden.</p>
                </div>
                <div>
        ...
        <section className="py-12" style={{ background: "#0E0F1E" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl text-center">
            ...
            <Link href="/es/pdf-a-jpg" className="inline-flex items-center gap-2 bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-3 px-8 rounded-xl transition-colors">
