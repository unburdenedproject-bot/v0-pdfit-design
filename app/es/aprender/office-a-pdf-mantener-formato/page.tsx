...
export const metadata = {
  title: "Como mantener el formato al convertir Office a PDF | OmnisPDF",
...
const faqSchema = { "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [
  ...
  { "@type": "Question", "name": "Puedo convertir archivos Office a PDF sin perder hiperenlaces?", "acceptedAnswer": { "@type": "Answer", "text": "Si. OmnisPDF preserva hiperenlaces clicables durante la conversion. Enlaces a sitios web, direcciones de email y marcadores dentro del documento permanecen funcionales en el PDF." } },
...
const howToSchema = { "@context": "https://schema.org", "@type": "HowTo", "name": "Como mantener el formato al convertir Office a PDF", "description": "Preserva el diseno, fuentes e imagenes de tu documento al convertir a PDF en 3 pasos.", "step": [
  ...
  { "@type": "HowToStep", "name": "Convierte con OmnisPDF", "text": "Sube tu archivo a la herramienta Office a PDF de OmnisPDF. El convertidor preserva formato, fuentes, imagenes y diseno automaticamente." },
    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              {[
                ...
                { title: "Convierte y verifica el resultado", desc: "Sube a la herramienta Office a PDF de OmnisPDF, descarga el PDF y abrelo para verificar cada pagina. Busca imagenes desplazadas, fuentes faltantes, tablas cortadas y saltos de pagina incorrectos." },
              ].map((step, i) => (
        ...
        <section className="py-12 bg-gradient-to-br from-slate-900 to-slate-800"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl text-center">
          ...
          <p className="text-slate-300 mb-6">OmnisPDF preserva fuentes, imagenes y diseno automaticamente. Sube tu archivo Office y obtiene un PDF pixel-perfect.</p>
