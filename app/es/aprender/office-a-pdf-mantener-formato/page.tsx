    ...
    <div className="min-h-screen bg-[#F3F4FF]">
      ...
      <main>
        ...
        <section className="py-8 bg-[#F0FDFA] border-b border-[#14D8C4]/10"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 bg-[#14D8C4] rounded-lg flex items-center justify-center flex-shrink-0"><FileText className="h-5 w-5 text-white" /></div><p className="text-slate-700 font-semibold">Listo para convertir? Nuestra herramienta preserva el formato automaticamente.</p></div>
        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <section className="mb-12">
            ...
            <ul className="space-y-3 text-slate-700">
              ...
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">2.</span><span><strong>Diferencias de margenes y tamano de pagina.</strong> Si tu documento fue disenado para papel A4 pero el convertidor usa tamano Carta (o viceversa), el contenido cerca de los bordes puede cortarse o desplazarse.</span></li>
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">3.</span><span><strong>Desplazamiento de imagenes.</strong> Las imagenes ancladas al texto pueden desplazarse cuando el interlineado cambia debido a la sustitucion de fuentes. Las imagenes configuradas como "en linea con texto" son mas estables que las flotantes.</span></li>
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">4.</span><span><strong>Desbordamiento de tablas.</strong> Las tablas anchas de Excel pueden extenderse mas alla del ancho de pagina del PDF, cortando columnas del lado derecho.</span></li>
