          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                ...
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">3.</span><span><strong>Extraer texto plano.</strong> Usa <Link href="/es/pdf-a-txt" className="text-orange-600 hover:underline">PDF a TXT</Link> para extraer todo el contenido de texto para procesamiento de datos, traduccion o analisis.</span></li>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div><h3 className="text-lg font-bold text-slate-900 mb-2">Comienza con un Escaneo Limpio</h3><p className="text-slate-600">La precision del OCR depende en gran medida de la calidad del escaneo. Usa al menos 300 DPI de resolucion, asegurate de que el texto no este borroso y evita sombras o iluminacion desigual. Si escaneaste con tu telefono, pasa el archivo por <Link href="/es/limpieza-escaneo-telefono" className="text-orange-600 hover:underline">Limpieza de Escaneo de Telefono</Link> antes del OCR.</p></div>
