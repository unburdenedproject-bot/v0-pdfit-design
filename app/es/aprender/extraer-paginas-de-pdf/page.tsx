      ...
      <main>
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-3xl mx-auto">
            <p className="text-orange-400 font-semibold text-sm mb-3 uppercase tracking-wide">Aprender / Extraer Páginas</p>
        ...
        <section className="py-8 bg-orange-50 border-b border-orange-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center flex-shrink-0"><FileOutput className="h-5 w-5 text-white" /></div>
        ...
        <article className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600">Si quieres combinar páginas extraídas con páginas de otros PDFs, usa <Link href="/es/unir-pdf" className="text-orange-600 hover:underline">Unir PDF</Link> para juntarlas en un solo documento.</p>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                <li>✓ <strong>Comprímelo</strong> para reducir el tamaño del archivo usando <Link href="/es/comprimir-pdf" className="text-orange-600 hover:underline">Comprimir PDF</Link> — especialmente útil si las páginas extraídas contienen imágenes escaneadas.</li>
                <li>✓ <strong>Únelo</strong> con otros documentos usando <Link href="/es/unir-pdf" className="text-orange-600 hover:underline">Unir PDF</Link> para construir un documento personalizado de múltiples fuentes.</li>
                <li>✓ <strong>Conviértelo</strong> a otro formato — por ejemplo, <Link href="/es/pdf-a-word" className="text-orange-600 hover:underline">PDF a Word</Link> si necesitas editar el contenido.</li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Después de extraer páginas, pasa el nuevo archivo por <Link href="/es/comprimir-pdf" className="text-orange-600 hover:underline">Comprimir PDF</Link> antes de enviarlo por email. Esto asegura que el archivo sea lo más pequeño posible para el destinatario.</p>
                </div>
              </div>
            </section>
