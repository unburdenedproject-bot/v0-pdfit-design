...
export const metadata = {
  title: "Cómo Comprimir un PDF (Reducir Tamaño Rápidamente) | OmnisPDF",
  description:
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Sube tu PDF a OmnisPDF, elige un nivel de compresión (Ligera, Media o Extrema), haz clic en Comprimir y descarga el archivo más pequeño. No se requiere registro para tus primeros 3 archivos." }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Sí. OmnisPDF funciona en cualquier navegador móvil — sube tu PDF, comprímelo y descarga el resultado directamente en iPhone o Android. No necesitas ninguna app." }
    },
    {
      "@type": "Question",
...
const howToSchema = {
  ...
  "description": "Reduce el tamaño de tu archivo PDF en 3 simples pasos usando OmnisPDF.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Sube tu PDF",
      "text": "Ve a la herramienta Comprimir PDF de OmnisPDF y sube tu archivo haciendo clic o arrastrándolo al área de carga."
    },
    {
      "@type": "HowToStep",
      ...
      <main>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Capas y anotaciones.</strong> Los campos de formulario, comentarios y elementos interactivos añaden datos extra. <Link href="/es/aplanar-pdf" className="text-orange-600 hover:underline">Aplanar tu PDF</Link> los elimina.</span>
                </li>
              </ul>
            </section>
                ...
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-t border-gray-200">
                      <td className="py-3 px-4 font-semibold text-orange-600">Ligera</td>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-600">
                    Gmail, Outlook y Yahoo limitan los adjuntos a 20-25MB. La compresión Media generalmente logra que los PDFs estén bajo este límite. Para límites más estrictos, prueba nuestra herramienta <Link href="/es/comprimir-pdf-para-email" className="text-orange-600 hover:underline">Comprimir para Email</Link> que está optimizada para servicios de correo electrónico.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Muchos portales requieren PDFs de menos de 2MB o 5MB. Usa la compresión Extrema, y si el archivo sigue siendo muy grande, divídelo en páginas individuales primero. Consulta nuestras herramientas dedicadas para <Link href="/es/comprimir-pdf-a-2mb" className="text-orange-600 hover:underline">límites de 2MB</Link> y <Link href="/es/comprimir-pdf-a-5mb" className="text-orange-600 hover:underline">límites de 5MB</Link>.
                  </p>
                </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                { q: "¿Cómo comprimo un PDF gratis?", a: "Sube tu PDF a OmnisPDF, elige un nivel de compresión (Ligera, Media o Extrema), haz clic en Comprimir y descarga el archivo más pequeño. No se requiere registro para tus primeros 3 archivos." },
                ...
                { q: "¿Puedo comprimir un PDF en mi teléfono?", a: "Sí. OmnisPDF funciona en cualquier navegador móvil — sube tu PDF, comprímelo y descarga el resultado directamente en iPhone o Android. No necesitas ninguna app." },
