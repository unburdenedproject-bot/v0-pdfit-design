          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>&#10003; <strong>Limpia los escaneos de telefono.</strong> Si el escaneo vino de una camara de telefono, usa <Link href="/es/limpieza-escaneo-telefono" className="text-orange-600 hover:underline">Limpieza de Escaneo de Telefono</Link> para mejorar el contraste y eliminar sombras antes de ejecutar OCR. Mejor calidad de entrada significa mejor precision de OCR.</li>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                ...
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">2.</span><span><strong>Limpiar</strong> — Si fue escaneado con un telefono, usa <Link href="/es/limpieza-escaneo-telefono" className="text-orange-600 hover:underline">Limpieza de Escaneo de Telefono</Link> para mejorar el contraste y eliminar sombras.</span></li>
