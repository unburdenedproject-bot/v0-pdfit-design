    ...
    <div className="min-h-screen bg-[#F3F4FF]">
      ...
      <main>
        ...
        <section className="py-8 bg-[#F0FDFA] border-b border-[#14D8C4]/10"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 bg-[#14D8C4] rounded-lg flex items-center justify-center flex-shrink-0"><FileSpreadsheet className="h-5 w-5 text-white" /></div><p className="text-slate-700 font-semibold">Configuraciones listas? Convierte tu hoja de calculo ahora.</p></div>
        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <section className="mb-12">
            ...
            <p className="text-slate-600 mb-4">Cuando conviertes un archivo Excel a PDF — ya sea a traves de la exportacion integrada de Excel o una herramienta en linea como <Link href="/es/excel-a-pdf" className="text-[#14D8C4] hover:underline">PDF.it</Link> — el convertidor usa tus configuraciones de impresion para determinar como los datos se distribuyen en las paginas.</p>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                ...
                <tbody className="text-slate-700">
                  <tr className="border-t border-gray-200"><td className="py-3 px-4 font-semibold text-[#14D8C4]">Ajustar hoja en una pagina</td><td className="py-3 px-4">Reduce toda la hoja (ancho + alto) a una pagina</td><td className="py-3 px-4">Tablas pequenas de menos de 30 filas</td></tr>
                  <tr className="border-t border-gray-200 bg-gray-50"><td className="py-3 px-4 font-semibold text-[#14D8C4]">Ajustar todas las columnas en una pagina</td><td className="py-3 px-4">Restringe el ancho a una pagina, las filas fluyen libremente</td><td className="py-3 px-4">La mayoria de hojas (recomendado)</td></tr>
                  <tr className="border-t border-gray-200"><td className="py-3 px-4 font-semibold text-[#14D8C4]">Ajustar todas las filas en una pagina</td><td className="py-3 px-4">Restringe la altura a una pagina, las columnas fluyen libremente</td><td className="py-3 px-4">Raramente util — solo para datos estrechos y altos</td></tr>
                </tbody>
              </table>
            </div>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600 mt-4">No estas seguro? Prueba ambas en Vista previa de impresion y ve cual produce un resultado mas limpio. Siempre puedes verificar antes de convertir con <Link href="/es/excel-a-pdf" className="text-[#14D8C4] hover:underline">PDF.it</Link>.</p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600">Hojas de calculo grandes con graficos, imagenes o muchas paginas pueden producir PDFs grandes. Si necesitas enviar el archivo por email o subirlo a un portal con limites de tamano, usa <Link href="/es/comprimir-pdf" className="text-[#14D8C4] hover:underline">Comprimir PDF</Link> despues de convertir.</p>
          </section>
        </div></article>
