          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>&#x2717; <strong>Imágenes y gráficos</strong> — fotos, gráficos, logotipos y diagramas se eliminan. Usa <Link href="/es/extraer-imagenes-de-pdf" className="text-orange-600 hover:underline">Extraer Imágenes</Link> si los necesitas por separado.</li>
              ...
              <p className="text-slate-600 mt-4">
                Si necesitas conservar el formato, considera usar <Link href="/es/pdf-a-word" className="text-orange-600 hover:underline">PDF a Word</Link> en su lugar — preserva el diseño, tablas y estilos en un documento editable.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Algunos PDFs restringen la copia de texto. Si tu PDF está protegido, usa <Link href="/es/desbloquear-pdf" className="text-orange-600 hover:underline">Desbloquear PDF</Link> primero (necesitarás la contraseña), luego convierte a TXT.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Algunos PDFs usan fuentes codificadas o personalizadas que producen texto ilegible al extraerlo. Si tu salida parece texto sin sentido, prueba <Link href="/es/pdf-a-word" className="text-orange-600 hover:underline">PDF a Word</Link> que maneja la codificación de fuentes de manera diferente, o usa OCR como alternativa.
                  </p>
                </div>
              </div>
            </section>
