    ...
    <div className="min-h-screen bg-[#F3F4FF]">
      ...
      <main>
        ...
        <section className="py-8 bg-[#F0FDFA] border-b border-[#14D8C4]/10"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 bg-[#14D8C4] rounded-lg flex items-center justify-center flex-shrink-0"><FileSpreadsheet className="h-5 w-5 text-white" /></div><p className="text-slate-700 font-semibold">Solucionaste tu diseno? Convierte tu hoja de calculo ahora.</p></div>
        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <section className="mb-12">
            ...
            <ul className="space-y-3 text-slate-700">
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">1.</span><span><strong>El ancho de pagina es muy estrecho.</strong> Modo vertical en papel tamano carta solo cabe unas 8-10 columnas estandar. Si tienes 15 o 20 columnas, el resto se desborda.</span></li>
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">2.</span><span><strong>No se ha establecido area de impresion.</strong> Sin un area de impresion definida, Excel adivina que celdas incluir. A menudo incluye columnas vacias o pierde las columnas que necesitas.</span></li>
              ...
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">4.</span><span><strong>Los anchos de columna son desiguales.</strong> Una columna extra ancha (como "Notas" o "Descripcion") puede empujar todo lo demas fuera de la pagina.</span></li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-slate-600 mt-2">Una vez establecida el area de impresion, convierte usando la <Link href="/es/excel-a-pdf" className="text-[#14D8C4] hover:underline">herramienta Excel a PDF de PDF.it</Link>.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-slate-600">Despues de convertir, si necesitas reorganizar las paginas, usa <Link href="/es/dividir-pdf" className="text-[#14D8C4] hover:underline">Dividir PDF</Link> para separar o reordenarlas.</p>
              </div>
            </div>
          </section>
