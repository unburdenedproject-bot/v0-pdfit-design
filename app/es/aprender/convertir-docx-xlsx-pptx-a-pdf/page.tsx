...
export const metadata = {
  title: "Convertir DOCX, XLSX y PPTX a PDF — Todos los formatos Office | OmnisPDF",
...
const faqSchema = { "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [
  { "@type": "Question", "name": "Puedo convertir archivos DOCX, XLSX y PPTX a PDF en una sola herramienta?", "acceptedAnswer": { "@type": "Answer", "text": "Si. La herramienta Office a PDF de OmnisPDF acepta archivos de Word, Excel y PowerPoint todo en un solo lugar. Sube cualquier archivo .docx, .xlsx o .pptx y obtiene un PDF en segundos." } },
  { "@type": "Question", "name": "Convertir archivos Office a PDF cambia el formato?", "acceptedAnswer": { "@type": "Answer", "text": "OmnisPDF preserva fuentes, imagenes, tablas y diseno durante la conversion. Para mejores resultados, usa fuentes estandar y evita macros complejas en tu archivo original." } },
  ...
  { "@type": "Question", "name": "Que formatos de archivo Office soporta OmnisPDF?", "acceptedAnswer": { "@type": "Answer", "text": "OmnisPDF soporta .docx (Word), .xlsx (Excel), .pptx (PowerPoint), y formatos legacy como .doc, .xls y .ppt a traves del convertidor Office a PDF." } },
  { "@type": "Question", "name": "Puedo convertir archivos Office a PDF en mi telefono?", "acceptedAnswer": { "@type": "Answer", "text": "Si. OmnisPDF funciona en cualquier navegador movil. Sube tu archivo Office, conviertelo y descarga el PDF — sin necesidad de instalar apps." } }
] }

const howToSchema = { "@context": "https://schema.org", "@type": "HowTo", "name": "Como convertir DOCX, XLSX y PPTX a PDF", "description": "Convierte cualquier archivo de Microsoft Office a PDF en 3 simples pasos usando OmnisPDF.", "step": [
  { "@type": "HowToStep", "name": "Sube tu archivo Office", "text": "Ve a la herramienta Office a PDF de OmnisPDF y sube tu archivo .docx, .xlsx o .pptx haciendo clic o arrastrandolo al area de carga." },
  { "@type": "HowToStep", "name": "Convierte a PDF", "text": "Haz clic en Convertir y OmnisPDF procesara tu archivo, preservando todo el formato, imagenes y diseno." },
    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-slate-300">Deja de usar tres convertidores diferentes. Ya sea que tengas un documento Word, una hoja de calculo Excel o una presentacion PowerPoint, OmnisPDF convierte cualquier archivo Office en un PDF limpio en segundos.</p>
        </div></div></section>
        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <section className="mb-12">
            ...
            <ul className="space-y-3 text-slate-700">
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">1.</span><span><strong>Compatibilidad universal.</strong> Cualquiera puede abrir un PDF sin importar su dispositivo o software. No todos tienen Microsoft Office instalado, pero cualquier dispositivo puede leer PDFs.</span></li>
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">2.</span><span><strong>El formato se mantiene intacto.</strong> Un documento Word que se ve perfecto en tu pantalla puede cambiar fuentes, margenes e imagenes en la computadora de otra persona. Los PDFs se ven igual en todas partes.</span></li>
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">3.</span><span><strong>Apariencia profesional.</strong> Enviar un PDF pulido en lugar de un .docx editable demuestra atencion al detalle — especialmente para curriculos, propuestas y facturas.</span></li>
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">4.</span><span><strong>Tamanos de archivo mas pequenos.</strong> Los PDFs a menudo son mas pequenos que sus equivalentes Office, haciendolos mas faciles de enviar por email. Puedes <Link href="/es/comprimir-pdf" className="text-orange-600 hover:underline">comprimir el PDF aun mas</Link> si es necesario.</span></li>
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">5.</span><span><strong>Seguridad.</strong> Los PDFs pueden <Link href="/es/proteger-pdf" className="text-orange-600 hover:underline">protegerse con contrasena</Link> para prevenir edicion o visualizacion no autorizada.</span></li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              {[
                { title: "Sube tu archivo Office", desc: "Ve a la herramienta Office a PDF de OmnisPDF y arrastra tu archivo .docx, .xlsx o .pptx al area de carga. Archivos hasta 25MB son gratis — usuarios Pro pueden subir archivos hasta 200MB." },
                { title: "Haz clic en Convertir", desc: "OmnisPDF detecta el tipo de archivo automaticamente y lo convierte a PDF preservando tu formato, imagenes, graficos y tablas." },
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600 mb-4">La herramienta <Link href="/es/office-a-pdf" className="text-orange-600 hover:underline">Office a PDF</Link> de OmnisPDF maneja los tres formatos en un solo lugar. Sube cualquier combinacion de archivos .docx, .xlsx y .pptx y conviertelos todos a la vez. Los usuarios Pro pueden incluso convertir por lotes multiples archivos simultaneamente.</p>
            <p className="text-slate-600">Por supuesto, si solo trabajas con un formato, tambien puedes usar los convertidores dedicados: <Link href="/es/word-a-pdf" className="text-orange-600 hover:underline">Word a PDF</Link>, <Link href="/es/excel-a-pdf" className="text-orange-600 hover:underline">Excel a PDF</Link>, o <Link href="/es/powerpoint-a-pdf" className="text-orange-600 hover:underline">PowerPoint a PDF</Link>.</p>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 text-slate-700">
              <li>&#10003; <strong>Unir multiples PDFs</strong> en un documento usando <Link href="/es/unir-pdf" className="text-orange-600 hover:underline">Unir PDF</Link> — ideal para combinar carta de presentacion, curriculo y portafolio.</li>
              <li>&#10003; <strong>Comprimir el PDF</strong> si es muy grande para email. Usa <Link href="/es/comprimir-pdf" className="text-orange-600 hover:underline">Comprimir PDF</Link> para que quede bajo el limite tipico de 25MB.</li>
              <li>&#10003; <strong>Agregar proteccion con contrasena</strong> con <Link href="/es/proteger-pdf" className="text-orange-600 hover:underline">Proteger PDF</Link> si el documento contiene datos sensibles.</li>
            </ul>
          </section>
        </div></article>
