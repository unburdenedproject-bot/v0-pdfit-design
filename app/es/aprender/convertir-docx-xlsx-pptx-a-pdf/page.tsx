...
export const metadata = {
  ...
  description: "Aprende como convertir cualquier archivo de Microsoft Office — Word, Excel o PowerPoint — a PDF en una sola herramienta. Mantiene formato, reduce tamaño de archivo y comparte con confianza.",
...
const faqSchema = { "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [
  ...
  { "@type": "Question", "name": "Convertir archivos Office a PDF cambia el formato?", "acceptedAnswer": { "@type": "Answer", "text": "PDF.it preserva fuentes, imágenes, tablas y diseño durante la conversión. Para mejores resultados, usa fuentes estándar y evita macros complejas en tu archivo original." } },
  { "@type": "Question", "name": "Es gratis convertir archivos Office a PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Si. Los usuarios gratuitos obtienen 10 conversiónes por día con archivos hasta 25MB. Los usuarios Pro obtienen conversiónes ilimitadas con archivos hasta 200MB y procesamiento por lotes." } },
  { "@type": "Question", "name": "Puedo convertir múltiples archivos Office a PDF a la vez?", "acceptedAnswer": { "@type": "Answer", "text": "Los usuarios Pro pueden convertir por lotes múltiples archivos Office a PDF en una sola operación. Los usuarios gratuitos pueden convertir un archivo a la vez." } },
  ...
  { "@type": "Question", "name": "Puedo convertir archivos Office a PDF en mi teléfono?", "acceptedAnswer": { "@type": "Answer", "text": "Si. PDF.it funciona en cualquier navegador móvil. Sube tu archivo Office, conviertelo y descarga el PDF — sin necesidad de instalar apps." } }
] }
...
const howToSchema = { "@context": "https://schema.org", "@type": "HowTo", "name": "Como convertir DOCX, XLSX y PPTX a PDF", "description": "Convierte cualquier archivo de Microsoft Office a PDF en 3 simples pasos usando PDF.it.", "step": [
  ...
  { "@type": "HowToStep", "name": "Convierte a PDF", "text": "Haz clic en Convertir y PDF.it procesará tu archivo, preservando todo el formato, imágenes y diseño." },
  { "@type": "HowToStep", "name": "Descarga tu PDF", "text": "Descarga tu PDF convertido. Si el archivo es muy grande, usa la herramienta Comprimir PDF para reducir su tamaño antes de compartir." }
] }
    ...
    <div className="min-h-screen bg-[#F3F4FF]">
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-slate-300">Deja de usar tres convertidores diferentes. Ya sea que tengas un documento Word, una hoja de cálculo Excel o una presentación PowerPoint, PDF.it convierte cualquier archivo Office en un PDF limpio en segundos.</p>
        </div></div></section>
        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <section className="mb-12">
            ...
            <p className="text-slate-600 mb-4">Los archivos de Microsoft Office son excelentes para editar, pero no son ideales para compartir. Aqui esta por qué PDF es la mejor opción cuando tu documento sale de tu computadora:</p>
            <ul className="space-y-3 text-slate-700">
              ...
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">4.</span><span><strong>Tamaños de archivo más pequeños.</strong> Los PDFs a menudo son más pequeños que sus equivalentes Office, haciendolos más fáciles de enviar por email. Puedes <Link href="/es/comprimir-pdf" className="text-[#14D8C4] hover:underline">comprimir el PDF aun más</Link> si es necesario.</span></li>
              <li className="flex items-start gap-3"><span className="text-[#14D8C4] font-bold mt-0.5">5.</span><span><strong>Seguridad.</strong> Los PDFs pueden <Link href="/es/proteger-pdf" className="text-[#14D8C4] hover:underline">protegerse con contraseña</Link> para prevenir edición o visualización no autorizada.</span></li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              {[
                ...
                { title: "Haz clic en Convertir", desc: "PDF.it detecta el tipo de archivo automáticamente y lo convierte a PDF preservando tu formato, imágenes, gráficos y tablas." },
                { title: "Descarga tu PDF", desc: "Tu PDF esta listo en segundos. Descargalo directamente o comprimelo después si necesitas un archivo más pequeño para email o subir a un portal." },
              ].map((step, i) => (
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div><h3 className="text-lg font-bold text-slate-900 mb-2">Word (.docx) a PDF</h3><p className="text-slate-600">Los documentos Word usualmente se convierten limpiamente. Cuidado con fuentes personalizadas que pueden no estar incrustadas — usa fuentes estándar como Arial, Times New Roman o Calibri para mejores resultados. Si tu documento tiene control de cambios, acepta o rechaza antes de convertir. Usa la herramienta dedicada <Link href="/es/word-a-pdf" className="text-[#14D8C4] hover:underline">Word a PDF</Link> para opciones avanzadas.</p></div>
              <div><h3 className="text-lg font-bold text-slate-900 mb-2">Excel (.xlsx) a PDF</h3><p className="text-slate-600">Las hojas de cálculo pueden ser complicadas porque tablas anchas pueden cortarse. Antes de convertir, establece tu area de impresión en Excel y elige orientación horizontal para hojas anchas. La herramienta <Link href="/es/excel-a-pdf" className="text-[#14D8C4] hover:underline">Excel a PDF</Link> maneja esto automáticamente cuando es posible.</p></div>
              <div><h3 className="text-lg font-bold text-slate-900 mb-2">PowerPoint (.pptx) a PDF</h3><p className="text-slate-600">Las presentaciones se convierten con una diapositiva por página por defecto. Las animaciones y transiciones no apareceran en el PDF, pero todo el texto, imágenes y gráficos se preservan. Usa la herramienta <Link href="/es/powerpoint-a-pdf" className="text-[#14D8C4] hover:underline">PowerPoint a PDF</Link> para los mejores resultados.</p></div>
            </div>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-black text-slate-900 mb-4">Un convertidor vs. tres herramientas separadas</h2>
            <p className="text-slate-600 mb-4">Muchos sitios web te obligan a usar una herramienta diferente para cada tipo de archivo — una para Word, otra para Excel y una tercera para PowerPoint. Eso significa subir a tres páginas diferentes y aprender tres interfaces diferentes.</p>
            <p className="text-slate-600 mb-4">La herramienta <Link href="/es/office-a-pdf" className="text-[#14D8C4] hover:underline">Office a PDF</Link> de PDF.it maneja los tres formatos en un solo lugar. Sube cualquier combinación de archivos .docx, .xlsx y .pptx y conviertelos todos a la vez. Los usuarios Pro pueden incluso convertir por lotes múltiples archivos simultaneamente.</p>
            <p className="text-slate-600">Por supuesto, si solo trabajas con un formato, también puedes usar los convertidores dedicados: <Link href="/es/word-a-pdf" className="text-[#14D8C4] hover:underline">Word a PDF</Link>, <Link href="/es/excel-a-pdf" className="text-[#14D8C4] hover:underline">Excel a PDF</Link>, o <Link href="/es/powerpoint-a-pdf" className="text-[#14D8C4] hover:underline">PowerPoint a PDF</Link>.</p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-black text-slate-900 mb-4">Que hacer después de convertir</h2>
            ...
            <ul className="space-y-2 text-slate-700">
              <li>&#10003; <strong>Unir múltiples PDFs</strong> en un documento usando <Link href="/es/unir-pdf" className="text-[#14D8C4] hover:underline">Unir PDF</Link> — ideal para combinar carta de presentación, curriculo y portafolio.</li>
              <li>&#10003; <strong>Comprimir el PDF</strong> si es muy grande para email. Usa <Link href="/es/comprimir-pdf" className="text-[#14D8C4] hover:underline">Comprimir PDF</Link> para que quede bajo el límite típico de 25MB.</li>
              <li>&#10003; <strong>Agregar protección con contraseña</strong> con <Link href="/es/proteger-pdf" className="text-[#14D8C4] hover:underline">Proteger PDF</Link> si el documento contiene datos sensibles.</li>
            </ul>
          </section>
        </div></article>
