      ...
      <main>
        ...
        <section className="py-8 bg-orange-50 border-b border-orange-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center flex-shrink-0"><FileDown className="h-5 w-5 text-white" /></div>
              <p className="text-slate-700 font-semibold">¿Listo para comprimir? Salta la guía y ve directo a la herramienta.</p>
            </div>
            <Link href="/es/comprimir-pdf" className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-2.5 px-6 rounded-xl text-sm transition-colors whitespace-nowrap">Comprimir PDF Ahora <ArrowRight className="h-4 w-4" /></Link>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-slate-700">
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">1.</span><span><strong>Objetos redundantes.</strong> Los PDFs frecuentemente almacenan fuentes duplicadas, perfiles de color y metadatos. La compresión sin pérdida los fusiona en instancias únicas.</span></li>
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">2.</span><span><strong>Flujos de datos no usados.</strong> El software de edición a veces deja objetos huérfanos en el archivo. La compresión los elimina.</span></li>
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">3.</span><span><strong>Metadatos y miniaturas.</strong> Información del autor, historial de revisiones y miniaturas incrustadas añaden kilobytes que la mayoría de las personas nunca ven.</span></li>
                <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">4.</span><span><strong>Campos de formulario y capas.</strong> Los elementos interactivos añaden sobrecarga. <Link href="/es/aplanar-pdf" className="text-orange-600 hover:underline">Aplanar tu PDF</Link> los elimina sin afectar cómo se ve el documento cuando se imprime o visualiza.</span></li>
              </ul>
            </section>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-t border-gray-200"><td className="py-3 px-4 font-semibold text-orange-600">Ligera</td><td className="py-3 px-4">Ninguno — imágenes intactas, texto nítido</td><td className="py-3 px-4">10-30%</td></tr>
                    <tr className="border-t border-gray-200 bg-gray-50"><td className="py-3 px-4 font-semibold text-orange-600">Media</td><td className="py-3 px-4">Ligero remuestreo de imagen — imperceptible en pantalla</td><td className="py-3 px-4">30-60%</td></tr>
                    <tr className="border-t border-gray-200"><td className="py-3 px-4 font-semibold text-orange-600">Extrema</td><td className="py-3 px-4">Pérdida de calidad visible en imágenes de alta resolución y fotos</td><td className="py-3 px-4">60-80%</td></tr>
                  </tbody>
                </table>
              </div>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                <li>&#10003; <strong>Aplana el PDF.</strong> Usa <Link href="/es/aplanar-pdf" className="text-orange-600 hover:underline">Aplanar PDF</Link> para fusionar campos de formulario, anotaciones y capas en el contenido de la página. Esto puede eliminar sobrecarga significativa sin cambiar la salida visual.</li>
                <li>&#10003; <strong>Elimina páginas innecesarias.</strong> Si tu PDF tiene páginas en blanco o secciones que no necesitas, usa <Link href="/es/dividir-pdf" className="text-orange-600 hover:underline">Dividir PDF</Link> para extraer solo las páginas que quieres, luego <Link href="/es/unir-pdf" className="text-orange-600 hover:underline">únelas de nuevo</Link>.</li>
                ...
                <li>&#10003; <strong>Usa PDF Listo para Subir.</strong> Nuestra herramienta <Link href="/es/pdf-listo-para-subir" className="text-orange-600 hover:underline">PDF Listo para Subir</Link> encadena aplanamiento y compresión juntos para el mejor resultado en un solo paso.</li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-600">Los portales gubernamentales, solicitudes de visa y envíos de exámenes frecuentemente limitan los archivos a 2MB o 5MB. Si la compresión Ligera no te lleva ahí, prueba nuestras herramientas dedicadas de <Link href="/es/comprimir-pdf-a-2mb" className="text-orange-600 hover:underline">Comprimir a 2MB</Link> o <Link href="/es/comprimir-pdf-a-5mb" className="text-orange-600 hover:underline">Comprimir a 5MB</Link>.</p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Adjuntos de Email</h3>
                  <p className="text-slate-600">La mayoría de los servicios de email limitan los adjuntos a 20-25MB. Si tu PDF está cerca de ese límite, la compresión Media lo pondrá por debajo manteniendo el texto y los gráficos perfectamente legibles. Consulta nuestra guía de <Link href="/es/comprimir-pdf-para-email" className="text-orange-600 hover:underline">Comprimir para Email</Link>.</p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Archivos Muy Grandes (50MB+)</h3>
                  <p className="text-slate-600">Para PDFs muy grandes con cientos de páginas o fotos de alta resolución, incluso la compresión Media puede ser necesaria. Considera dividir el archivo primero con <Link href="/es/dividir-pdf" className="text-orange-600 hover:underline">Dividir PDF</Link>, luego comprimir cada parte.</p>
                </div>
              </div>
            </section>
        ...
        <section className="py-12 bg-gradient-to-br from-slate-900 to-slate-800">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl text-center">
            ...
            <Link href="/es/comprimir-pdf" className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-xl transition-colors"><FileDown className="h-5 w-5" /> Comprimir PDF Ahora</Link>
          </div>
        </section>
