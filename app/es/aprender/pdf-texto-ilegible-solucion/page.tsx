        ...
        <article className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600">
                <strong>La solución:</strong> Prueba <Link href="/es/pdf-a-word" className="text-orange-600 hover:underline">PDF a Word</Link>, que usa un método de extracción diferente que a veces puede decodificar fuentes personalizadas. Si eso no funciona, usa <Link href="/es/escaner-ocr" className="text-orange-600 hover:underline">OCR</Link> como alternativa — OCR lee la apariencia visual y evita la codificación por completo.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600">
                <strong>La solución:</strong> Usa <Link href="/es/desbloquear-pdf" className="text-orange-600 hover:underline">Desbloquear PDF</Link> para eliminar restricciones (necesitarás la contraseña del propietario si se estableció una), luego convierte a TXT normalmente con <Link href="/es/pdf-a-texto" className="text-orange-600 hover:underline">PDF a TXT</Link>.
              </p>
            </section>
                ...
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-t border-gray-200">
                      ...
                      <td className="py-3 px-4 font-semibold text-orange-600"><Link href="/es/escaner-ocr" className="hover:underline">Escáner OCR</Link></td>
                    </tr>
                    <tr className="border-t border-gray-200 bg-gray-50">
                      <td className="py-3 px-4">Símbolos aleatorios / texto ilegible</td>
                      <td className="py-3 px-4">Codificación de fuente</td>
                      <td className="py-3 px-4 font-semibold text-orange-600"><Link href="/es/pdf-a-word" className="hover:underline">PDF a Word</Link> o <Link href="/es/escaner-ocr" className="hover:underline">OCR</Link></td>
                    </tr>
                    <tr className="border-t border-gray-200">
                      <td className="py-3 px-4">No se puede seleccionar texto</td>
                      <td className="py-3 px-4">PDF protegido</td>
                      <td className="py-3 px-4 font-semibold text-orange-600"><Link href="/es/desbloquear-pdf" className="hover:underline">Desbloquear PDF</Link> luego <Link href="/es/pdf-a-texto" className="hover:underline">PDF a TXT</Link></td>
                    </tr>
                    <tr className="border-t border-gray-200 bg-gray-50">
                      <td className="py-3 px-4">Palabras en orden incorrecto</td>
                      <td className="py-3 px-4">Diseño complejo</td>
                      <td className="py-3 px-4 font-semibold text-orange-600"><Link href="/es/pdf-a-texto" className="hover:underline">PDF a TXT</Link> o <Link href="/es/pdf-a-word" className="hover:underline">PDF a Word</Link></td>
                    </tr>
                    <tr className="border-t border-gray-200">
