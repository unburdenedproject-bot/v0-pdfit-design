    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="py-8 bg-orange-50 border-b border-orange-100"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center flex-shrink-0"><Shield className="h-5 w-5 text-white" /></div><p className="text-slate-700 font-semibold">Listo para asegurar tu PDF? Salta la guia y ve directo a la herramienta.</p></div>
        ...
        <article className="py-16"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-3 text-slate-700">
              ...
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">3.</span><span><strong>Sin edicion.</strong> Evita modificaciones al contenido del documento. Esencial para contratos finalizados y registros oficiales.</span></li>
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">4.</span><span><strong>Sin extraccion de paginas.</strong> Evita que los usuarios saquen paginas individuales del documento usando herramientas PDF.</span></li>
              <li className="flex items-start gap-3"><span className="text-orange-500 font-bold mt-0.5">5.</span><span><strong>Sin anotaciones.</strong> Evita agregar comentarios, resaltados o notas adhesivas. Usa esto cuando quieras que el documento permanezca limpio y sin modificaciones.</span></li>
            </ul>
          </section>
