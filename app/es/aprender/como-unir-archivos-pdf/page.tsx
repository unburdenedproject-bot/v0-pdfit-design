...
export const metadata = {
  title: "Cómo Unir Archivos PDF en Línea (Combinar PDFs en Uno) | OmnisPDF",
  description:
...
const faqSchema = {
  ...
  "mainEntity": [
    { "@type": "Question", "name": "¿Cómo uno archivos PDF en línea gratis?", "acceptedAnswer": { "@type": "Answer", "text": "Sube tus PDFs a la herramienta Unir PDF de OmnisPDF, ordénalos como desees, haz clic en Unir y descarga el archivo combinado. No se requiere registro para tus primeros 3 archivos." } },
    { "@type": "Question", "name": "¿Puedo unir más de dos PDFs a la vez?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. OmnisPDF te permite subir y unir tantos PDFs como necesites en una sola operación. Los usuarios gratuitos pueden unir archivos uno a la vez, mientras que los usuarios Pro obtienen procesamiento por lotes." } },
    { "@type": "Question", "name": "¿Unir PDFs aumentará el tamaño del archivo?", "acceptedAnswer": { "@type": "Answer", "text": "El archivo unido será aproximadamente la suma de todos los archivos individuales. Si el resultado es muy grande, usa la herramienta Comprimir PDF de OmnisPDF después de unir para reducir el tamaño significativamente." } },
    { "@type": "Question", "name": "¿Puedo reordenar páginas antes de unir?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. OmnisPDF te permite arrastrar y soltar archivos en el orden exacto que deseas antes de unir. También puedes reordenar páginas individuales después de unir usando la herramienta Dividir o Reordenar." } },
    { "@type": "Question", "name": "¿Es seguro unir PDFs en línea?", "acceptedAnswer": { "@type": "Answer", "text": "OmnisPDF procesa los archivos de forma segura y los elimina del servidor después del procesamiento. Tus documentos nunca se almacenan permanentemente ni se comparten con terceros." } },
    { "@type": "Question", "name": "¿Puedo unir PDFs en mi teléfono?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. OmnisPDF funciona en cualquier navegador móvil — Safari, Chrome o Firefox. Sube tus PDFs, únelos y descarga el resultado directamente en tu teléfono. No necesitas instalar ninguna app." } }
  ]
}

const howToSchema = {
  "@context": "https://schema.org", "@type": "HowTo", "name": "Cómo Unir Archivos PDF en Línea",
  "description": "Combina múltiples PDFs en un documento en 3 simples pasos usando OmnisPDF.",
  "step": [
    { "@type": "HowToStep", "name": "Sube tus archivos PDF", "text": "Ve a la herramienta Unir PDF de OmnisPDF y sube todos los archivos que deseas combinar haciendo clic o arrastrándolos al área de carga." },
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>&#10003; <strong>Usa arrastrar y soltar</strong> en OmnisPDF para reordenar archivos visualmente antes de unir.</li>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-600">Los documentos escaneados a veces tienen páginas rotadas incorrectamente. Antes de unir, asegúrate de que todas las páginas estén orientadas correctamente. Puedes corregir páginas rotadas usando la herramienta <Link href="/es/rotar-pdf" className="text-orange-600 hover:underline">Rotar PDF</Link> de OmnisPDF.</p>
                </div>
                <div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                { q: "¿Cómo uno archivos PDF en línea gratis?", a: "Sube tus PDFs a la herramienta Unir PDF de OmnisPDF, ordénalos como desees, haz clic en Unir y descarga el archivo combinado. No se requiere registro para tus primeros 3 archivos." },
                { q: "¿Puedo unir más de dos PDFs a la vez?", a: "Sí. OmnisPDF te permite subir y unir tantos PDFs como necesites en una sola operación. Los usuarios gratuitos pueden unir archivos uno a la vez, mientras que los usuarios Pro obtienen procesamiento por lotes." },
                { q: "¿Unir PDFs aumentará el tamaño del archivo?", a: "El archivo unido será aproximadamente la suma de todos los archivos individuales. Si el resultado es muy grande, usa la herramienta Comprimir PDF de OmnisPDF después de unir para reducir el tamaño significativamente." },
                { q: "¿Puedo reordenar páginas antes de unir?", a: "Sí. OmnisPDF te permite arrastrar y soltar archivos en el orden exacto que deseas antes de unir. También puedes reordenar páginas individuales después de unir usando la herramienta Dividir o Reordenar." },
                { q: "¿Es seguro unir PDFs en línea?", a: "OmnisPDF procesa los archivos de forma segura y los elimina del servidor después del procesamiento. Tus documentos nunca se almacenan permanentemente ni se comparten con terceros." },
                { q: "¿Puedo unir PDFs en mi teléfono?", a: "Sí. OmnisPDF funciona en cualquier navegador móvil — Safari, Chrome o Firefox. Sube tus PDFs, únelos y descarga el resultado directamente en tu teléfono. No necesitas instalar ninguna app." },
              ].map((faq, i) => (
