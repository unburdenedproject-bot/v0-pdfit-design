...
export const metadata = {
  title: "Comprimir PDF a 5MB Online — Compresion Extrema Gratis | PDF.it",
  description: "Aplica compresion extrema a tu PDF para cumplir limites de 5MB. Perfecto para envios, solicitudes y subidas — rapido, desde tu navegador, gratis.",
...
export default function ComprimirPDFA5MBPage() {
  const faqs = [
    { q: "¿Como comprimo un PDF para un limite de 5MB?", a: "Sube tu PDF a PDF.it, haz clic en Comprimir y descarga el archivo reducido. PDF.it usa compresion extrema para reducir drasticamente el tamano del archivo. Los resultados dependen del contenido de tu PDF." },
    { q: "¿Mi PDF quedara definitivamente debajo de 5MB despues de comprimirlo?", a: "La compresion extrema reduce drasticamente el tamano del archivo. La mayoria de los PDFs de menos de 20MB se comprimen significativamente. Los archivos muy pesados en imagenes pueden necesitar dividirse primero y luego comprimir cada parte por separado." },
    { q: "¿El texto seguira siendo legible despues de la compresion?", a: "Si. El texto se mantiene nitido y legible. La calidad de imagen puede reducirse ligeramente, pero las paginas se mantienen utilizables." },
    { q: "¿Por que los portales de subida tienen un limite de 5MB?", a: "Muchos portales gubernamentales, universitarios y de solicitudes de empleo establecen un limite de 5MB para gestionar almacenamiento y ancho de banda. Comprimir tu PDF asegura que cumpla estos requisitos." },
    { q: "¿Puedo comprimir un PDF a 5MB desde mi celular?", a: "Si. PDF.it funciona en navegadores moviles — sube, comprime y descarga en iPhone o Android." },
    { q: "¿Que hago si mi PDF sigue pesando mas de 5MB despues de comprimirlo?", a: "Si el archivo sigue siendo demasiado grande, intenta dividirlo en partes mas pequenas usando la herramienta Dividir PDF de PDF.it y luego comprime cada parte individualmente." },
  ]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Aplica compresion extrema para reducir drasticamente el tamano de tu PDF en portales con limites de 5MB. Desde tu navegador, resultados al instante.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">¿Necesitas subir un PDF pero el portal dice &quot;archivo demasiado grande&quot;? PDF.it aplica compresion extrema para reducir drasticamente el tamano de tu PDF — perfecto para formularios gubernamentales, envios universitarios, solicitudes de empleo y cualquier sitio con un limite de 5MB.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">✓ Compresion extrema para maxima reduccion de tamano</li>
            <li className="flex items-center gap-2">✓ Perfecto para portales de subida con limites de tamano</li>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "Cumple Limites de Portales de Subida", desc: "Los portales gubernamentales, solicitudes universitarias y sitios de empleo frecuentemente limitan las subidas a 5MB. PDF.it aplica compresion extrema para reducir drasticamente el tamano de tu archivo y ayudarte a cumplir estos requisitos." },
            { title: "Comprime Documentos y Formularios Escaneados", desc: "Los PDFs escaneados frecuentemente pesan 10-30MB. El modo de compresion extrema de PDF.it reduce los datos de imagen agresivamente para llevar el archivo por debajo de 5MB manteniendo el texto legible." },
            { title: "¿Sigue Grande? Divide y Comprime", desc: "Si tu PDF sigue superando los 5MB despues de comprimir, usa la herramienta Dividir PDF de PDF.it para separarlo en partes mas pequenas y luego comprime cada una individualmente." },
          ].map((feature) => (
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Comprimir un PDF para Limites de 5MB</h2>
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[{ name: "Comprimir a 2MB", href: "/es/comprimir-pdf-a-2mb", desc: "Para limites de 2MB" }, { name: "Comprimir a 10MB", href: "/es/comprimir-pdf-a-10mb", desc: "Para limites de 10MB" }, { name: "Comprimir PDF", href: "/es/comprimir-pdf", desc: "Compresion estandar" }, { name: "Dividir PDF", href: "/es/dividir-pdf", desc: "Divide si sigue grande" }].map((tool) => (
