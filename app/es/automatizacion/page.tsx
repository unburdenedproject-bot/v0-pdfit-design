      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: "¿La Automatización de Flujos es gratis?", a: "La Automatización de Flujos es una función del plan Enterprise ($49.99/mes). Incluye flujos ilimitados junto con todas las demás herramientas Enterprise." },
        ...
        <Script id="faq-schema-es" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "¿La Automatización de Flujos es gratis?", "acceptedAnswer": { "@type": "Answer", "text": "La Automatización de Flujos es una función del plan Enterprise ($49.99/mes). Incluye flujos ilimitados junto con todas las demás herramientas Enterprise." } },
