...
export const metadata = {
  ...
  description: "Optimiza PDFs para tu sitio web con compresion inteligente. Reduce el tamano para cargas mas rapidas y mejor experiencia de usuario — mantiene alta calidad mientras reduce las descargas.",
...
export default function ComprimirPDFParaWebPage() {
  const faqs = [{"q":"¿Como optimizo un PDF para mi sitio web?","a":"Sube tu PDF a PDF.it y haz clic en Comprimir. La compresion recomendada equilibra calidad y tamano del archivo."},{"q":"¿Se veran bien al descargarse?","a":"Si. La compresion recomendada reduce el tamano preservando la calidad visual."},{"q":"¿Por que debo comprimir PDFs antes de alojarlos?","a":"Los PDFs grandes ralentizan los tiempos de carga, perjudican el SEO y frustran a los visitantes moviles."},{"q":"¿El tamano del PDF afecta el SEO?","a":"Si. Google considera la velocidad de pagina como factor de posicionamiento. Los PDFs mas pequenos contribuyen a mejores Core Web Vitals."},{"q":"¿Puedo comprimir multiples PDFs a la vez?","a":"Los usuarios Pro pueden comprimir multiples PDFs en lote. Sube todos tus archivos, comprimelos y descarga todo como ZIP."},{"q":"¿Que nivel de compresion debo usar?","a":"La compresion recomendada es ideal para web. Reduce significativamente el tamano manteniendo aspecto profesional."}]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Optimiza tus PDFs para hosting web. La compresion recomendada mantiene alta calidad mientras reduce el tamano para cargas mas rapidas y mejor experiencia para los visitantes.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">Los PDFs alojados en tu sitio web son descargados por visitantes, indexados por motores de busqueda y afectan la velocidad de carga. Los PDFs grandes ralentizan todo — aumentan la tasa de rebote, perjudican el SEO y cuestan mas ancho de banda. Comprimir tus PDFs mantiene las descargas rapidas y a tus visitantes contentos.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">✓ Descargas mas rapidas mejoran la experiencia de usuario</li>
            <li className="flex items-center gap-2">✓ Mejor velocidad de pagina ayuda tu posicionamiento SEO</li>
            <li className="flex items-center gap-2">✓ Archivos mas pequenos ahorran ancho de banda y costos de hosting</li>
            <li className="flex items-center gap-2">✓ Sin instalacion — optimiza PDFs en tu navegador</li>
          </ul>
        </div></section>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
                { title: "Catalogos y Listas de Precios", desc: "Los sitios de e-commerce y fabricantes alojan catalogos como PDFs descargables. Comprimirlos asegura que los clientes puedan descargarlos rapidamente, especialmente en moviles." },
                { title: "Menus y Folletos", desc: "Menus de restaurantes, folletos de marketing y casos de estudio para descarga deben estar optimizados para web. Archivos mas pequenos significan mas descargas completadas." },
                { title: "Whitepapers y Recursos", desc: "Whitepapers, ebooks y guias para marketing de contenido deben cargar rapidamente. Los recursos comprimidos significan que los visitantes tienen mas probabilidad de interactuar con tu contenido." },
          ].map((feature) => (
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
            {[{ num: "1", title: "Sube tu PDF", desc: "Arrastra y suelta o haz clic para elegir un archivo" }, { num: "2", title: "Haz clic en Comprimir", desc: "La compresion recomendada equilibra calidad y tamano" }, { num: "3", title: "Descarga y publica", desc: "Sube el PDF optimizado a tu sitio web" }].map((step) => (
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[{ name: "Comprimir PDF", href: "/es/comprimir-pdf", desc: "Compresion estandar" }, { name: "Comprimir para Email", href: "/es/comprimir-pdf-para-email", desc: "Para limites de email" }, { name: "Dividir PDF", href: "/es/dividir-pdf", desc: "Divide PDFs grandes" }, { name: "Unir PDF", href: "/es/unir-pdf", desc: "Combina multiples PDFs" }].map((tool) => (
