...
const categories = [
  {
    ...
    tools: [
      ...
      { name: "PDF a Word", description: "Convierte PDF a un documento Word editable.", icon: FileText, href: "/pdf-to-word", tier: "PRO" as const },
      { name: "PDF a Excel", description: "Extrae tablas de PDF a una hoja de cálculo.", icon: FileSpreadsheet, href: "/pdf-to-excel", tier: "PRO" as const },
      { name: "PDF a PowerPoint", description: "Convierte páginas PDF en diapositivas.", icon: Presentation, href: "/pdf-to-powerpoint", tier: "PRO" as const },
      { name: "Extraer Imágenes", description: "Extrae fotos, logos y gráficos de un PDF.", icon: ImageDown, href: "/extract-images-from-pdf", tier: "FREE" as const },
    ],
  },
  {
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "Aplanar PDF", description: "Bloquea campos y anotaciones en un PDF plano.", icon: Layers, href: "/flatten-pdf", tier: "FREE" as const },
    ],
  },
  {
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "PDF Listo para Subir", description: "Optimiza PDFs para cualquier portal de carga.", icon: Upload, href: "/upload-ready-pdf", tier: "FREE" as const },
      { name: "Escáner OCR", description: "Extrae texto de PDFs escaneados.", icon: Scan, href: "/ocr-scanner", tier: "PRO" as const },
      { name: "Limpiar Escaneo", description: "Convierte fotos de documentos en PDFs profesionales.", icon: Camera, href: "/phone-scan-cleanup", tier: "FREE" as const },
    ],
  },
  {
    name: "Generar",
    ...
    tools: [
      { name: "Generador de QR", description: "Genera códigos QR desde cualquier URL o texto.", icon: QrCode, href: "/tools/qr-code", tier: "PRO" as const },
    ],
  },
  {
    ...
    tools: [
      { name: "Automatización", description: "Encadena varias herramientas PDF en un flujo automático.", icon: Repeat, href: "/workflow-automation", tier: "BUSINESS" as const },
      { name: "Extracción de Tablas", description: "Extrae tablas de PDFs directamente a Excel.", icon: FileSpreadsheet, href: "/table-extraction", tier: "BUSINESS" as const },
      { name: "Comparar PDF", description: "Compara dos PDFs lado a lado y resalta diferencias.", icon: ArrowLeftRight, href: "/pdf-compare", tier: "BUSINESS" as const },
      { name: "Firma Electrónica", description: "Agrega firmas electrónicas legales a PDFs.", icon: PenTool, href: "/esign", tier: "BUSINESS" as const },
      { name: "Redacción PDF", description: "Elimina permanentemente texto sensible de PDFs.", icon: Shield, href: "/pdf-redaction", tier: "BUSINESS" as const },
    ],
  },
]
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
              {[
                ...
                { icon: Globe, label: "Límite Gratis", value: "25MB", description: "200MB con Pro" },
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-slate-600 max-w-2xl mx-auto leading-relaxed">
                  Todo lo que necesitas saber sobre OmnisPDF. ¿No encuentras lo que buscas?{" "}
              ...
              <div className="space-y-4">
                {[
                  { q: "¿OmnisPDF es gratis?", a: "Sí. OmnisPDF ofrece un plan gratuito con 10 conversiones al día y archivos hasta 25MB. No necesitas cuenta para las herramientas gratuitas. Actualiza a Pro ($7.99/mes) para conversiones ilimitadas, todas las herramientas y archivos hasta 200MB." },
                  ...
                  { q: "¿Qué formatos de archivo soportan?", a: "OmnisPDF soporta PDF, JPG, PNG, TXT y formatos de Office (Word, Excel, PowerPoint). Las herramientas incluyen convertir, comprimir, unir, dividir, rotar, proteger, desbloquear, marca de agua y OCR." },
                  { q: "¿Cuál es el tamaño máximo de archivo?", a: "Las cuentas gratuitas pueden subir archivos hasta 25MB. Las cuentas Pro y Business pueden subir hasta 200MB." },
                  ...
                  { q: "¿Funciona en celular?", a: "Sí. OmnisPDF funciona en navegadores modernos incluyendo Chrome, Firefox, Safari y Edge en computadora, tablet y celular." },
                  { q: "¿Cómo puedo obtener ayuda?", a: "Visita nuestra página de Contacto o escríbenos a contact@omnispdf.com. Respondemos en menos de un día hábil." },
                ].map((faq, i) => (
              ...
              <div className="mt-8 text-center">
                <div className="bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-200 rounded-2xl p-6">
                  ...
                  <p className="text-slate-700 text-xs mb-4 max-w-xl mx-auto leading-relaxed">
                    Nuestro equipo de soporte está aquí para ayudarte a aprovechar OmnisPDF al máximo.
                  </p>
