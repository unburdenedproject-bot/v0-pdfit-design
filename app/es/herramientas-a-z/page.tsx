...
export const metadata: Metadata = {
  ...
  description:
    "Explora todas las herramientas de PDF.it en orden alfabetico. Convierte, comprime, une, divide, protege y más.",
  alternates: {
...
const tools = [
  { name: "Analizador ATS de Currículum", description: "Análisis de currículum con IA y puntuacion de compatibilidad ATS.", icon: Target, href: "/es/optimizador-ats", tier: "PRO" },
  { name: "Automatización de Flujos", description: "Encadena múltiples herramientas PDF en un flujo automatizado.", icon: Repeat, href: "/es/automatización", tier: "BUSINESS" },
  { name: "Código QR", description: "Genera códigos QR desde cualquier URL o texto al instante.", icon: QrCode, href: "/es/codigo-qr", tier: "PRO" },
  ...
  { name: "Comprimir PDF", description: "Reduce el tamaño del archivo con compresión Ligera, Media o Extrema.", icon: Compress, href: "/es/comprimir-pdf", tier: "FREE" },
  { name: "Comprimir PDF para Email", description: "Reduce PDFs para cumplir los límites de Gmail, Outlook y Yahoo.", icon: Mail, href: "/es/comprimir-pdf-para-email", tier: "FREE" },
  { name: "Convertir Excel a PDF", description: "Convierte hojas de cálculo en PDFs compartibles.", icon: FileSpreadsheet, href: "/es/excel-a-pdf", tier: "PRO" },
  { name: "Convertir JPG a PDF", description: "Convierte imágenes JPG a documentos PDF.", icon: Image, href: "/es/jpg-a-pdf", tier: "FREE" },
  { name: "Convertir PDF a Excel", description: "Extrae tablas de PDF a una hoja de cálculo Excel.", icon: FileSpreadsheet, href: "/es/pdf-a-excel", tier: "PRO" },
  { name: "Convertir PDF a JPG", description: "Convierte páginas PDF a imágenes JPG de alta calidad.", icon: Image, href: "/es/pdf-a-jpg", tier: "FREE" },
  { name: "Convertir PDF a PNG", description: "Convierte páginas PDF a imágenes PNG.", icon: Image, href: "/es/pdf-a-png", tier: "FREE" },
  { name: "Convertir PDF a PowerPoint", description: "Convierte páginas PDF en diapositivas de PowerPoint.", icon: Presentation, href: "/es/pdf-a-powerpoint", tier: "PRO" },
  ...
  { name: "Convertir PNG a PDF", description: "Convierte imágenes PNG a documentos PDF.", icon: Image, href: "/es/png-a-pdf", tier: "FREE" },
  ...
  { name: "Desbloquear PDF", description: "Elimina las restricciones de contraseña de un PDF.", icon: Unlock, href: "/es/desbloquear-pdf", tier: "FREE" },
  ...
  { name: "Extracción de Tablas", description: "Extrae tablas de PDFs directamente a hojas de cálculo Excel.", icon: FileSpreadsheet, href: "/es/extraccion-de-tablas", tier: "BUSINESS" },
  { name: "Extracción de Alto Volumen", description: "Extrae hasta 2,000 páginas de tablas al mes a Excel.", icon: FileSpreadsheet, href: "/es/extraccion-de-tablas", tier: "ENTERPRISE" },
  { name: "Extraer Imágenes", description: "Extrae fotos, logos y gráficos de PDFs.", icon: ImageDown, href: "/es/extraer-imágenes-de-pdf", tier: "FREE" },
  { name: "Firma Electrónica", description: "Agrega firmas electrónicas legalmente vinculantes a PDFs.", icon: PenTool, href: "/es/firma-electrónica", tier: "BUSINESS" },
  ...
  { name: "Proteger PDF", description: "Agrega protección con contraseña a tu PDF.", icon: Lock, href: "/es/proteger-pdf", tier: "FREE" },
  { name: "Redacción PDF", description: "Elimina permanentemente texto y datos sensibles de PDFs.", icon: Shield, href: "/es/redaccion-pdf", tier: "BUSINESS" },
  { name: "Rotar PDF", description: "Corrige la orientación de las páginas al instante.", icon: RotateCw, href: "/es/rotar-pdf", tier: "FREE" },
  { name: "Unir PDF", description: "Combina múltiples PDFs en un solo archivo.", icon: Merge, href: "/es/unir-pdf", tier: "FREE" },
  { name: "URL a PDF", description: "Convierte cualquier página web pública en un documento PDF.", icon: Globe, href: "/es/url-a-pdf", tier: "PRO" },
  { name: "Plantillas de Flujos", description: "Flujos predefinidos para documentos legales, contables y de laboratorio.", icon: Layers, href: "/es/automatización", tier: "ENTERPRISE" },
]
        ...
        <section className="py-16 relative overflow-hidden">
          ...
          >
            ...
            >
              ...
              <p className="text-slate-400 mb-8">Elige cualquier herramienta o comienza con las más populares.</p>
