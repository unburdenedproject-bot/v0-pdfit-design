...
export const metadata: Metadata = {
  ...
  description: "Aprende como convertir un PDF a formato Google Docs. Convierte PDF a Word con PDF.it, sube a Google Drive y abre en Google Docs para editar y colaborar fácilmente.",
  alternates: {
  ...
  const faqs = [
    {
        ...
        "a": "Google Drive puede abrir PDFs, pero el formato a menudo se rompe. Para mejores resultados, convierte el PDF a DOCX primero usando PDF.it, luego sube el DOCX a Google Drive y abrelo con Google Docs. Esto preserva formato, tablas e imágenes mucho mejor."
    },
    {
        "q": "Por qué debería convertir a DOCX antes de subir a Google Docs?",
        "a": "Google Docs maneja archivos DOCX mucho mejor que PDFs. Cuando abres un PDF directamente, a menudo pierde diseño, fuentes y estructura de tablas. Convertir a DOCX primero preserva el formato."
    },
    {
        "q": "Este método es gratis?",
        "a": "La conversión de PDF a Word en PDF.it está disponible para suscriptores Pro y Business. Una vez que tengas el archivo DOCX, subirlo a Google Drive y abrirlo en Google Docs es completamente gratis."
    },
    {
        "q": "Se preservara el formato en Google Docs?",
        "a": "Convertir PDF a DOCX con PDF.it preserva la mayoría del formato incluyendo fuentes, tablas, imágenes y diseño. Google Docs puede hacer ajustes menores al abrir el DOCX, pero el resultado es mucho mejor que abrir el PDF directamente."
    },
    {
        "q": "Puedo colaborar en el documento después de convertir?",
        "a": "Si. Una vez que el DOCX se abre en Google Docs, puedes compartirlo, usar colaboracion en tiempo real, agregar comentarios, sugerir ediciónes y rastrear cambios."
    },
    {
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-300 mb-8">Abre cualquier PDF en Google Docs con formato perfecto. Convierte a Word primero con PDF.it, luego sube a Google Drive para editar y colaborar fácilmente.</p>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { title: "Edición Colaborativa", desc: "Necesitas que varias personas editen un PDF? Convierte a formato Google Docs para que todo tu equipo pueda hacer cambios simultaneamente con colaboracion en tiempo real y comentarios." },
              { title: "Funciona en Chromebooks", desc: "Los Chromebooks ejecutan Google Docs nativamente pero no pueden instalar Word. Convierte tu PDF a DOCX con PDF.it, luego abre en Google Docs para edición completa en ChromeOS." },
