...
export const metadata: Metadata = {
  ...
  description: "Convierte PDF a XLSX en línea con PDF.it. Extrae tablas, datos financieros e informes de PDF a hojas de cálculo Excel editables. Rápido, preciso, sin instalación.",
  alternates: {
  ...
  const faqs = [
    {
        ...
        "a": "XLSX es el formato moderno de Excel introducido con Microsoft Office 2007. Soporta hojas más grandes, mejor compresión y mayor compatibilidad comparado con el viejo formato XLS. PDF.it convierte PDFs directamente a XLSX."
    },
    {
    ...
    {
        "q": "Mis tablas PDF se convertiran con precisión?",
        "a": "PDF.it detecta estructuras de tablas y las mapea a filas y columnas de Excel. Las tablas simples y bien estructuradas se convierten con alta precisión. Diseños complejos con celdas combinadas pueden requerir ajustes menores."
    },
    {
        "q": "Puedo convertir un PDF escaneado a XLSX?",
        "a": "Los PDFs escaneados contienen imágenes en lugar de datos estructurados. Para mejores resultados, usa primero el Escáner OCR de PDF.it para extraer texto, luego convierte el resultado."
    },
    {
        "q": "El convertidor de PDF a XLSX es gratis?",
        "a": "La conversión de PDF a XLSX está disponible para suscriptores Pro y Business. Las cuentas gratuitas pueden usar herramientas básicas de PDF, mientras que Pro desbloquea conversiónes avanzadas."
    },
    {
        "q": "Puedo convertir múltiples PDFs a XLSX a la vez?",
        "a": "Si. Las cuentas Pro y Business soportan procesamiento por lotes — sube múltiples PDFs y conviertelos todos a XLSX en una sola sesión."
    }
]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-300 mb-8">Extrae tablas y datos de cualquier PDF a una hoja de cálculo Excel XLSX editable. Detección precisa de columnas, descarga instantanea.</p>
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                ...
                <div className="flex items-center gap-2"><Download className="h-4 w-4 text-[#14D8C4]" /><span>Extracción Precisa</span></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">XLSX es el formato moderno de hojas de cálculo Excel usado por Microsoft Excel, Google Sheets y LibreOffice Calc. Cuando recibes informes financieros, facturas o tablas de datos como PDFs, convertirlos a XLSX te permite ordenar, filtrar, calcular y analizar los datos — en lugar de escribir todo manualmente.</p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Extrae tablas de PDF a formato XLSX editable</li>
              <li className="flex items-center gap-2">✓ Detección inteligente de columnas, filas y encabezados</li>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { title: "Extrae Datos Financieros", desc: "Estados de cuenta, informes trimestrales y resumenes financieros llegan como PDFs. Convierte a XLSX para ejecutar formulas, crear gráficos y analizar tendencias en Excel o Google Sheets." },
              { title: "Convierte Facturas a Hojas de Cálculo", desc: "Recibes facturas en formato PDF? Convierte a XLSX para extraer líneas de detalle, calcular totales e importar datos a tu software contable o sistema ERP." },
              { title: "Analiza Informes y Tablas de Datos", desc: "Datos de investigación, catalogos de productos y tablas de precios atrapados en PDFs se vuelven útiles al estar en Excel. Ordena, filtra, crea tablas dinamicas y gráficos sin entrada manual." },
