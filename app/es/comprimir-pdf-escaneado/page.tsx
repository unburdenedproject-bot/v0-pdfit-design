...
export const metadata = {
  title: "Comprimir PDF Escaneado — Reducir Tamaño de Escaneos | PDF.it",
  description: "Comprime PDFs escaneados con compresión extrema para reducir dramaticamente el tamaño. Perfecto para contratos, documentos archivados, recibos y escaneos de ID — rápido, desde tu navegador, gratis.",
...
export default function ComprimirPDFEscaneadoPage() {
  const faqs = [{"q":"¿Por qué los PDFs escaneados son tan grandes?","a":"Los PDFs escaneados contienen imágenes de página completa en lugar de texto. Cada página es esencialmente una fotografia de alta resolución, por eso tipicamente pesan 10-50MB o más."},{"q":"¿La compresión hara mi documento escaneado ilegible?","a":"El texto en documentos escaneados permanece legible después de la compresión. La compresión extrema reduce la resolución de imagen, pero el texto impreso sigue siendo legible."},{"q":"¿Puedo comprimir un PDF escaneado de múltiples páginas?","a":"Si. PDF.it comprime todas las páginas a la vez. Los escaneos de múltiples páginas frecuentemente ven las mayores reducciones de tamaño."},{"q":"¿Cuanto se puede comprimir un PDF escaneado?","a":"Los resultados varian segun la resolución del escaneo y el número de páginas. Reducciones del 50-80% son comunes."},{"q":"¿Comprimir afecta el texto OCR?","a":"Si tu PDF escaneado ya tiene una capa de texto OCR, la compresión la preserva. La capa de texto es separada de la capa de imagen."},{"q":"¿Que hago si sigue siendo muy grande?","a":"Divide el PDF en secciones más pequeñas con Dividir PDF y luego comprime cada parte individualmente."}]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Los PDFs escaneados contienen imágenes incrustadas grandes que inflan el tamaño del archivo a 10-50MB o más. Aplica compresión extrema para reducir dramaticamente el tamaño — perfecto para subir, enviar por email o archivar.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">A diferencia de los PDFs nativos que almacenan texto como datos vectoriales, los PDFs escaneados almacenan cada página como una imagen de alta resolución. Un documento escaneado de 10 páginas puede fácilmente alcanzar 30-50MB. PDF.it aplica compresión extrema que apunta a estas imágenes incrustadas, reduciendo dramaticamente el tamaño manteniendo el texto legible.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">&#10003; La compresión extrema apunta a imágenes incrustadas grandes</li>
            ...
            <li className="flex items-center gap-2">&#10003; Sin instalación — comprime PDFs escaneados en tu navegador</li>
          </ul>
        </div></section>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
                { title: "Contratos y Acuerdos Escaneados", desc: "Los contratos firmados escaneados en alta resolución pueden ser enormes. Comprimelos a un tamaño manejable para adjuntos de email, almacenamiento en la nube o subida a sistemas de gestion documental." },
                ...
                { title: "Recibos, Facturas y Escaneos de ID", desc: "Los informes de gastos y documentos de identificación frecuentemente se requieren para solicitudes con límites estrictos. Comprime recibos e IDs escaneadas para cumplir requisitos de subida fácilmente." },
          ].map((feature) => (
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
            {[{ num: "1", title: "Sube tu PDF escaneado", desc: "Arrastra y suelta o haz clic para elegir un archivo" }, { num: "2", title: "Haz clic en Comprimir PDF", desc: "La compresión extrema apunta a las imágenes incrustadas" }, { num: "3", title: "Descarga tu PDF", desc: "Obtiene tu archivo comprimido al instante" }].map((step) => (
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[{ name: "Comprimir PDF", href: "/es/comprimir-pdf", desc: "Compresión estándar" }, { name: "Escáner OCR", href: "/es/escaner-ocr", desc: "Haz escaneos buscables" }, { name: "Dividir PDF", href: "/es/dividir-pdf", desc: "Divide si sigue grande" }, { name: "Unir PDF", href: "/es/unir-pdf", desc: "Combina después de comprimir" }].map((tool) => (
