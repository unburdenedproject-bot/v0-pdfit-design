...
export const metadata: Metadata = {
  title: "Reordenar Paginas PDF en Linea — Reorganiza Paginas en un PDF | PDF.it",
  description: "Reorganiza paginas en un PDF con PDF.it. Usa Dividir y Unir para reordenar paginas en cualquier secuencia, rapido, gratis y desde tu navegador.",
  alternates: {
  ...
  const faqs = [
    {
        ...
        "a": "Usa la herramienta Dividir PDF de PDF.it para extraer paginas individuales o grupos, luego usa Unir PDF para recombinarlas en el orden que desees."
    },
    {
        "q": "Puedo mover una pagina especifica a otra posicion?",
        "a": "Si. Divide tu PDF para extraer la pagina que quieres mover, luego une todas las paginas en el nuevo orden."
    },
    {
        "q": "Puedo reorganizar paginas PDF en mi celular?",
        "a": "Si. PDF.it funciona en navegadores moviles — divide y une tus PDFs en iPhone o Android para reorganizar paginas en cualquier orden."
    },
    {
        "q": "Necesito instalar software para reordenar paginas PDF?",
    ...
    {
        "q": "Puedo invertir el orden de paginas de un PDF?",
        "a": "Si. Divide tu PDF en paginas individuales, luego subelas a Unir PDF en orden inverso."
    }
]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-black mb-4">Reordenar Paginas PDF</h1>
            <p className="text-xl text-slate-300 mb-8">Reorganiza paginas en cualquier PDF dividiendo y uniendo. Extrae las paginas que necesitas, ponlas en el orden correcto y descarga un documento limpio y reorganizado.</p>
            <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
              <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Cualquier Orden de Paginas</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">Reordenar paginas PDF es facil con PDF.it. Primero, usa la herramienta Dividir PDF para extraer paginas individuales o rangos de tu documento. Luego, sube las paginas extraidas a la herramienta Unir PDF en el orden deseado. PDF.it las combina en un solo PDF reorganizado — listo para descargar, imprimir o compartir.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">✓ Reorganiza paginas en cualquier orden que necesites</li>
            <li className="flex items-center gap-2">✓ Mueve, intercambia o invierte secuencias de paginas</li>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "Corrige Orden Incorrecto de Paginas", desc: "Documentos escaneados, informes exportados y archivos combinados a veces terminan con paginas desordenadas. Usa Dividir y Unir para corregir la secuencia rapidamente." },
            { title: "Reorganiza Presentaciones y Propuestas", desc: "Necesitas mover una seccion al inicio o reorganizar capitulos? Divide tu PDF en secciones y luego unelas en el nuevo orden." },
            { title: "Organiza Documentos Escaneados", desc: "Las paginas escaneadas a menudo llegan en orden incorrecto. Extrae cada pagina con Dividir PDF y recombinalas en la secuencia correcta con Unir PDF." },
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl"><h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Reordenar Paginas PDF</h2><div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
          {[{ num: "1", title: "Divide tu PDF", desc: "Extrae paginas individuales o grupos" },{ num: "2", title: "Une en nuevo orden", desc: "Sube las paginas en la secuencia deseada" },{ num: "3", title: "Descarga tu PDF", desc: "Obtiene tu documento reordenado al instante" }].map((step) => (<div key={step.num} className="flex-1"><div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3" style={{ background: "linear-gradient(135deg, #1a1f5e, #252A6A)", boxShadow: "0 0 20px rgba(20, 216, 196, 0.3), 0 4px 8px rgba(232,129,58,0.1)", border: "1px solid rgba(20,216,196,0.25)" }}><span className="text-[#14D8C4] font-black text-lg">{step.num}</span></div><p className="font-semibold text-slate-900">{step.title}</p><p className="text-sm text-slate-500 mt-1">{step.desc}</p></div>))}
        </div></div></section>
