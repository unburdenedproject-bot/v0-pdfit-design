...
export const metadata: Metadata = {
  ...
  description: "Exporta tablas de PDFs como archivos CSV con PDF.it. Extrae datos estructurados para usar en Excel, Google Sheets, bases de datos y herramientas de analisis.",
  alternates: {
  ...
  const faqs = [
    {
        ...
        "a": "CSV es un formato de texto plano con valores separados por comas — funciona en todas partes, incluyendo bases de datos, scripts y pipelines de datos. Excel (.xlsx) preserva formato, formulas y multiples hojas. Usa CSV cuando necesites maxima compatibilidad."
    },
    {
        "q": "Como obtengo un CSV de una tabla PDF?",
        "a": "Sube tu PDF a la herramienta PDF a Excel de PDF.it para extraer los datos, luego abre el archivo Excel y guardalo como CSV. O usa la herramienta de Extraccion de Tablas del plan Business."
    },
    {
    ...
    },
    {
        ...
        "a": "Si. PDF.it maneja tablas de cualquier tamano. Los usuarios Pro pueden procesar archivos de hasta 200MB, y los usuarios Business obtienen procesamiento prioritario."
    },
    {
        "q": "Puedo usar archivos CSV para importaciones de bases de datos?",
        "a": "Absolutamente. CSV es el formato mas ampliamente soportado para importaciones de bases de datos. Extrae tus tablas PDF, guarda como CSV e importa directamente."
    },
    {
        "q": "Puedo elegir un delimitador diferente en lugar de comas?",
        "a": "La exportacion estandar usa comas como delimitadores. Si necesitas punto y coma, tabulaciones u otros delimitadores, exporta a Excel primero, luego usa Excel o Google Sheets para guardar como CSV con tu configuracion preferida."
    }
]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Exporta tablas de archivos PDF como CSV para usar en Excel, Google Sheets, bases de datos y herramientas de analisis. El formato mas portable para tus datos extraidos.</p>
            <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
              ...
              <div className="flex items-center gap-2"><Download className="h-4 w-4 text-[#14D8C4]" /><span>Exportacion de Datos Limpia</span></div>
            </div>
          </div></div>
        </section>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "CSV para Analisis de Datos", desc: "Analistas y cientificos de datos trabajan con CSV todos los dias. Extrae tablas de informes PDF y cargalas directamente en Python, R o tu herramienta de analisis favorita." },
            { title: "Importar a Bases de Datos", desc: "Necesitas llevar datos de tablas PDF a MySQL, PostgreSQL o MongoDB? CSV es el formato estandar de importacion para practicamente cualquier base de datos." },
            { title: "Automatizacion y Scripting", desc: "Automatiza tu pipeline de datos convirtiendo tablas PDF a CSV. Alimenta la salida en hojas de calculo, sistemas CRM, procesos ETL o cualquier herramienta que acepte texto estructurado." },
