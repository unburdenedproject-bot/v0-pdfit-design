...
export const metadata = {
  title: "Comprimir PDF para WhatsApp — Comparte PDFs Fácilmente | PDF.it",
  description: "Comprime tu PDF para compartirlo rápido por WhatsApp. Reduce el tamaño para que los documentos se envien y descarguen rápido en móvil — gratis, desde tu navegador, sin registro.",
...
export default function ComprimirPDFParaWhatsAppPage() {
  const faqs = [{"q":"¿Como comprimo un PDF para WhatsApp?","a":"Sube tu PDF a PDF.it y haz clic en Comprimir. La compresión extrema reduce la resolución de imágenes y optimiza la estructura del archivo."},{"q":"¿Cual es el límite de tamaño de WhatsApp?","a":"WhatsApp permite adjuntos de hasta 100MB. Sin embargo, los PDFs grandes son lentos en redes móviles."},{"q":"¿El PDF seguira siendo legible?","a":"Si. El texto se mantiene nitido. Las imágenes pueden perder algo de detalle con la compresión extrema."},{"q":"¿Puedo comprimir desde mi celular?","a":"Si. PDF.it funciona en cualquier navegador móvil. Comprime y comparte directamente a WhatsApp."},{"q":"¿Por qué mi PDF es demasiado grande?","a":"Los PDFs con imágenes escaneadas, gráficos de alta resolución o fuentes incrustadas pueden ser muy grandes."},{"q":"¿Que hago si sigue siendo muy grande?","a":"Divide el PDF en partes con Dividir PDF y luego comprime cada parte individualmente."}]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Reduce el tamaño de tu PDF para que se envie y descargue rápidamente en WhatsApp. La compresión extrema hace que compartir documentos por móvil sea rápido y sin esfuerzo.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">WhatsApp permite adjuntos de hasta 100MB, pero los PDFs grandes son lentos de enviar y descargar — especialmente con datos móviles. Comprimir tu PDF antes de compartirlo asegura entrega rápida, ahorra datos y fácilita abrir el archivo en cualquier dispositivo.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">✓ Compresión extrema para compartir rápido en móvil</li>
            ...
            <li className="flex items-center gap-2">✓ Sin instalación de app — comprime en tu navegador</li>
          </ul>
        </div></section>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
                ...
                { title: "Recibos y Facturas", desc: "Envia rápidamente recibos de compra, confirmaciones de pago y facturas por WhatsApp. La compresión mantiene los archivos pequeños para que se envien en segundos." },
                { title: "Material Escolar y de Estudio", desc: "Estudiantes y profesores comparten tareas, apuntes y materiales por grupos de WhatsApp. Los PDFs comprimidos se descargan rápidamente sin consumir datos móviles." },
          ].map((feature) => (
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
            {[{ num: "1", title: "Sube tu PDF", desc: "Arrastra y suelta o haz clic para elegir un archivo" }, { num: "2", title: "Haz clic en Comprimir", desc: "La compresión extrema se aplica automáticamente" }, { num: "3", title: "Descarga y comparte", desc: "Envia el PDF más pequeño por WhatsApp al instante" }].map((step) => (
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[{ name: "Comprimir PDF", href: "/es/comprimir-pdf", desc: "Compresión estándar" }, { name: "Comprimir para Email", href: "/es/comprimir-pdf-para-email", desc: "Para límites de email" }, { name: "Comprimir a 1MB", href: "/es/comprimir-pdf-a-1mb", desc: "Para límites de 1MB" }, { name: "Dividir PDF", href: "/es/dividir-pdf", desc: "Divide si sigue grande" }].map((tool) => (
