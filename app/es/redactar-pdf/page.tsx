...
export const metadata: Metadata = {
  title: "Redactar PDF en Linea — Elimina Informacion Sensible Permanentemente | PDF.it",
  description: "Redacta texto y datos sensibles de PDFs con PDF.it. Oculta permanentemente informacion confidencial antes de compartir — seguro, rapido y desde tu navegador.",
  alternates: {
...
export default function RedactarPDFPage() {
  const faqs = [
    { q: "Que significa redactar un PDF?", a: "Redactar un PDF significa eliminar permanentemente informacion sensible — como nombres, numeros de seguro social, datos financieros o texto confidencial — marcandola en negro para que no pueda recuperarse ni copiarse." },
    { q: "La redaccion de PDF es verdaderamente permanente?", a: "Si. A diferencia de colocar un rectangulo negro sobre texto, la verdadera redaccion elimina permanentemente los datos subyacentes del archivo. El contenido redactado no puede recuperarse, copiarse ni buscarse." },
    { q: "Cual es la diferencia entre redaccion y ocultar texto?", a: "Ocultar texto con un cuadro negro es puramente visual — el texto sigue en el archivo y puede copiarse o extraerse. La redaccion elimina permanentemente los datos del PDF, haciendo imposible su recuperacion." },
    { q: "La redaccion de PDF es necesaria para cumplimiento HIPAA y GDPR?", a: "Si. HIPAA requiere que la informacion de salud protegida sea eliminada permanentemente antes de compartir documentos. GDPR requiere que los datos personales sean anonimizados adecuadamente. La redaccion de PDF es el metodo estandar." },
    { q: "PDF.it ofrece redaccion de PDF?", a: "Si. La Redaccion de PDF esta disponible en el plan Business de PDF.it ($13.99/mes). Elimina permanentemente texto sensible, imagenes y metadatos de tus documentos directamente en tu navegador." },
    { q: "Que tipos de contenido se pueden redactar de un PDF?", a: "Puedes redactar texto (nombres, direcciones, numeros de cuenta), imagenes (fotos, firmas, logos) y metadatos (nombre del autor, fecha de creacion, info del software). La herramienta de redaccion de PDF.it maneja los tres tipos." },
  ]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-black mb-4">Redactar PDF en Linea</h1>
            <p className="text-xl text-slate-300 mb-8">Elimina permanentemente informacion sensible de PDFs antes de compartir. La verdadera redaccion elimina datos — no solo los oculta.</p>
            <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
              <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Eliminacion Permanente</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">La redaccion de PDF es el proceso de eliminar permanentemente informacion sensible, confidencial o privada de un documento. A diferencia de cubrir texto con un cuadro negro, la verdadera redaccion elimina los datos subyacentes para que nunca puedan ser recuperados, copiados o buscados. Requerido para cumplimiento de HIPAA, GDPR y legal.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">✓ Elimina permanentemente texto, imagenes y metadatos</li>
        ...
        <section className="py-12 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl text-center">
          ...
          <p className="text-slate-600 mb-6">La Redaccion de PDF esta disponible en nuestro plan Business. Elimina permanentemente texto, imagenes y metadatos sensibles de tus documentos.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/es/redaccion-pdf" className="inline-flex items-center justify-center gap-2 bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-3 px-8 rounded-xl transition-colors">Probar Redaccion PDF</Link>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "Cumplimiento Legal y Regulatorio", desc: "Tribunales, agencias gubernamentales y organizaciones de salud requieren eliminacion permanente de datos antes de compartir documentos. La redaccion de PDF cumple con HIPAA, GDPR, FOIA y reglas judiciales." },
            { title: "Requisitos HIPAA y GDPR", desc: "HIPAA exige eliminacion permanente de informacion de salud protegida. GDPR requiere anonimizacion adecuada. Simplemente cubrir texto con un cuadro negro no cumple estos estandares." },
            { title: "Redaccion Permanente vs Visual", desc: "La redaccion visual (rectangulos negros) deja el texto en el archivo. La verdadera redaccion elimina permanentemente los datos. PDF.it usa redaccion verdadera para asegurar que la informacion sensible desaparezca completamente." },
