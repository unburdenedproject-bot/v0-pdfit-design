...
export const metadata = {
  title: "Comprimir PDF para Subir a Portales — Reduce Tamaño de PDF | PDF.it",
  description: "Comprime tu PDF para cumplir límites de portales de subida. Compresión extrema para formularios gubernamentales, admisiones universitarias, solicitudes de empleo y reclamos de seguros — gratis y desde tu navegador.",
...
export default function ComprimirPDFParaSubirPage() {
  const faqs = [{"q":"¿Como comprimo un PDF para un portal?","a":"Sube tu PDF a PDF.it y haz clic en Comprimir. La compresión extrema reduce la resolución de imágenes y optimiza la estructura del archivo."},{"q":"¿Sera aceptado por portales gubernamentales?","a":"Si. PDF.it produce archivos PDF estándar aceptados por todos los portales principales."},{"q":"¿Puedo comprimir a un tamaño específico?","a":"La compresión extrema reduce drasticamente el tamaño, pero el resultado exacto depende del contenido de tu PDF."},{"q":"¿Se afectara la calidad?","a":"El texto se mantiene nitido y legible. Las imágenes pueden perder algo de detalle con la compresión extrema."},{"q":"¿Puedo comprimir desde mi celular?","a":"Si. PDF.it funciona en cualquier navegador móvil — sin necesidad de instalar una app."},{"q":"¿Que hago si sigue siendo muy grande?","a":"Divide el PDF en secciones con Dividir PDF y luego comprime cada parte por separado."}]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Muchos portales de subida tienen límites estrictos. Aplica compresión extrema para reducir drasticamente el tamaño de tu PDF para formularios gubernamentales, admisiones universitarias, bolsas de trabajo y más.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">Los sitios gubernamentales, sistemas de admision universitaria, portales de empleo y formularios de reclamos de seguros frecuentemente imponen límites estrictos — a veces tan bajos como 1MB o 2MB. Si tu PDF excede el límite, la subida falla. PDF.it aplica compresión extrema para reducir drasticamente el tamaño de tu archivo.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">✓ Compresión extrema para máxima reducción de tamaño</li>
            <li className="flex items-center gap-2">✓ Produce PDFs estándar aceptados por todos los portales</li>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
                { title: "Solicitudes de Empleo y Admisiones", desc: "Bolsas de trabajo, sistemas de seguimiento de candidatos y portales universitarios limitan las subidas a pocos megabytes. Comprime tu currículum, transcripciones y cartas para subirlos sin errores." },
                { title: "Tramites Gubernamentales y de Seguros", desc: "Declaraciones de impuestos, solicitudes de permisos, formularios de visa y reclamos de seguros tienen límites estrictos. Comprime tus PDFs para cumplir requisitos y evitar errores." },
                { title: "Salida PDF Estándar", desc: "PDF.it produce archivos PDF estándar aceptados por todos los portales principales. El texto permanece nitido y la estructura se mantiene válida para cualquier sistema." },
          ].map((feature) => (
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
            {[{ num: "1", title: "Sube tu PDF", desc: "Arrastra y suelta o haz clic para elegir un archivo" }, { num: "2", title: "Haz clic en Comprimir", desc: "La compresión extrema se aplica automáticamente" }, { num: "3", title: "Descarga y sube", desc: "Obtiene tu archivo más pequeño y envialo al portal" }].map((step) => (
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[{ name: "Comprimir PDF", href: "/es/comprimir-pdf", desc: "Compresión estándar" }, { name: "Comprimir a 1MB", href: "/es/comprimir-pdf-a-1mb", desc: "Para límites de 1MB" }, { name: "Comprimir a 2MB", href: "/es/comprimir-pdf-a-2mb", desc: "Para límites de 2MB" }, { name: "Dividir PDF", href: "/es/dividir-pdf", desc: "Divide si sigue grande" }].map((tool) => (
