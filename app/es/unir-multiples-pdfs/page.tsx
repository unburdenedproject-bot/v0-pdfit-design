...
export const metadata: Metadata = {
  title: "Unir Multiples PDFs en Un Solo Archivo — Herramienta Gratis en Linea | PDF.it",
  description: "Une multiples archivos PDF en un solo documento con PDF.it. Combina 2, 5 o 10+ PDFs en un archivo, rapido, gratis y desde tu navegador.",
  alternates: {
...
export default function UnirMultiplesPDFsPage() {
  const faqs = [
    {
        "q": "Como uno multiples PDFs en un solo archivo?",
    ...
    {
        "q": "Puedo unir mas de 10 PDFs a la vez?",
    ...
    {
        "q": "Hay un limite de tamano al unir multiples PDFs?",
        "a": "Los usuarios gratuitos pueden subir archivos de hasta 25MB cada uno. Los usuarios Pro obtienen un limite de 200MB por archivo."
    },
    {
        "q": "El PDF unido sera muy grande para enviar por email?",
        "a": "Depende del tamano total de tus archivos. Si el PDF unido es muy grande, usa la herramienta Comprimir PDF de PDF.it para reducir el tamano antes de enviar."
    },
    {
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-black mb-4">Unir Multiples PDFs en Un Solo Archivo</h1>
            <p className="text-xl text-slate-300 mb-8">Combina 2, 5 o 10+ archivos PDF en un solo documento. Sube tus archivos, establece el orden y descarga un PDF unido, rapido, gratis y desde tu navegador.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">Ya sea que necesites unir dos contratos o combinar docenas de capitulos de informes, PDF.it lo maneja todo. Sube tus archivos PDF, ordenalos correctamente y obtiene un documento unido limpio. Los usuarios Pro desbloquean procesamiento por lotes para unir grandes cantidades de archivos a la vez.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            ...
            <li className="flex items-center gap-2">✓ Sin perdida de calidad — todas las paginas se mantienen como estan</li>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "Union por Lotes de Docenas de Archivos", desc: "Necesitas combinar un gran lote de facturas, informes o certificados? Los usuarios Pro pueden seleccionar multiples archivos a la vez y unirlos en una sola operacion." },
            { title: "Mantiene las Paginas en el Orden Correcto", desc: "Despues de subir, arrastra y suelta archivos para establecer la secuencia exacta. PDF.it preserva el orden que elijas para que cada capitulo y apendice aparezca donde debe." },
            { title: "Une y Luego Comprime para Compartir", desc: "Unir muchos PDFs puede crear un archivo grande. Despues de combinar, usa la herramienta Comprimir PDF de PDF.it para reducir el resultado para email y almacenamiento en la nube." },
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl"><h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Unir Multiples PDFs</h2><div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
