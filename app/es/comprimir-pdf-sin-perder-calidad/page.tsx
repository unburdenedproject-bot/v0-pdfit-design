...
export const metadata = {
  ...
  description: "Comprime archivos PDF sin perder calidad. La compresion inteligente optimiza estructuras internas, hace subset de fuentes y comprime imagenes ligeramente preservando la legibilidad — rapido, desde tu navegador, gratis.",
...
export default function ComprimirPDFSinPerderCalidadPage() {
  const faqs = [{"q":"¿Como comprime PDF.it sin perder calidad?","a":"La compresion inteligente optimiza las estructuras internas del PDF, elimina objetos duplicados, hace subset de fuentes y aplica compresion ligera de imagenes."},{"q":"¿Las imagenes se veran diferentes?","a":"Con la compresion recomendada, las imagenes se optimizan ligeramente. La diferencia es virtualmente imperceptible."},{"q":"¿Cuanto mas pequeno sera mi PDF?","a":"Los documentos con fuentes incrustadas y estructuras no optimizadas tipicamente ven una reduccion del 20-50%."},{"q":"¿Es diferente de la compresion extrema?","a":"Si. La compresion extrema reduce agresivamente la resolucion de imagenes. La compresion recomendada prioriza la calidad."},{"q":"¿Puedo comprimir sin perder calidad desde mi celular?","a":"Si. PDF.it funciona en cualquier navegador movil. Sube, comprime y descarga el archivo optimizado."},{"q":"¿Que tipos de PDFs se benefician mas?","a":"Informes profesionales, presentaciones, portafolios y documentos legales — cualquier documento donde la calidad visual importa."}]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">La compresion inteligente optimiza las estructuras internas del PDF, hace subset de fuentes y comprime imagenes ligeramente — reduciendo el tamano preservando la legibilidad y calidad visual.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">No toda la compresion es igual. La compresion inteligente de PDF.it se enfoca en optimizar la estructura interna de tu PDF — eliminando objetos duplicados, haciendo subset de fuentes incrustadas y aplicando optimizacion ligera de imagenes. El resultado es un archivo notablemente mas pequeno que se ve virtualmente identico al original.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            ...
            <li className="flex items-center gap-2">&#10003; La compresion ligera de imagenes preserva la calidad visual</li>
            <li className="flex items-center gap-2">&#10003; Sin instalacion — funciona en cualquier navegador en cualquier dispositivo</li>
          </ul>
        </div></section>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
                { title: "Informes y Presentaciones Profesionales", desc: "Informes anuales, resumenes financieros y presentaciones para clientes necesitan verse pulidos. La compresion inteligente reduce el tamano manteniendo graficos, tablas y formato impecables." },
                { title: "Portafolios y Diseno", desc: "Los portafolios creativos dependen de la calidad de imagen. La compresion que preserva calidad te permite compartir tu trabajo por email o portales sin degradar tus disenos." },
                { title: "Documentos Legales y de Cumplimiento", desc: "Contratos, acuerdos y documentos legales deben permanecer completamente legibles. La compresion inteligente optimiza el tamano asegurando que cada palabra, firma y sello se mantenga nitido." },
          ].map((feature) => (
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
            {[{ num: "1", title: "Sube tu PDF", desc: "Arrastra y suelta o haz clic para elegir un archivo" }, { num: "2", title: "Haz clic en Comprimir PDF", desc: "La compresion inteligente se aplica automaticamente" }, { num: "3", title: "Descarga tu PDF", desc: "Obtiene tu archivo optimizado al instante" }].map((step) => (
        ...
        <section className="py-16" style={{ background: "#0E0F1E" }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[{ name: "Comprimir PDF", href: "/es/comprimir-pdf", desc: "Compresion estandar" }, { name: "Comprimir para Email", href: "/es/comprimir-pdf-para-email", desc: "Para limites de adjuntos" }, { name: "Dividir PDF", href: "/es/dividir-pdf", desc: "Divide si sigue grande" }, { name: "Aplanar PDF", href: "/es/aplanar-pdf", desc: "Elimina campos de formulario" }].map((tool) => (
