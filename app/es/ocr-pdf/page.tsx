...
export const metadata = {
  title: "OCR PDF — Reconocimiento Óptico de Caracteres en PDFs | OmnisPDF",
  description:
    "Aplica OCR a tus PDFs con OmnisPDF. Reconocimiento optico de caracteres para extraer texto de documentos escaneados y hacerlos buscables y editables — rapido y seguro.",
  alternates: {
    canonical: "https://omnispdf.com/es/ocr-pdf",
    languages: {
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "El OCR de OmnisPDF soporta mas de 16 idiomas incluyendo espanol, ingles, frances, aleman, portugues, italiano, holandes y mas.",
      },
    },
    {
      "@type": "Question",
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <p className="text-lg text-slate-600 mb-8">
              Usa la herramienta de OCR PDF de OmnisPDF para aplicar reconocimiento optico de caracteres a tus documentos PDF escaneados. El OCR analiza cada pagina, detecta texto dentro de imagenes y lo convierte en texto digital que puedes copiar, buscar y editar. Ideal para digitalizar documentos fisicos.
            </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl space-y-12">
            <div>
              ...
              <p className="text-slate-600">
                Si tu PDF es un escaneo, el texto existe solo como imagen — no puedes seleccionarlo ni buscarlo. El OCR de OmnisPDF reconoce cada caracter y lo convierte en texto digital real que puedes usar como cualquier otro texto.
              </p>
            </div>
            <div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                ...
                { q: "¿Que tan preciso es el OCR de OmnisPDF?", a: "La precision depende de la calidad del escaneo, la resolucion y la tipografia. Escaneos limpios y de alta resolucion producen los mejores resultados. Escaneos borrosos o con baja resolucion pueden reducir la precision." },
                { q: "¿Que idiomas soporta el OCR?", a: "El OCR de OmnisPDF soporta mas de 16 idiomas incluyendo espanol, ingles, frances, aleman, portugues, italiano, holandes y mas." },
