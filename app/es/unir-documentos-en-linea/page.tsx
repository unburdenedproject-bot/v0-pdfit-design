...
export const metadata: Metadata = {
  title: "Unir Documentos en Linea — Combina Archivos en Un Solo PDF | PDF.it",
  description: "Une documentos en linea con PDF.it. Combina multiples archivos en un solo PDF para compartir, imprimir o archivar, rapido, gratis y desde tu navegador.",
  alternates: {
...
export default function UnirDocumentosEnLineaPage() {
  const faqs = [
    {
        "q": "Como uno documentos en linea?",
    ...
    },
    {
        ...
        "a": "PDF.it une archivos PDF directamente. Si tienes archivos Word, Excel o PowerPoint, usa las herramientas de conversion de PDF.it para convertirlos a PDF primero, luego unelos."
    },
    {
        "q": "Es seguro unir documentos en linea?",
        "a": "Si. PDF.it usa conexiones cifradas y elimina todos los archivos al terminar tu sesion. Tus documentos nunca se almacenan permanentemente."
    },
    {
    ...
    {
        "q": "Hay un limite de tamano para unir documentos?",
        "a": "Los usuarios gratuitos pueden subir archivos de hasta 25MB cada uno. Los usuarios Pro obtienen un limite de 200MB por archivo para manejar documentos grandes."
    },
    {
        "q": "Por que deberia unir documentos en linea en vez de usar software de escritorio?",
        "a": "La union en linea es mas rapida, no requiere instalacion y funciona en cualquier dispositivo. Puedes unir documentos desde tu celular, tablet o cualquier computadora con navegador."
    }
]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-black mb-4">Unir Documentos en Linea</h1>
            <p className="text-xl text-slate-300 mb-8">Combina multiples documentos en un solo PDF para compartir, imprimir o archivar. Sin software que instalar — une documentos directamente en tu navegador, rapido y gratis.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          ...
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            ...
            <li className="flex items-center gap-2">✓ Sin instalacion de software ni cuenta requerida</li>
          </ul>
        </div></section>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "Combina Informes en Un Documento", desc: "Ensamblando un informe trimestral o documento de investigacion de multiples archivos? Sube cada seccion, ordenalas y une en un documento limpio listo para distribucion." },
            { title: "Une Contratos y Documentos Legales", desc: "Combina acuerdos firmados, adendas, anexos y documentos de soporte en un solo PDF para registros legales. Un archivo significa menos confusion y archivado mas facil." },
            { title: "Crea Paquetes de Documentos para Compartir", desc: "Enviando multiples archivos a un cliente? Une todo en un paquete PDF — mas facil de compartir por email, subir a portales o imprimir como un solo paquete." },
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl"><h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Unir Documentos en Linea</h2><div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
