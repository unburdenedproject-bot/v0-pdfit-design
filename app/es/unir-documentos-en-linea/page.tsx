...
export const metadata = {
  title: "Unir Documentos en Línea — Combina Archivos en Un Solo PDF | OmnisPDF",
  description:
    "Une documentos en línea con OmnisPDF. Combina múltiples archivos en un solo PDF para compartir, imprimir o archivar — rápido, gratis y desde tu navegador.",
  alternates: {
    languages: {
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Sube tus documentos PDF a OmnisPDF, ordénalos como prefieras y haz clic en Unir. Tu documento combinado estará listo para descargar en segundos — sin necesidad de software." }
    },
    {
      "@type": "Question",
      "name": "¿Qué tipos de documentos puedo unir?",
      "acceptedAnswer": { "@type": "Answer", "text": "OmnisPDF une archivos PDF directamente. Si tienes archivos Word, Excel o PowerPoint, usa las herramientas de conversión de OmnisPDF para convertirlos a PDF primero y luego únalos en un solo documento." }
    },
    {
      "@type": "Question",
      "name": "¿Es seguro unir documentos en línea?",
      "acceptedAnswer": { "@type": "Answer", "text": "Sí. OmnisPDF usa conexiones encriptadas y elimina todos los archivos subidos después de tu sesión. Tus documentos nunca se almacenan permanentemente en nuestros servidores." }
    },
    {
      "@type": "Question",
      "name": "¿Puedo unir documentos sin instalar software?",
      "acceptedAnswer": { "@type": "Answer", "text": "Sí. OmnisPDF es 100% basado en navegador. Sin descargas, sin plugins, sin software de escritorio — solo sube, une y descarga." }
    },
    {
      "@type": "Question",
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <p className="text-lg text-slate-600 mb-8">
              Deja de manejar múltiples archivos. OmnisPDF te permite unir documentos en línea en un solo PDF — perfecto para combinar reportes, contratos, presentaciones y materiales de referencia en un solo archivo profesional. Sin software de escritorio, sin suscripciones, sin complicaciones.
            </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-4">
              {[
                "Sube o arrastra tus documentos PDF a OmnisPDF.",
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-6">
              {[
                { q: "¿Cómo puedo unir documentos en línea?", a: "Sube tus documentos PDF a OmnisPDF, ordénalos como prefieras y haz clic en Unir. Tu documento combinado estará listo para descargar en segundos — sin necesidad de software." },
                { q: "¿Qué tipos de documentos puedo unir?", a: "OmnisPDF une archivos PDF directamente. Si tienes archivos Word, Excel o PowerPoint, usa las herramientas de conversión de OmnisPDF para convertirlos a PDF primero y luego únelos en un solo documento." },
                { q: "¿Es seguro unir documentos en línea?", a: "Sí. OmnisPDF usa conexiones encriptadas y elimina todos los archivos subidos después de tu sesión. Tus documentos nunca se almacenan permanentemente en nuestros servidores." },
                { q: "¿Puedo unir documentos sin instalar software?", a: "Sí. OmnisPDF es 100% basado en navegador. Sin descargas, sin plugins, sin software de escritorio — solo sube, une y descarga." },
