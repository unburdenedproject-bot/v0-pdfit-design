...
export const metadata: Metadata = {
  title: "Unir PDFs Escaneados en Un Documento — Gratis en Linea | PDF.it",
  description: "Combina multiples PDFs escaneados en un solo documento con PDF.it. Une paginas escaneadas de diferentes fuentes en un archivo limpio, rapido, gratis y desde tu navegador.",
  alternates: {
  ...
  const faqs = [
    {
        ...
        "a": "Sube tus archivos PDF escaneados a PDF.it, ordenalos y haz clic en Unir. PDF.it combina paginas escaneadas en un solo documento sin alterar la calidad de imagen."
    },
    {
        "q": "Unir PDFs escaneados reducira la calidad de imagen?",
        "a": "No. PDF.it une tus paginas escaneadas sin recomprimirlas. Cada pagina conserva su calidad y resolucion de escaneo original."
    },
    {
        "q": "Puedo ejecutar OCR despues de unir PDFs escaneados?",
        "a": "Si. Despues de unir tus PDFs escaneados, usa la herramienta Escaner OCR de PDF.it para hacer el texto buscable y seleccionable. OCR esta disponible para usuarios Pro."
    },
    {
        "q": "Que tan grandes pueden ser los archivos PDF escaneados?",
        "a": "Los usuarios gratuitos pueden subir PDFs escaneados de hasta 25MB cada uno. Los usuarios Pro obtienen un limite de 200MB por archivo, que maneja escaneos de alta resolucion facilmente."
    },
    {
    ...
    },
    {
        ...
        "a": "Si. PDF.it funciona con PDFs escaneados de cualquier fuente — camaras de celular, escaneres de escritorio, impresoras multifuncion o apps como CamScanner y Adobe Scan."
    }
]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Combina PDFs escaneados de diferentes fuentes en un solo documento organizado. Perfecto para recibos, contratos, identificaciones y documentos archivados — rapido, gratis y desde tu navegador.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">Los documentos escaneados a menudo terminan como archivos PDF separados — uno por pagina, uno por lote o uno por sesion de escaneo. PDF.it te permite unir todos tus PDFs escaneados en un solo archivo, manteniendo cada pagina en su calidad original. Ideal para combinar contratos escaneados, recibos, identificaciones y documentos archivados.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">✓ Une PDFs escaneados sin perdida de calidad</li>
            <li className="flex items-center gap-2">✓ Combina escaneos de celulares, escaneres y apps</li>
            <li className="flex items-center gap-2">✓ Ordena las paginas en cualquier orden antes de unir</li>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "Une Contratos Escaneados", desc: "Los contratos firmados a menudo llegan como paginas escaneadas separadas. Combina todas las paginas en un documento profesional para tus registros, archivos legales o envios a clientes." },
            ...
            { title: "Organiza Archivos Escaneados", desc: "Digitalizando documentos antiguos? Une lotes de paginas escaneadas en documentos organizados por categoria, fecha o proyecto. Luego comprime para almacenamiento a largo plazo." },
