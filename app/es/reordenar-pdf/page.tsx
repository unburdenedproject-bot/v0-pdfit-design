...
export const metadata: Metadata = {
  title: "Reordenar PDF en Línea — Reorganiza Páginas PDF en Cualquier Orden | PDF.it",
  description: "Reorganiza páginas PDF en cualquier orden con PDF.it. Usa herramientas de Dividir y Unir para reorganizar tu documento, rápido, gratis y desde tu navegador.",
  alternates: {
  ...
  const faqs = [
    {
        ...
        "a": "Usa la herramienta Dividir PDF de PDF.it para separar tu documento en páginas individuales, luego usa Unir PDF para combinarlas en el orden deseado. Es rápido, gratis y funciona completamente en tu navegador."
    },
    {
        "q": "Puedo arrastrar y soltar páginas PDF para reorganizarlas?",
        "a": "PDF.it usa un flujo de dividir-y-unir para reordenar páginas. Divide tu PDF en páginas individuales, luego subelas a Unir PDF en el orden que quieras."
    },
    {
        "q": "Reordenar páginas afectara la calidad de mi PDF?",
        "a": "No. Dividir y unir PDFs con PDF.it preserva la calidad original de tus páginas, incluyendo texto, imágenes, formato y fuentes incrustadas."
    },
    {
        "q": "Puedo reordenar páginas en un PDF escaneado?",
        "a": "Si. Los PDFs escaneados funcionan igual — divide el documento en páginas, luego unelas en el orden correcto. Las imágenes escaneadas permanecen sin cambios."
    },
    {
        "q": "Hay un límite de páginas para reordenar PDFs?",
    ...
    {
        "q": "Puedo reordenar páginas PDF en mi celular?",
        "a": "Si. PDF.it funciona en cualquier navegador móvil en iPhone o Android. Divide tu PDF, luego une las páginas en tu orden preferido."
    }
]
      ...
      <main>
        <section className="text-white py-16 relative overflow-hidden" style={{ background: `radial-gradient(ellipse 70% 50% at 50% 0%, rgba(20,216,196,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 80% 70%, rgba(232,129,58,0.06) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 15% 80%, rgba(107,124,255,0.10) 0%, transparent 60%), #0E0F1E` }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10"><div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-black mb-4">Reordenar Páginas PDF en Línea</h1>
            <p className="text-xl text-slate-300 mb-8">Reorganiza páginas PDF en cualquier orden usando las herramientas de Dividir y Unir de PDF.it. Corrige errores de orden, reorganiza presentaciones y ordena documentos escaneados — rápido, gratis y desde tu navegador.</p>
        ...
        <section className="py-10 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          <p className="text-lg text-slate-600 leading-relaxed">Necesitas reorganizar páginas en un PDF? PDF.it lo hace simple con un flujo de dos pasos: divide tu documento en páginas individuales, luego unelas en cualquier orden. Sin software que instalar, sin cuenta requerida — preserva la calidad original incluyendo texto, imágenes y formato.</p>
          <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
            <li className="flex items-center gap-2">✓ Reorganiza páginas en cualquier orden</li>
        ...
        <section className="py-16" style={{ background: `radial-gradient(ellipse 60% 40% at 50% 0%, rgba(20,216,196,0.04) 0%, transparent 50%), radial-gradient(ellipse 50% 50% at 100% 80%, rgba(232,129,58,0.03) 0%, transparent 50%), #0E0F1E` }}><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl"><div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: "Corrige Errores de Orden", desc: "Escaneaste documentos en el orden incorrecto? Recibiste un PDF con páginas fuera de secuencia? Divide el documento en páginas individuales y unelas en el orden correcto." },
            { title: "Reorganiza Presentaciones e Informes", desc: "Reestructura una presentación o reorganiza secciones de un informe dividiendo y uniendo páginas en tu nuevo orden preferido." },
            { title: "Ordena Documentos Escaneados", desc: "Al escanear múltiples documentos a la vez, las páginas a menudo quedan desordenadas. Divide, revisa y une en la secuencia correcta." },
        ...
        <section className="py-16 bg-[#F3F4FF]"><div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl"><h2 className="text-3xl font-black text-slate-900 mb-8 text-center">Como Reordenar Páginas PDF</h2><div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
          {[{ num: "1", title: "Divide tu PDF", desc: "Separa en páginas individuales" },{ num: "2", title: "Une en nuevo orden", desc: "Sube páginas en la secuencia deseada" },{ num: "3", title: "Descarga tu PDF", desc: "Obtiene tu documento reordenado al instante" }].map((step) => (<div key={step.num} className="flex-1"><div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3" style={{ background: "linear-gradient(135deg, #1a1f5e, #252A6A)", boxShadow: "0 0 20px rgba(20, 216, 196, 0.3), 0 4px 8px rgba(232,129,58,0.1)", border: "1px solid rgba(20,216,196,0.25)" }}><span className="text-[#14D8C4] font-black text-lg">{step.num}</span></div><p className="font-semibold text-slate-900">{step.title}</p><p className="text-sm text-slate-500 mt-1">{step.desc}</p></div>))}
        </div></div></section>
