      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Lightning Fast</span></div>
                <div className="flex items-center gap-2"><Shield className="h-4 w-4 text-[#14D8C4]" /><span>Files Deleted After Session</span></div>
                <div className="flex items-center gap-2"><Download className="h-4 w-4 text-[#14D8C4]" /><span>Perfect Quality</span></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Convert PDF to editable DOCX format online</li>
              <li className="flex items-center gap-2">✓ Preserves layout, fonts, tables, and images</li>
              <li className="flex items-center gap-2">✓ Opens in Word, Google Docs, and LibreOffice</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Edit Contracts & Proposals", desc: "Convert PDF contracts to DOCX to make edits, add comments, track changes, and send back clean revisions — all in Microsoft Word or Google Docs." },
                { title: "Update Resumes & Reports", desc: "Need to update a resume or report but only have the PDF? Convert to DOCX and edit instantly without starting from scratch." },
                { title: "Collaborate in Real Time", desc: "Convert PDFs to DOCX to enable real-time collaboration. Share via Google Docs or OneDrive for team editing with track changes." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Convert PDF to DOCX</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Click Convert", desc: "Your PDF is transformed into editable DOCX" },
                { num: "3", title: "Download your DOCX", desc: "Open in Word, Google Docs, or any editor" },
              ].map((step) => (
