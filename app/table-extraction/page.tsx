...
export const metadata = {
  title: "Table Extraction — Coming Soon | OmnisPDF",
  description: "Extract tables from PDFs directly into Excel spreadsheets. Coming soon to OmnisPDF Business.",
}
        ...
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl lg:text-5xl font-black mb-4">Table Extraction</h1>
              <p className="text-xl text-slate-300 mb-8">
                Extract tables from PDFs directly into Excel spreadsheets. This tool is part of the OmnisPDF Business plan and is currently under development.
              </p>
