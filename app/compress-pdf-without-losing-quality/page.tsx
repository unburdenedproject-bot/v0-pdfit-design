      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">
              Not all compression is the same. PDF.it's smart compression focuses on optimizing the internal structure of your PDF — removing duplicate objects, subsetting embedded fonts, and applying light image optimization. The result is a noticeably smaller file that looks virtually identical to the original.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">&#10003; Optimizes internal PDF structures and removes redundancies</li>
              <li className="flex items-center gap-2">&#10003; Subsets fonts to remove unused characters</li>
              <li className="flex items-center gap-2">&#10003; Light image compression preserves visual quality</li>
              <li className="flex items-center gap-2">&#10003; No installation — works in any browser on any device</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Professional Reports & Presentations", desc: "Annual reports, financial summaries, and client presentations need to look polished. Smart compression reduces file size for easy sharing while keeping charts, graphs, and formatting pristine." },
                { title: "Portfolios & Design Work", desc: "Creative portfolios rely on image quality to make an impression. Quality-preserving compression lets you share your work via email or upload portals without degrading your designs." },
                { title: "Legal & Compliance Documents", desc: "Contracts, agreements, and legal filings must remain fully readable. Smart compression optimizes file size while ensuring every word, signature, and stamp stays sharp and legible." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress PDF Without Losing Quality</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Click Compress PDF", desc: "Smart compression is applied automatically" },
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { name: "Flatten PDF", href: "/flatten-pdf", desc: "Remove form fields" },
              ].map((tool) => (
                <div
                  key={tool.href}
                  className="rounded-xl p-[1px]"
