      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Lock filled form fields so they cannot be edited</li>
              <li className="flex items-center gap-2">✓ Merge annotations and comments into the page</li>
              <li className="flex items-center gap-2">✓ Fix blank fields that appear in some PDF viewers</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Submit Forms Without Blank Fields", desc: "Filled out a PDF form but the recipient sees empty fields? Flattening locks everything into place so it displays correctly everywhere." },
                { title: "Finalize Signed Documents", desc: "After signing a PDF, flatten it to prevent further edits. Signatures, form data, and annotations become permanent parts of the document." },
                { title: "Archive PDFs for Long-Term Storage", desc: "Flattened PDFs are ideal for archiving. The content is locked and will display consistently years from now across any viewer." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Flatten a PDF</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Click Flatten", desc: "Processing usually takes a few seconds" },
                { num: "3", title: "Download your PDF", desc: "Get your flattened file instantly" },
              ].map((step) => (
        ...
        <Script id="faq-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "FAQPage",
          "mainEntity": [
            { "@type": "Question", "name": "What does it mean to flatten a PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Flattening a PDF merges all interactive elements — form fields, annotations, comments, and layers — into the page content. The result is a static, non-editable PDF that looks the same everywhere." } },
            { "@type": "Question", "name": "When should I flatten a PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Flatten a PDF before submitting forms, sharing signed documents, archiving records, or when a recipient sees blank fields. Flattening ensures the content is locked and visible." } },
            { "@type": "Question", "name": "Will flattening change how my PDF looks?", "acceptedAnswer": { "@type": "Answer", "text": "No. The visual appearance stays the same. Flattening only removes the ability to edit form fields, annotations, and interactive elements." } },
            { "@type": "Question", "name": "Can I flatten a PDF with filled-in form fields?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. All filled-in data is preserved and becomes part of the page content. The fields just can no longer be edited." } },
            { "@type": "Question", "name": "Can I flatten a PDF on my phone?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. PDF.it works in mobile browsers — upload, flatten, and download on iPhone or Android." } },
            { "@type": "Question", "name": "Is it free to flatten a PDF?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Free accounts get 10 conversions per day. Pro accounts get unlimited usage." } }
          ]
        })}} />
      </main>
      <Footer />
