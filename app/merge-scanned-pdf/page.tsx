      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Merge scanned PDFs without quality loss</li>
              <li className="flex items-center gap-2">✓ Combine scans from phones, scanners, and apps</li>
              <li className="flex items-center gap-2">✓ Arrange pages in any order before merging</li>
              <li className="flex items-center gap-2">✓ Follow up with OCR for searchable text (Pro)</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Merge Scanned Contracts", desc: "Signed contracts often arrive as separate scanned pages. Combine all pages into one professional document for your records, legal files, or client submissions." },
                { title: "Combine Receipts for Expense Reports", desc: "Scan your receipts throughout the month, then merge them all into one PDF for your expense report. One file instead of a folder full of loose scans." },
                { title: "Organize Scanned Archives", desc: "Digitizing old paperwork? Merge batches of scanned pages into organized documents by category, date, or project. Then compress for long-term storage." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Merge Scanned PDFs</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your scanned PDFs", desc: "Drag and drop or click to choose files" },
                { num: "2", title: "Arrange pages in order", desc: "Reorder files before merging" },
                { num: "3", title: "Download your document", desc: "Get your merged file instantly" },
              ].map((step) => (
