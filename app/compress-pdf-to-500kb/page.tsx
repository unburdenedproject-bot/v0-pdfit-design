      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              ...
              <li className="flex items-center gap-2">✓ Perfect for government and visa photo uploads</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Government Portals with Strict Limits", desc: "Many government websites for tax filings, permits, and official registrations cap uploads at 500KB per file. Compress your documents to submit without errors or rejections." },
                { title: "Visa Photo & Document Uploads", desc: "Visa application portals frequently require photo IDs, passport copies, and supporting documents under 500KB. Compress your scanned documents to meet these strict requirements." },
                { title: "Mobile Forms & Job Applications", desc: "Mobile-optimized forms enforce smaller file limits for fast uploads on cellular connections. Job portals and certification submissions sometimes limit attachments to 500KB." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF for 500KB Limits</h2>
