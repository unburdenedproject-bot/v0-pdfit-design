      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">
              Scanned PDFs are just images — you cannot select, search, or copy the text. PDF.it's OCR technology reads the text in your scanned documents and converts it into searchable, copyable, and editable text. Support for multiple languages included.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Convert scanned PDFs into searchable text</li>
              <li className="flex items-center gap-2">✓ OCR reads text from images, photos, and scans</li>
              <li className="flex items-center gap-2">✓ Works on Mac, Windows, iOS, Android, and Linux</li>
              <li className="flex items-center gap-2">✓ No installation — run OCR in your browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Digitize Paper Documents", desc: "Scanned contracts, receipts, letters, and forms are trapped as images. PDF.it's OCR reads the text from these scans and makes it selectable and copyable — turning paper into digital data." },
                { title: "Make Scanned PDFs Searchable", desc: "After OCR processing, your scanned PDF becomes searchable. Use Ctrl+F to find specific words, names, dates, or amounts in documents that were previously just static images." },
                { title: "Extract Data from Old Documents", desc: "Have years of scanned invoices, records, or correspondence? Run OCR to extract the text, then copy it into spreadsheets, databases, or modern document management systems." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Scan a PDF to Text</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your scanned PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Select language & run OCR", desc: "Choose the document language for best results" },
                { num: "3", title: "Download searchable PDF", desc: "Get your text-searchable file instantly" },
              ].map((step) => (
