      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Convert PDF to editable Word documents online</li>
              <li className="flex items-center gap-2">✓ Preserves layout, fonts, and structure</li>
              <li className="flex items-center gap-2">✓ Great for contracts, reports, forms, and letters</li>
              <li className="flex items-center gap-2">✓ Works on Mac, Windows, iOS, Android, and Linux</li>
              <li className="flex items-center gap-2">✓ No installation — convert PDFs in your browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Edit Any PDF as a Word Document", desc: "Convert your PDFs into fully editable DOCX files. Modify text, tables, and formatting directly in Word, Google Docs, or any word processor." },
                { title: "Formatting Preserved with Precision", desc: "PDF.it keeps the layout, fonts, and images from the original PDF so your Word document looks professional from the start." },
                { title: "Download Instantly", desc: "Download your Word document right away after conversion. Open it in Microsoft Word, Google Docs, or any compatible editor." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Convert PDF to Word</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                ...
                { num: "3", title: "Download your Word file", desc: "Get your editable .docx document" },
              ].map((step) => (
