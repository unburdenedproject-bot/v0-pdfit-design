      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Instant Compression</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">
              When you need a smaller PDF right now, the last thing you want is to download software, create an account, or wait in a queue. PDF.it compresses your PDF in seconds — no installation, no signup, no friction. Just upload, compress, and download.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Compress PDFs in seconds — no waiting</li>
              <li className="flex items-center gap-2">✓ No software to install or update</li>
              <li className="flex items-center gap-2">✓ Works on Mac, Windows, iOS, Android, and Linux</li>
              <li className="flex items-center gap-2">✓ Files are automatically deleted after your session</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Last-Minute Email Attachments", desc: "Your PDF is too large to attach and the email needs to go out now. Compress it in seconds and attach the smaller version — no installs, no accounts." },
                { title: "Quick File Sharing", desc: "Need to share a PDF via Slack, Teams, or a messaging app? Compress it quickly so it uploads and downloads faster for everyone involved." },
                { title: "On-the-Go Compression", desc: "Away from your computer? Compress PDFs directly from your phone or tablet using any mobile browser. No app download needed — just open PDF.it." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF Fast</h2>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { name: "Compress for Email", href: "/compress-pdf-for-email", desc: "Fit email attachment limits" },
                { name: "Compress to 1MB", href: "/compress-pdf-to-1mb", desc: "For 1MB upload limits" },
