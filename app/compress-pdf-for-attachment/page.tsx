      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Recommended compression preserves quality</li>
              <li className="flex items-center gap-2">✓ Avoid attachment rejections from size limits</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Support Tickets & CRM", desc: "Helpdesk platforms like Zendesk, Freshdesk, and CRMs like Salesforce have attachment limits. Compress before attaching so your documentation uploads without issues." },
                { title: "Project Management Tools", desc: "Jira, Asana, Trello, and Monday.com let you attach files to tasks. Smaller PDFs mean faster uploads and a smoother experience for your entire team." },
                { title: "HR & Onboarding Forms", desc: "Submitting onboarding paperwork, tax forms, or policy documents through HR platforms? Compress your PDFs to meet upload limits and avoid submission delays." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF for Attachments</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Click Compress", desc: "Recommended compression preserves quality" },
                { num: "3", title: "Download & attach", desc: "Get your smaller file and attach it anywhere" },
              ].map((step) => (
