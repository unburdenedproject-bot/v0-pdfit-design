      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Combine any number of PDF files into one</li>
              <li className="flex items-center gap-2">✓ No quality loss — original formatting preserved</li>
              <li className="flex items-center gap-2">✓ Works on Mac, Windows, iOS, Android, and Linux</li>
              <li className="flex items-center gap-2">✓ No installation — combine PDFs in your browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Combine Reports and Proposals", desc: "Assembling a client proposal or quarterly report from multiple files? Upload each section as a separate PDF, arrange them in order, and combine into one polished document." },
                { title: "Merge Application Documents", desc: "College applications, visa forms, and job applications often require a single PDF. Combine your resume, cover letter, transcripts, and references into one file." },
                { title: "Combine and Compress Easily", desc: "After combining your PDFs, the resulting file may be too large for email. Use PDF.it's Compress PDF tool to reduce the combined file size without losing quality." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Combine PDF Files</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDFs", desc: "Drag and drop or click to choose files" },
                { num: "2", title: "Arrange the order", desc: "Reorder files before combining" },
                { num: "3", title: "Download your PDF", desc: "Get your merged file instantly" },
              ].map((step) => (
