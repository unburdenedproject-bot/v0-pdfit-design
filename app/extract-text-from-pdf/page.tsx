      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Extract all selectable text from any PDF</li>
              <li className="flex items-center gap-2">✓ Output as a clean plain text file</li>
              <li className="flex items-center gap-2">✓ Works on Mac, Windows, iOS, Android, and Linux</li>
              <li className="flex items-center gap-2">✓ No installation — extract text in your browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Extract Text for Research and Study", desc: "Working with academic papers or reference documents? Extract the text to quote passages, take notes, or compile research without retyping." },
                { title: "Pull Content for Emails and Messages", desc: "Need to share specific content from a PDF in an email or chat? Extract the text, copy the relevant sections, and paste them directly." },
                { title: "Copy Text from Contracts and Legal Docs", desc: "Extract text from contracts, agreements, and legal PDFs to review clauses, compare terms, or reuse language in new documents." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Extract Text from a PDF</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Click Extract Text", desc: "All selectable text is pulled automatically" },
                { num: "3", title: "Download your text", desc: "Get the plain text file or copy directly" },
              ].map((step) => (
