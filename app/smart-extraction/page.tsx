...
export const metadata = {
  title: "Smart Data Extraction — Pull Names, Dates & Key Data from PDFs | PDF.it",
  description:
    "Automatically extract names, dates, amounts, contact info, and key fields from any PDF. AI-powered data extraction for contracts, invoices, reports, and forms. Business plan feature.",
  alternates: {
    languages: {
...
export default function SmartExtractionPage() {
  return (
      ...
      <main>
        ...
        >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl lg:text-5xl font-black mb-4">Smart Data Extraction</h1>
              <p className="text-xl text-slate-300 mb-8">
                Automatically extract names, dates, amounts, contact info, and key fields from any PDF document using AI.
              </p>
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><FileSearch className="h-4 w-4 text-[#14D8C4]" /><span>AI-Powered</span></div>
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Instant Results</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">
              Stop manually copying data from PDFs. Upload your document and our AI automatically identifies and extracts people, organizations, dates, amounts, contact details, key fields, and important clauses — organized and ready to use.
            </p>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Contracts & Legal Documents", desc: "Extract party names, effective dates, termination clauses, liability limits, and key obligations from any contract or agreement." },
                { title: "Invoices & Financial Documents", desc: "Pull invoice numbers, due dates, line items, totals, tax amounts, and payment terms from invoices, receipts, and statements." },
                { title: "Forms & Reports", desc: "Extract field values, respondent info, dates, reference numbers, and key findings from forms, applications, and reports." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How Smart Extraction Works</h2>
