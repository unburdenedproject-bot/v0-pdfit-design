...
export const metadata = {
  ...
  description: "Convert PDF tables to Excel spreadsheets with PDF.it. Extract structured data from PDFs and download editable .xlsx files — fast and browser-based.",
}
      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Detects table structure including rows and headers</li>
              <li className="flex items-center gap-2">✓ Preserves numbers, dates, and text in correct cells</li>
              <li className="flex items-center gap-2">✓ Handles multi-page tables across your PDF</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Financial Reports to Spreadsheets", desc: "Balance sheets, income statements, and budget reports come as PDFs. Convert to Excel to update figures, add formulas, and build charts from real data." },
                { title: "Extract Invoice Line Items", desc: "Vendor invoices with itemized lines, quantities, and totals are easy to extract. Pull them into Excel for reconciliation, expense tracking, or accounting imports." },
                { title: "Analysis-Ready Data Tables", desc: "Research data, product catalogs, and pricing tables trapped in PDFs become useful the moment they are in Excel. Sort, filter, pivot, and chart without manual entry." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Convert a PDF Table to Excel</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                ...
                { num: "3", title: "Download your .xlsx", desc: "Open in Excel or Google Sheets instantly" },
              ].map((step) => (
