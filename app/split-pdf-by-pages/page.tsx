      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Custom Page Ranges</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Split by custom page ranges (e.g. 1-5, 6-10)</li>
              <li className="flex items-center gap-2">✓ Extract individual pages into their own PDF</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Split Chapters from Textbooks", desc: "Got a 300-page textbook but only need chapters 3 and 7? Enter the page ranges for just those chapters and download them as lightweight, focused files." },
                { title: "Divide Reports for Your Team", desc: "Split a quarterly report so each department gets only the pages relevant to them. Finance gets pages 1-12, marketing gets 13-24 — everyone gets what they need." },
                { title: "Create Handouts from Decks", desc: "Extract specific slides from a large presentation PDF to create targeted handouts. Pull out key summary pages, data tables, or reference sheets." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Split a PDF by Page Number</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Enter page ranges", desc: "Define which pages go into each file" },
                { num: "3", title: "Download your files", desc: "Get each part as a separate PDF" },
              ].map((step) => (
