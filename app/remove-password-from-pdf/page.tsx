      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Remove password protection in seconds</li>
              <li className="flex items-center gap-2">✓ Content, formatting, and quality preserved</li>
              <li className="flex items-center gap-2">✓ Requires the correct password — no cracking</li>
              <li className="flex items-center gap-2">✓ No installation — unlock in your browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Remove Restrictions for Easy Sharing", desc: "Need to share a PDF without the password hassle? Remove it and share an unrestricted version that anyone can open instantly." },
                { title: "Unlock PDFs for Editing and Printing", desc: "Some password-protected PDFs restrict editing, copying, or printing. Remove the password to regain full control — annotate, fill forms, and print freely." },
                { title: "Remove Outdated Passwords", desc: "Over time, password-protected files pile up and remembering each password becomes a chore. Remove outdated passwords for easier archival and future access." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Remove a Password from a PDF</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop your password-protected PDF" },
                { num: "2", title: "Enter the password", desc: "Type the current password when prompted" },
                { num: "3", title: "Download unlocked PDF", desc: "Get your unprotected file instantly" },
              ].map((step) => (
