...
const faqs = [
  { q: "What Office formats can PDF.it convert to PDF?", a: "PDF.it converts Word (DOC/DOCX), Excel (XLS/XLSX), PowerPoint (PPT/PPTX), and OpenDocument formats (ODT/ODP/ODS) to PDF." },
  { q: "Will my formatting stay the same after converting to PDF?", a: "Most documents convert cleanly. Some complex layouts with unusual fonts or wide spreadsheets may render slightly differently depending on the source file." },
  { q: "Can I convert Office files to PDF on mobile?", a: "Yes. PDF.it works in mobile browsers — upload your file and download the PDF." },
  { q: "Do PowerPoint animations convert to PDF?", a: "No. PDFs are static, so animations and transitions won't play — slides are exported as still pages." },
  { q: "Is it safe to upload Office files?", a: "Yes. All transfers are SSL encrypted and your files are deleted immediately after your session. We never store or share your documents." },
      ...
      <main>
        ...
        >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl lg:text-5xl font-black mb-4">Office to PDF Converter</h1>
              <p className="text-xl text-slate-300 mb-8">
                Convert Word, Excel, PowerPoint and other office files to PDF. Fast, accurate, and secure — all in your browser.
              </p>
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                <div className="flex items-center gap-2"><Zap className="h-4 w-4 text-[#14D8C4]" /><span>Formatting Preserved</span></div>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">
              Convert any Microsoft Office or OpenDocument file to PDF with a single click. PDF.it preserves formatting, fonts, and layout so your documents look exactly the way you intended — no software installation needed.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">&#10003; Supports DOC, DOCX, XLS, XLSX, PPT, PPTX</li>
              <li className="flex items-center gap-2">&#10003; OpenDocument formats: ODT, ODP, ODS</li>
              <li className="flex items-center gap-2">&#10003; Preserves fonts, tables, and layout</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Preserves Formatting & Layout", desc: "Fonts, tables, images, and page layout are faithfully reproduced in the PDF output. Your documents look exactly as intended." },
                { title: "All Major Office Formats", desc: "Supports Word, Excel, PowerPoint, and OpenDocument formats. Convert any office file to a universally readable PDF." },
                { title: "Fast & Secure Conversion", desc: "Upload, convert, download. Files are encrypted during transfer and deleted automatically after your session ends." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Convert Office Files to PDF</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your file", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Click Convert to PDF", desc: "Conversion usually takes a few seconds" },
