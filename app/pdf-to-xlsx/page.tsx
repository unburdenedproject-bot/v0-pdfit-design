      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-semibold">
                ...
                <div className="flex items-center gap-2"><Download className="h-4 w-4 text-[#14D8C4]" /><span>Accurate Extraction</span></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            <p className="text-lg text-slate-600 leading-relaxed">
              XLSX is the modern Excel spreadsheet format used by Microsoft Excel, Google Sheets, and LibreOffice Calc. When you receive financial reports, invoices, or data tables as PDFs, converting them to XLSX lets you sort, filter, calculate, and analyze the data — instead of manually retyping everything.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Extract tables from PDF to editable XLSX format</li>
              <li className="flex items-center gap-2">✓ Smart detection of columns, rows, and headers</li>
              <li className="flex items-center gap-2">✓ Opens in Excel, Google Sheets, and LibreOffice</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Extract Financial Data", desc: "Bank statements, quarterly reports, and financial summaries come as PDFs. Convert to XLSX to run formulas, create charts, and analyze trends in Excel or Google Sheets." },
                { title: "Convert Invoices to Spreadsheets", desc: "Received invoices in PDF format? Convert to XLSX to extract line items, calculate totals, and import data into your accounting software or ERP system." },
                { title: "Analyze Reports & Data Tables", desc: "Research data, product catalogs, and pricing tables trapped in PDFs become useful the moment they are in Excel. Sort, filter, pivot, and chart without manual entry." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Convert PDF to XLSX</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop or click to choose a file" },
                { num: "2", title: "Click Convert", desc: "Tables are detected and extracted automatically" },
                { num: "3", title: "Download your XLSX", desc: "Open in Excel, Google Sheets, or any app" },
              ].map((step) => (
