    ...
    <div className="min-h-screen bg-[#F3F4FF]">
      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Split multiple PDFs simultaneously</li>
              <li className="flex items-center gap-2">✓ Extract specific pages or split into individual pages</li>
        ...
        <ProcessingInterface
          ...
          toolName="Split PDF"
          outputFormat="PDF"
          processingMessage="Splitting your PDFs..."
          successMessage="Your split PDFs are ready!"
          requiresPlan="pro"
        />
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Split Invoices and Statements in Bulk", desc: "Financial teams often receive multi-page invoices or bank statements that need separating. Batch split lets you process an entire folder of PDFs at once." },
                { title: "Extract Pages from Multiple Documents", desc: "Need the first page from 50 different contracts? Batch splitting lets you apply the same extraction rules to multiple files simultaneously." },
                { title: "Process Legal and Compliance Docs", desc: "Law firms and compliance teams can split large document packages into individual filings. Upload a batch, split by page ranges, and download organized results as a ZIP." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Batch Split PDFs</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload multiple PDFs", desc: "Select all files to split at once (Pro)" },
                { num: "2", title: "Configure split settings", desc: "By page, by range, or into individual pages" },
                { num: "3", title: "Download as ZIP", desc: "Get all split results in one download" },
              ].map((step) => (
