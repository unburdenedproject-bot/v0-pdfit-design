      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              ...
              <li className="flex items-center gap-2">✓ Produces standard PDFs accepted by all portals</li>
              <li className="flex items-center gap-2">✓ Text stays sharp and readable for submissions</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Job Applications & Admissions", desc: "Job boards, applicant tracking systems, and university portals often cap uploads at a few megabytes. Compress your resume, transcripts, and letters to upload without errors." },
                { title: "Government & Insurance Filings", desc: "Tax filings, permit applications, visa forms, and insurance claims have strict upload limits. Compress your PDFs to meet requirements and avoid submission errors." },
                { title: "Standard PDF Output", desc: "PDF.it produces standard PDF files accepted by all major portals. Text remains sharp and readable, and the file structure stays valid for any system." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF for Upload Portals</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                ...
                { num: "3", title: "Download & upload", desc: "Get your smaller file and submit it to the portal" },
              ].map((step) => (
