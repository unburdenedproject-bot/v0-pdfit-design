      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              ...
              <li className="flex items-center gap-2">✓ Perfect for visa, government, and exam portals</li>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Meet Strict 2MB Upload Requirements", desc: "Government portals, visa applications, and exam systems often enforce a hard 2MB limit. PDF.it's extreme compression mode aggressively reduces file size to help you submit without issues." },
                { title: "Compress Scanned IDs & Documents", desc: "Scanned identity documents, certificates, and forms often exceed 2MB. PDF.it reduces embedded image sizes while keeping text legible for official submissions." },
                { title: "Still Too Large? Split Then Compress", desc: "If your PDF is still over 2MB after compression, use PDF.it's Split PDF tool to break it into individual pages, then compress each one separately." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Compress a PDF for 2MB Limits</h2>
