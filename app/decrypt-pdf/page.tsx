      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Remove PDF encryption permanently</li>
              <li className="flex items-center gap-2">✓ Content, formatting, and quality preserved</li>
              <li className="flex items-center gap-2">✓ Requires the correct password — no bypassing</li>
              <li className="flex items-center gap-2">✓ No installation — decrypt in your browser</li>
            </ul>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Decrypt PDFs for Editing", desc: "Encrypted PDFs often block editing, form filling, and annotation. Decrypt the file to regain full access — highlight text, add comments, and make changes." },
                { title: "Remove Encryption for Archival", desc: "Passwords get lost over time. If you have old encrypted PDFs and still know the passwords, decrypt them now for safe archival and future access." },
                { title: "Decrypt for Team Access", desc: "When a colleague sends an encrypted PDF and the whole team needs access, decrypt it once and share the unprotected version internally." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Decrypt a PDF</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Upload your PDF", desc: "Drag and drop your encrypted PDF" },
                { num: "2", title: "Enter the password", desc: "Type the current password when prompted" },
                { num: "3", title: "Download decrypted PDF", desc: "Get your unencrypted file instantly" },
              ].map((step) => (
