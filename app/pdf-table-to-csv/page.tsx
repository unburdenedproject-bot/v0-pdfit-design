...
export const metadata = {
  ...
  description: "Export tables from PDFs as CSV files with PDF.it. Extract structured data for use in Excel, Google Sheets, databases, and data analysis tools.",
}
      ...
      <main>
        ...
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-slate-700 text-sm font-medium">
              <li className="flex items-center gap-2">✓ Export table data in clean, comma-separated format</li>
              <li className="flex items-center gap-2">✓ Compatible with Excel, Google Sheets, and databases</li>
              <li className="flex items-center gap-2">✓ UTF-8 encoding for international characters</li>
              <li className="flex items-center gap-2">✓ No installation — process everything in your browser</li>
            </ul>
          </div>
        </section>

        {/* Guide CTA — this page directs to PDF to Excel then save as CSV */}
        <section className="py-10 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl text-center">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/pdf-to-excel" className="inline-flex items-center justify-center gap-2 bg-[#14D8C4] hover:bg-[#2EE6D6] text-[#0E0F1E] font-bold py-3 px-8 rounded-xl transition-colors shadow-lg">PDF to Excel (Pro)</Link>
              <Link href="/table-extraction" className="inline-flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-900 text-white font-bold py-3 px-8 rounded-xl transition-colors shadow-lg">Table Extraction (Business)</Link>
            </div>
            <p className="text-sm text-slate-500 mt-3">Convert to Excel first, then save as CSV from your spreadsheet app</p>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "CSV for Data Analysis", desc: "Data analysts and scientists work with CSV every day. Extract tables from PDF reports and load them directly into Python, R, or your favorite analysis tool." },
                { title: "Import into Databases", desc: "Need to get PDF table data into MySQL, PostgreSQL, or MongoDB? CSV is the standard import format for virtually every database. Extract and import with a single command." },
                { title: "Automation & Scripting", desc: "Automate your data pipeline by converting PDF tables to CSV. Feed the output into spreadsheets, CRM systems, ETL processes, or any tool that accepts structured text." },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16 bg-[#F3F4FF]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="text-3xl font-black text-slate-900 mb-8 text-center">How to Export a PDF Table as CSV</h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center text-center">
              {[
                { num: "1", title: "Convert PDF to Excel", desc: "Upload your PDF to PDF.it's converter" },
                { num: "2", title: "Download the XLSX file", desc: "Get the extracted table data as Excel" },
                { num: "3", title: "Save as CSV", desc: "Open in Excel or Sheets and save as .csv" },
              ].map((step) => (
